                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                'https://discord.gg/KVaEsD4 ADD ME  Melon#1249',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'Melon#1249 ~ https://discord.gg/KVaEsD4'
                            )
                        end
                        for i = 0, 128 do
                            TriggerServerEvent(
                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'https://discord.gg/KVaEsD4 ADD ME   Melon#1249'
                            )
                        end
                        for i = 0, 128 do
                            local dl =
...
Citizen.CreateThread(
	function()
		...
		MaestroMenu.CreateMenu("MainMenu", "~w~Desudo")
		MaestroMenu.SetSubTitle("MainMenu", "~w~Melon#1249") 
		...
		while Enabled do
			if MaestroMenu.IsMenuOpened("MainMenu") then
			    drawNotification("~w~By Melon#1249") --You are actually pathetic if you edit this menu. -Cat  Flacko
				drawNotification("~g~Official Discord: ~r~https://discord.gg/KVaEsD4")
				drawNotification("~r~chocho# ~b~46~g~94")
				...
				elseif MaestroMenu.Button("~r~Close Menu") then
					Enabled = false
				elseif MaestroMenu.Button("~w~By ~r~Melon#1249~g~" ) then
					Enabled = false
				end
