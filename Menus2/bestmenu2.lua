...
function Cience.CreateMenu(id, title)
    ...
    menus[id].titleBackgroundColor = { r = 255, g = 0, b = 0, a = 180 }
    menus[id].titleBackgroundSprite = nil

    menus[id].menuTextColor = { r = 255, g = 255, b = 255, a = 255 }
    menus[id].menuSubTextColor = { r = 189, g = 189, b = 189, a = 255 }
    menus[id].menuFocusTextColor = { r = 10, g = 10, b = 10, a = 255 }
    menus[id].menuFocusBackgroundColor = { r = 255, g = 0, b = 0, a = 180 }
    menus[id].menuBackgroundColor = { r = 255, g = 0, b = 0, a = 160 }
...
function RapeAllFunc()
    for bs=0,9 do 
        TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"You got communised by Destroyer Fivem ")
    end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do 
            TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"Destroyer Fivem H4X  By: Destroyer Fivem")
        end
...
Citizen.CreateThread(
    function()
        ...
        Cience.CreateMenu("MainMenu", "9MOONA")
        ...
        while Enabled do
            ...
            elseif IsDisabledControlPressed(0, 154) then
                if logged then
                    ...
                    if temp == pass then
                        drawNotification("~g~Login Succesful! Welcome stfu")
                        logged = true
                        Cience.OpenMenu("MainMenu")
                    else
                        drawNotification("~r~Login Failed! stfu")
                    end
                end
            end
