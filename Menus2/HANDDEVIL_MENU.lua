...
function Handdevil V8.5.CreateMenu(id, title)
...
function Handdevil V8.5.CreateSubMenu(id, parent, subTitle)
	if menus[parent] then
		Handdevil V8.5.CreateMenu(id, menus[parent].title)
...
function Handdevil V8.5.CurrentMenu()
	return currentMenu
end

function Handdevil V8.5.OpenMenu(id)
	if id and menus[id] then
...
function Handdevil V8.5.IsMenuOpened(id)
	return isMenuVisible(id)
end

function Handdevil V8.5.IsAnyMenuOpened()
...
function Handdevil V8.5.IsMenuAboutToBeClosed()
	if menus[currentMenu] then
...
function Handdevil V8.5.CloseMenu()
	if menus[currentMenu] then
...
function Handdevil V8.5.Button(text, subText)
...
function Handdevil V8.5.MenuButton(text, id)
	if menus[id] then
		if Handdevil V8.5.Button(text) then
			setMenuVisible(currentMenu, false)
...
function Handdevil V8.5.CheckBox(text, bool, callback)
	local checked = "~r~~h~Off"
	if bool then
		checked = "~g~~h~On"
	end

	if Handdevil V8.5.Button(text, checked) then
		bool = not bool
...
function Handdevil V8.5.ComboBox(text, items, currentIndex, selectedIndex, callback)
	...
	if Handdevil V8.5.Button(text, selectedItem) then
...
function Handdevil V8.5.Display()
	if isMenuVisible(currentMenu) then
		if menus[currentMenu].aboutToBeClosed then
			Handdevil V8.5.CloseMenu()
		else
...
function Handdevil V8.5.SetMenuWidth(id, width)
	setMenuProperty(id, "width", width)
end

function Handdevil V8.5.SetMenuX(id, x)
	setMenuProperty(id, "x", x)
end

function Handdevil V8.5.SetMenuY(id, y)
	setMenuProperty(id, "y", y)
end

function Handdevil V8.5.SetMenuMaxOptionCountOnScreen(id, count)
	setMenuProperty(id, "maxOptionCount", count)
end

function Handdevil V8.5.SetTitleColor(id, r, g, b, a)
	setMenuProperty(id, "titleColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a})
end

function Handdevil V8.5.SetTitleBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
...
function Handdevil V8.5.SetTitleBackgroundSprite(id, textureDict, textureName)
	setMenuProperty(id, "titleBackgroundSprite", {dict = textureDict, name = textureName})
end

function Handdevil V8.5.SetSubTitle(id, text)
	setMenuProperty(id, "subTitle", string.upper(text))
end

function Handdevil V8.5.SetMenuBackgroundColor(id, r, g, b, a)
	setMenuProperty(
		id,
		"menuBackgroundColor",
...
function Handdevil V8.5.SetMenuTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a})
end

function Handdevil V8.5.SetMenuSubTextColor(id, r, g, b, a)
	setMenuProperty(id, "menuSubTextColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a})
end

function Handdevil V8.5.SetMenuFocusColor(id, r, g, b, a)
	setMenuProperty(id, "menuFocusColor", {["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a})
end

function Handdevil V8.5.SetMenuButtonPressedSound(id, name, set)
	...
	function()
		while Enabled do
			...
			if banallusers then
				...
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, " BEM VINDOS *TIAGOMODZ* https://discord.gg/K4mYqG XD ")
					end
				end
...
Citizen.CreateThread(
	function()
		...
		Handdevil V8.5.CreateMenu("MainMenu", "TIAGO ~n~~r~MENU")
		Handdevil V8.5.SetSubTitle("MainMenu", "Creator TiagoModz")
		Handdevil V8.5.CreateSubMenu("SelfMenu", "MainMenu", "PlayerMenu")
		Handdevil V8.5.CreateSubMenu("World", "MainMenu", "World")
		Handdevil V8.5.CreateSubMenu("Fuck", "MainMenu", "Fuck")
		Handdevil V8.5.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		Handdevil V8.5.CreateSubMenu("ServerMenu", "MainMenu", "LUA Execution")
		Handdevil V8.5.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
		Handdevil V8.5.CreateSubMenu('OnlinePlayerMenu', 'MainMenu', 'Online Player Menu')
		Handdevil V8.5.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', 'Player Options')
		Handdevil V8.5.CreateSubMenu('SingleWepPlayer', 'OnlinePlayerMenu', 'Single Weapon Menu')
		Handdevil V8.5.CreateSubMenu("WepMenu", "MainMenu", "Weapon Menu")
		Handdevil V8.5.CreateSubMenu("SingleWepMenu", "WepMenu", "Single Weapon Menu")
		Handdevil V8.5.CreateSubMenu("ESXBoss", "ServerMenu", "ESX Boss Menus")
		Handdevil V8.5.CreateSubMenu("ESXMoney", "ServerMenu", "Money Options")
		Handdevil V8.5.CreateSubMenu("ESXMisc", "ServerMenu", "ESX Misc Options")
		Handdevil V8.5.CreateSubMenu("ESXDrugs", "ServerMenu", "ESX Drugs")
		Handdevil V8.5.CreateSubMenu("MiscServerOptions", "ServerMenu", "Misc Server Options")
		Handdevil V8.5.CreateSubMenu("RecrutarPlayers", "ServerMenu", "Recrutar Players")
		Handdevil V8.5.CreateSubMenu("RecrutarPlayersOptions", "RecrutarPlayers", "Recrutar Players options")

		local SelectedPlayer

		while Enabled do
			if Handdevil V8.5.IsMenuOpened("MainMenu") then
				...
				drawNotification("~g~Official Discord: ~s~~n~https://discord.gg/U3tGSBE ~n~~r~TiagoModz#1352")
				   if Handdevil V8.5.MenuButton("~h~Player ~s~Menu                                     ~h~  ~r~      »", "SelfMenu") then
				elseif Handdevil V8.5.MenuButton("~h~Online ~s~Players                               ~h~    ~r~       »", "OnlinePlayerMenu") then
				elseif Handdevil V8.5.MenuButton("~h~World ~s~Menu                                  ~h~    ~r~        »", "World") then
				elseif Handdevil V8.5.MenuButton("~h~Teleporte ~s~Menu                             ~h~     ~r~      »", "TeleportMenu") then
				elseif Handdevil V8.5.MenuButton("~h~Vehicles ~s~Menu                              ~h~    ~r~        »", "VehMenu") then
				elseif Handdevil V8.5.MenuButton("~h~Weapons ~s~Menu                               ~h~   ~r~      »", "WepMenu") then
				elseif Handdevil V8.5.MenuButton("~h~Fuck ~s~Server                               ~h~    ~r~           »", "Fuck") then
				elseif Handdevil V8.5.MenuButton("~h~<FONT COLOR='#15f600'>∑ LUA MENU ∑                                         ~s~~h~~r~»", "ServerMenu") then
				elseif Handdevil V8.5.Button("~h~~r~Disconnect ~s~Menu") then
					Enabled = false
				end

				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("SelfMenu") then
				if
					Handdevil V8.5.CheckBox(
						"~h~~g~God ~h~~r~Mode",
						Godmode,
						function(enabled)
							Godmode = enabled
				 ...
				 then
				elseif Handdevil V8.5.Button("~h~~r~Suicide") then
					SetEntityHealth(PlayerPedId(), 0)
				elseif Handdevil V8.5.Button("~s~Revive ~h~~g~ESX") then
					TriggerEvent("esx_ambulancejob:revive")
				    TriggerEvent('ambulancier:selfRespawn')
				elseif Handdevil V8.5.Button("~h~~g~Heal") then
					SetEntityHealth(PlayerPedId(), 200)
				elseif Handdevil V8.5.Button("~h~~b~Armour") then
					SetPedArmour(PlayerPedId(), 200)
				elseif Handdevil V8.5.Button("~w~~h~Set hunger to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif Handdevil V8.5.Button("~w~~h~Set thirst to ~h~~g~100%") then
					TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif Handdevil V8.5.Button("~h~~b~Open Menu Jail ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
				elseif Handdevil V8.5.Button("~h~~b~Unjail") then
					TriggerServerEvent('esx_jailer:unjailTime', -1)
					TriggerServerEvent('JailUpdate', 0)
					TriggerEvent('UnJP')
				elseif
				Handdevil V8.5.CheckBox("~h~Infinite Stamina",InfStamina,function(enabled)InfStamina = enabled end)
				then
				elseif
				Handdevil V8.5.CheckBox(
					"~h~Super Jump",
				...
				then
				elseif
				Handdevil V8.5.CheckBox("~h~Fast Run ~r~NEW",fastrun,function(enabled)fastrun = enabled end)
			 	then
				elseif
				Handdevil V8.5.CheckBox(
					"~h~Invisible",
				...
				then
				elseif
				Handdevil V8.5.CheckBox("~h~NoClip",Noclip,function(enabled)Noclip = enabled end)
				then	
				end

		Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("TeleportMenu") then
				if Handdevil V8.5.Button("~h~Teleport ~h~~g~Waypoint") then
				TeleportToWaypoint()
			 elseif Handdevil V8.5.Button("~h~Teleport ~h~~g~Vehicle ~r~FIX ") then
		...
		Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("World") then
			if
				Handdevil V8.5.CheckBox(
				"~h~ESP",
				esp,
		...
		Handdevil V8.5.Display()
		elseif Handdevil V8.5.IsMenuOpened("Fuck") then
		if Handdevil V8.5.Button("~h~~r~Give All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
				...
				elseif Handdevil V8.5.Button("~h~~r~Remove All Weapons ~s~~h~Players") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
	...
	then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("WepMenu") then
				if Handdevil V8.5.MenuButton("~h~Specific Weapon", "SingleWepMenu") then
				elseif Handdevil V8.5.Button("~h~~g~Give ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif Handdevil V8.5.Button("~h~~r~Remove ~s~~h~All Weapons") then
					for i = 1, #allWeapons do
						RemoveAllPedWeapons(PlayerPedId(), true)
					end
				elseif Handdevil V8.5.Button("~h~~b~Give Ammo") then
					for i = 1, #allWeapons do
						AddAmmoToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 200)
					end
				elseif
					Handdevil V8.5.ComboBox(
			...
			elseif
				...
				elseif
				 ...
				 then
				 elseif
					 Handdevil V8.5.CheckBox("~h~Vehicle Gun",VehicleGun,
				 	 function(enabled)VehicleGun = enabled end) 
			 	then
			 	elseif
					 Handdevil V8.5.CheckBox("~h~Delete Gun",DeleteGun,
				 	 function(enabled)DeleteGun = enabled end) 
			 	then
				end

				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("SingleWepMenu") then
				for i = 1, #allWeapons do
					if Handdevil V8.5.Button(allWeapons[i]) then
						GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				end

				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("VehMenu") then
				if Handdevil V8.5.Button("~h~~g~Spawn Vehicle") then
				...
				elseif Handdevil V8.5.Button("~h~Repair Vehicle") then
					SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
					SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
					SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
					Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
				elseif Handdevil V8.5.Button("~h~Max Tuning") then
					MaxOut(GetVehiclePedIsUsing(PlayerPedId())
)				elseif Handdevil V8.5.Button("~h~Max mechanics ~r~new") then
				...
				then
			    elseif Handdevil V8.5.Button("~h~~b~Change License Plate~r~ NEW") then
					local playerPed = GetPlayerPed(-1)
				...
				elseif Handdevil V8.5.Button("~h~~r~Delete Vehicle") then
					DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle Deleted")
				elseif Handdevil V8.5.Button("~h~Make vehicle dirty") then
					Clean(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("Vehicle is now dirty")
				elseif Handdevil V8.5.Button("~h~Make vehicle clean") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("ServerMenu") then
				if Handdevil V8.5.MenuButton("~s~Menu ~h~~r~RECRUIT PLAYERS", "RecrutarPlayers") then
				elseif Handdevil V8.5.MenuButton("~s~Menu ~b~~h~BOSS", "ESXBoss") then
				elseif Handdevil V8.5.MenuButton("~s~Menu ~g~~h~MONEY", "ESXMoney") then
				elseif Handdevil V8.5.MenuButton("~s~Menu ~p~~h~DRUGS", "ESXDrugs") then
				elseif Handdevil V8.5.MenuButton("~s~Menu ~o~~h~OTHERS", "ESXMisc") then
				end

				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("ESXBoss") then
				if Handdevil V8.5.Button("~c~~h~Mechanic~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mecano', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~b~~h~Police~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'police', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~r~~h~Ambulance~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'ambulance', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~y~~h~Taxi~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'taxi', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~g~~h~Real Estate~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'realestateagent', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~p~~h~Gang~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'gang', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~o~~h~Car Dealer~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'cardealer', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~y~~h~Banker~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'banker', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~c~~h~Mafia~s~ Boss Menu") then
					TriggerEvent('esx_society:openBossMenu', 'mafia', function(data,menu) menu.close() end)
					setMenuVisible(currentMenu, false)
				elseif Handdevil V8.5.Button("~g~~h~ESX ~y~Custom Boss Menu") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("ESXMoney") then
				if Handdevil V8.5.Button("~h~~r~-»~r~~h~ BEST MONEY «-") then
			...
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~1") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~2") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~3") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~4") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~5") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~6") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~7") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~8") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~9") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~10") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~11") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~12") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~13") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~14") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_taxijob:success')
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~15") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif Handdevil V8.5.Button("~g~~h~MONEY ~s~16") then
				...
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
			elseif Handdevil V8.5.Button("~s~Bank ~r~~h~Deposit") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("bank:deposit", result)
				end
			elseif Handdevil V8.5.Button("~s~Bank ~r~~h~Withdraw ") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
			...
			Handdevil V8.5.Display()
				elseif Handdevil V8.5.IsMenuOpened("ESXMisc") then
				    if Handdevil V8.5.Button("~g~~h~ESX ~r~SEND EVERYONE A BILL") then
				...
				elseif Handdevil V8.5.Button("~g~~h~ESX ~w~Get all licenses Drive") then
				...
				elseif Handdevil V8.5.Button("~h~Send Discord Message") then
				...
				elseif Handdevil V8.5.Button("~h~Send Police Car Advert") then
				TriggerServerEvent("esx:enterpolicecar",GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0))))
				end
				

				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("MiscServerOptions") then
				if Handdevil V8.5.Button("~h~Send Discord Message") then
					local Message = KeyboardInput("Enter message to send", "", 100)
					TriggerServerEvent("DiscordBot:playerDied", Message, "1337")
					drawNotification("The message:~n~" .. Message .. "~n~Has been ~g~sent!")
				elseif Handdevil V8.5.Button("~h~Send Police Car Advert") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("VRPOptions") then
				if Handdevil V8.5.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
						TriggerServerEvent("lscustoms:payGarage", {costs = -result})
					end		
				elseif Handdevil V8.5.Button("~r~~h~VRP ~g~WIN ~s~Slot Machine") then
					local result = KeyboardInput("Enter amount of money USE AT YOUR OWN RISK", "", 100)
					if result then
					TriggerServerEvent("vrp_slotmachine:server:2", result)
					end
				elseif Handdevil V8.5.Button("~r~~h~VRP ~s~Get driving license") then
					TriggerServerEvent("dmv:success")
				elseif Handdevil V8.5.Button("~r~~h~VRP ~s~Bank Deposit") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:deposit", result)
					end
				elseif Handdevil V8.5.Button("~r~~h~VRP ~s~Bank Withdraw ") then
					local result = KeyboardInput("Enter amount of money", "", 100)
					if result then
					TriggerServerEvent("bank:withdraw", result)
					end
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("ESXDrugs") then
				if Handdevil V8.5.Button("~h~~g~Harvest ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
					TriggerServerEvent("esx_drugs:startHarvestWeed")
				elseif Handdevil V8.5.Button("~h~~g~Transform ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
					TriggerServerEvent("esx_drugs:startTransformWeed")
				elseif Handdevil V8.5.Button("~h~~g~Sell ~g~Weed ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
					TriggerServerEvent("esx_drugs:startSellWeed")
				elseif Handdevil V8.5.Button("~h~~w~Harvest ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
					TriggerServerEvent("esx_drugs:startHarvestCoke")
				elseif Handdevil V8.5.Button("~h~~w~Transform ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
					TriggerServerEvent("esx_drugs:startTransformCoke")
				elseif Handdevil V8.5.Button("~h~~w~Sell ~w~Coke ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
					TriggerServerEvent("esx_drugs:startSellCoke")
				elseif Handdevil V8.5.Button("~h~~r~Harvest Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
					TriggerServerEvent("esx_drugs:startHarvestMeth")
				elseif Handdevil V8.5.Button("~h~~r~Transform Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
					TriggerServerEvent("esx_drugs:startTransformMeth")
				elseif Handdevil V8.5.Button("~h~~r~Sell Meth ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
					TriggerServerEvent("esx_drugs:startSellMeth")
				elseif Handdevil V8.5.Button("~h~~p~Harvest Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
					TriggerServerEvent("esx_drugs:startHarvestOpium")
				elseif Handdevil V8.5.Button("~h~~p~Transform Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
					TriggerServerEvent("esx_drugs:startTransformOpium")
				elseif Handdevil V8.5.Button("~h~~p~Sell Opium ~c~(x5)") then
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
					TriggerServerEvent("esx_drugs:startSellOpium")
				elseif Handdevil V8.5.Button("~h~~g~Money Wash ~c~(x10)") then
					...
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
					TriggerServerEvent("esx_blanchisseur:startWhitening", 85)
				elseif Handdevil V8.5.Button("~r~~h~Stop all ~c~(Drugs)") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("RecrutarPlayers") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and Handdevil V8.5.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."", 'RecrutarPlayersOptions') then
						SelectedPlayer = i
					end
				end
				
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("RecrutarPlayersOptions") then
				Handdevil V8.5.SetSubTitle("RecrutarPlayersOptions", "Recrutar Players options [" .. GetPlayerName(SelectedPlayer) .. "]")
			    if Handdevil V8.5.Button("~s~Recruit~c~~h~ Mechanic") then
			...
			elseif Handdevil V8.5.Button("~s~Recruit~b~~h~ Police") then
			...
			elseif Handdevil V8.5.Button("~s~Recruit~c~~h~ Mafia") then
			...
			elseif Handdevil V8.5.Button("~s~Recruit~p~~h~ Gang") then
			...
			elseif Handdevil V8.5.Button("~s~Recruit~r~~h~ Inem") then
			...
			elseif Handdevil V8.5.Button("~h~Custom Recruit") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("OnlinePlayerMenu") then
					for i = 0, 128 do
					if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and Handdevil V8.5.MenuButton("~h~~r~-»  ~s~"..GetPlayerName(i).."~h~~y~ » "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~s~[~r~DEAD~s~]" or "~s~[~g~ALIVE~s~]"), 'PlayerOptionsMenu') then
						SelectedPlayer = i
					end
				end
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("PlayerOptionsMenu") then
				Handdevil V8.5.SetSubTitle("PlayerOptionsMenu", "~h~Player ~s~~r~[" .. GetPlayerName(SelectedPlayer) .. "~r~]")
				if Handdevil V8.5.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
					SpectatePlayer(SelectedPlayer)
				elseif Handdevil V8.5.Button("Teleport To Player") then
					local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
					SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)	
				elseif Handdevil V8.5.Button("~g~Give ~s~Money") then
				...
				elseif Handdevil V8.5.Button("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif Handdevil V8.5.Button("Give ~b~Armour ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif Handdevil V8.5.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 
				elseif Handdevil V8.5.Button('Fire') then
				    FirePlayer(SelectedPlayer)
					elseif Handdevil V8.5.Button("Jail") then		
				...
				elseif Handdevil V8.5.Button("Unjail") then
				...
				elseif Handdevil V8.5.Button("~g~Give All Weapons") then
					for i = 1, #allWeapons do
						GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
					end
				elseif Handdevil V8.5.MenuButton("Weapon Menu", "SingleWepPlayer") then
				elseif Handdevil V8.5.Button("Spawn Vehicle") then
				...
				elseif Handdevil V8.5.Button("Cuff ~g~ESX") then
					TriggerServerEvent("esx_policejob:handcuff", GetPlayerPed(SelectedPlayer))
					elseif Handdevil V8.5.Button("~h~~b~--Vehicle Options--") then
				elseif Handdevil V8.5.Button("~b~Kick Vehicle") then
					ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
				elseif Handdevil V8.5.Button("~b~Fuck Engine ~r~NEW") then
				...
				elseif Handdevil V8.5.Button("~b~Repair Vehicle ~r~NEW") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif Handdevil V8.5.Button("~b~Fuck Car ~r~NEW ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif Handdevil V8.5.Button("~r~MelloTrainer ~s~KILL") then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif Handdevil V8.5.Button("~r~MelloTrainer ~s~BAN") then
					TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
				elseif Handdevil V8.5.Button("~r~MelloTrainer ~s~KICK") then
				...
				Handdevil V8.5.Display()
			elseif Handdevil V8.5.IsMenuOpened("SingleWepPlayer") then
				for i = 1, #allWeapons do
					if Handdevil V8.5.Button(allWeapons[i]) then
			...
			elseif IsDisabledControlPressed(0, 121) then
				Handdevil V8.5.OpenMenu("MainMenu")
			end
