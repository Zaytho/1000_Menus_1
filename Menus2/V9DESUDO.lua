                    ...
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'https://discord.io/COMMUNITYV9'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Voiture#4895 V9 https://discord.io/COMMUNITYV9',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"V9; Voiture#4895")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Voiture#4895',
                    {0, 0x99, 255},
                    '/ooc V9 Menu Buy At discord.io/COMMUNITYV9'
                )
                TriggerServerEvent('_chat:messageEntered', 'Voiture#4895', {0, 0x99, 255}, 'V9 Menu <3 discord.io/COMMUNITYV9')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Voiture <3 Voiture#4895 discord.io/COMMUNITYV9")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "V9 <3 Voiture#4895 discord.io/COMMUNITYV9")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Voiture")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Voiture")
                drawNotification("~h~~s~Made by ~b~Voiture#4895")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "V9 Menu discord.io/COMMUNITYV9", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "V9 Menu discord.io/COMMUNITYV", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "V9 Menu discord.io/COMMUNITYVn", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "V9 Menu discord.io/COMMUNITYV", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "V9 Menu discord.io/COMMUNITYV", "6969696969")
                end
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Voiture")
                    else
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("∑~r~~h~Voiture#4895 - Owner And Developer") then
				end
				Plane.Display()
