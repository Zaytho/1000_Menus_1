...
local function D(E)
    if ||-BLOOD_MENU-||.debug then
        Citizen.Trace('[||-BLOOD_MENU-||] ' .. tostring(E))
    end
end
...
function ||-BLOOD_MENU-||.CreateMenu(G, a4)
    j[G] = {}
    j[G].title = a4
    j[G].subTitle = C
    j[G].visible = false
...
function ||-BLOOD_MENU-||.CreateSubMenu(G, a6, a7)
    if j[a6] then
        ||-BLOOD_MENU-||.CreateMenu(G, j[a6].title)
        if a7 then
            F(G, 'subTitle', a7)
        else
...
function ||-BLOOD_MENU-||.CurrentMenu()
    return n
end

function ||-BLOOD_MENU-||.OpenMenu(G)
    if G and j[G] then
...
function ||-BLOOD_MENU-||.IsMenuOpened(G)
    return I(G)
end

function ||-BLOOD_MENU-||.IsAnyMenuOpened()
...
function ||-BLOOD_MENU-||.IsMenuAboutToBeClosed()
    if j[n] then
...
function ||-BLOOD_MENU-||.Button(E, Z)
    local a8 = E
    if Z then
...
function ||-BLOOD_MENU-||.MenuButton(E, G)
    if j[G] then
        if ||-BLOOD_MENU-||.Button(E) then
            J(n, false)
            J(G, true, true)
            return true
        end
...
function ||-BLOOD_MENU-||.CheckBox(E, bool, aa)
    local ab = '~r~~h~OFF'
    if bool then
        ab = '~g~~h~ON'
    end
    if ||-BLOOD_MENU-||.Button(E, ab) then
        bool = not bool
...
function ||-BLOOD_MENU-||.ComboBox(E, ac, ad, ae, aa)
    local af = #ac
    local ag = ac[ad]
    ...
    if ||-BLOOD_MENU-||.Button(E, ag) then
        ae = ad
        aa(ad, ae)
        return true
    elseif a9 then
...
function ||-BLOOD_MENU-||.Display()
    if I(n) then
        if j[n].aboutToBeClosed then
            ||-BLOOD_MENU-||.CloseMenu()
        else
...
function ||-BLOOD_MENU-||.SetMenuWidth(G, U)
    F(G, 'width', U)
end

function ||-BLOOD_MENU-||.SetMenuX(G, x)
    F(G, 'x', x)
end

function ||-BLOOD_MENU-||.SetMenuY(G, y)
    F(G, 'y', y)
end

function ||-BLOOD_MENU-||.SetMenuMaxOptionCountOnScreen(G, count)
    F(G, 'maxOptionCount', count)
end

function ||-BLOOD_MENU-||.SetTitleColor(G, r, g, b, a)
    F(G, 'titleColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].titleColor.a})
end

function ||-BLOOD_MENU-||.SetTitleBackgroundColor(G, r, g, b, a)
    F(
        G,
...
function ||-BLOOD_MENU-||.SetTitleBackgroundSprite(G, ah, ai)
    F(G, 'titleBackgroundSprite', {dict = ah, name = ai})
end

function ||-BLOOD_MENU-||.SetSubTitle(G, E)
    F(G, 'subTitle', E)
end

function ||-BLOOD_MENU-||.SetMenuBackgroundColor(G, r, g, b, a)
    F(
        G,
        'menuBackgroundColor',
        {
...
function ||-BLOOD_MENU-||.SetMenuTextColor(G, r, g, b, a)
    F(G, 'menuTextColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuTextColor.a})
end

function ||-BLOOD_MENU-||.SetMenuSubTextColor(G, r, g, b, a)
    F(G, 'menuSubTextColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuSubTextColor.a})
end

function ||-BLOOD_MENU-||.SetMenuFocusColor(G, r, g, b, a)
    F(G, 'menuFocusColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].menuFocusColor.a})
end

function ||-BLOOD_MENU-||.SetMenuButtonPressedSound(G, name, aj)
...
Citizen.CreateThread(
    function()
        ...
        ||-BLOOD_MENU-||.CreateMenu('\76\121\110\120\88', 'Melon')
        ||-BLOOD_MENU-||.SetSubTitle('\76\121\110\120\88', 'Desudo Executor')
        ||-BLOOD_MENU-||.CreateSubMenu('\83\101\108\102\77\101\110\117', '\76\121\110\120\88', '\83\101\108\102\32\77\101\110\117')
        ||-BLOOD_MENU-||.CreateSubMenu(
        ...
        ||-BLOOD_MENU-||.CreateSubMenu('\76\117\97\77\101\110\117', '\76\121\110\120\88', '\76\117\97\32\77\101\110\117')
        ||-BLOOD_MENU-||.CreateSubMenu(
            '\86\101\104\105\99\108\101\77\101\110\117',
            '\76\121\110\120\88',
            '\86\101\104\105\99\108\101\32\77\101\110\117'
        )
        ||-BLOOD_MENU-||.CreateSubMenu("AICONTROLMENU", "VehicleMenu", "AI Menu")
        ||-BLOOD_MENU-||.CreateSubMenu(
        ...
        ||-BLOOD_MENU-||.CreateSubMenu('\67\114\101\100\105\116\115', '\76\121\110\120\88', '\67\114\101\100\105\116\115')
        ||-BLOOD_MENU-||.CreateSubMenu('\69\83\88\74\111\98\115', '\76\117\97\77\101\110\117', '\69\83\88\32\74\111\98\115')
        ||-BLOOD_MENU-||.CreateSubMenu(
        ...
        ||-BLOOD_MENU-||.CreateSubMenu('ModSelect', '\87\101\97\112\111\110\79\112\116\105\111\110\115', 'Weapon Mod Options')
        ||-BLOOD_MENU-||.CreateSubMenu('CarTypes', '\86\101\104\105\99\108\101\77\101\110\117', 'Vehicles')
        ||-BLOOD_MENU-||.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
        ||-BLOOD_MENU-||.CreateSubMenu(
        ...
        ||-BLOOD_MENU-||.CreateSubMenu('\76\83\67', '\86\101\104\105\99\108\101\77\101\110\117', 'LSC Customs')
        ||-BLOOD_MENU-||.CreateSubMenu('tunings', '\76\83\67', 'Visual Tuning')
        ||-BLOOD_MENU-||.CreateSubMenu('performance', '\76\83\67', 'Performance Tuning')
        ||-BLOOD_MENU-||.CreateSubMenu(
        ...
        for i, da in pairs(be) do
            ||-BLOOD_MENU-||.CreateSubMenu(da.id, 'tunings', da.name)
            if da.id == 'paint' then
                ||-BLOOD_MENU-||.CreateSubMenu('primary', da.id, 'Primary Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('secondary', da.id, 'Secondary Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('rimpaint', da.id, 'Wheel Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('classic1', 'primary', 'Classic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metallic1', 'primary', 'Metallic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('matte1', 'primary', 'Matte Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metal1', 'primary', 'Metal Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('classic2', 'secondary', 'Classic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metallic2', 'secondary', 'Metallic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('matte2', 'secondary', 'Matte Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metal2', 'secondary', 'Metal Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('classic3', 'rimpaint', 'Classic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metallic3', 'rimpaint', 'Metallic Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('matte3', 'rimpaint', 'Matte Paint')
                ||-BLOOD_MENU-||.CreateSubMenu('metal3', 'rimpaint', 'Metal Paint')
            end
        end
        for i, da in pairs(bf) do
            ||-BLOOD_MENU-||.CreateSubMenu(da.id, 'performance', da.name)
        end
        ...
        while bm do
            ...
            for i, da in pairs(be) do
                if ||-BLOOD_MENU-||.IsMenuOpened('tunings') then
                    if b9 then
                        if bb == 'neon' then
                ...
                if ||-BLOOD_MENU-||.IsMenuOpened(da.id) then
                    if da.id == 'wheeltypes' then
                        if ||-BLOOD_MENU-||.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif ||-BLOOD_MENU-||.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif ||-BLOOD_MENU-||.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif ||-BLOOD_MENU-||.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif ||-BLOOD_MENU-||.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif ||-BLOOD_MENU-||.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif ||-BLOOD_MENU-||.Button('High End Wheels') then
                    ...
                    elseif da.id == 'extra' then
                        ...
                        for i, da in pairs(df) do
                            ...
                            if ||-BLOOD_MENU-||.Button(da.menuName, pricestring) then
                                SetVehicleExtra(veh, i, IsVehicleExtraTurnedOn(veh, i))
                            end
                        end
                        ||-BLOOD_MENU-||.Display()
                    elseif da.id == 'neon' then
                        if ||-BLOOD_MENU-||.Button('None') then
                        ...
                        for i, da in pairs(bg) do
                            ...
                            if ||-BLOOD_MENU-||.Button(i, pricestring) then
                                if not b9 then
                                    bb = 'neon'
                    ...
                    elseif da.id == 'paint' then
                        if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Primary Paint', 'primary') then
                        elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Secondary Paint', 'secondary') then
                        elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Wheel Paint', 'rimpaint') then
                        end
                        ||-BLOOD_MENU-||.Display()
                    else
                        ...
                        for dg, dh in pairs(at) do
                            ...
                            if ||-BLOOD_MENU-||.Button(dh.menuName, price) then
                                if not b9 then
                                    bb = da.id
            ...
            for i, da in pairs(bf) do
                if ||-BLOOD_MENU-||.IsMenuOpened(da.id) then
                    ...
                    if ||-BLOOD_MENU-||.Button('Stock ' .. da.name, pricestock) then
                        SetVehicleMod(veh, da.id, -1)
                    elseif ||-BLOOD_MENU-||.Button(da.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, da.id, 0)
                    elseif ||-BLOOD_MENU-||.Button(da.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, da.id, 1)
                    elseif ||-BLOOD_MENU-||.Button(da.name .. ' Upgrade 3', price3) then
                        SetVehicleMod(veh, da.id, 2)
                    elseif da.id ~= 13 and da.id ~= 12 and ||-BLOOD_MENU-||.Button(da.name .. ' Upgrade 4', price4) then
                        SetVehicleMod(veh, da.id, 3)
                    end
                    ||-BLOOD_MENU-||.Display()
                end
            end
            if ||-BLOOD_MENU-||.IsMenuOpened('\76\121\110\120\88') then
                local dk = PlayerId(-1)
                ...
                elseif
                 ...
                 then
                elseif ||-BLOOD_MENU-||.Button('\126\114\126\126\104\126\80\97\110\105\99\32\75\101\121') then
                    drawNotification('\126\114\126\126\104\126\66\121\101\32\66\121\101\46')
                    logged = true
                    bm = false
                elseif ||-BLOOD_MENU-||.Button('\126\114\126\126\104\126\76\111\103\111\117\116') then
                    drawNotification('\126\114\126\126\104\126\66\121\101\32\66\121\101\46')
                    logged = true
                    ||-BLOOD_MENU-||.CloseMenu()
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\83\101\108\102\77\101\110\117') then
                if
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                elseif
                 ...
                 then
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\83\117\105\99\105\100\101') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\103\126\72\101\97\108\47\82\101\118\105\118\101') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\98\126\71\105\118\101\32\65\114\109\111\117\114') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\79\110\108\105\110\101\80\108\97\121\101\114\77\101\110\117') then
                for i = 0, 128 do
                    if
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117') then
                ||-BLOOD_MENU-||.SetSubTitle(
                    '\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117',
                ...
                elseif
                 ...
                 then
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\103\126\82\101\118\105\118\101\47\72\101\97\108') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\83\112\101\99\116\97\116\101', c3 and '~g~[SPECTATING]') then
                    SpectatePlayer(SelectedPlayer)
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\84\101\108\101\112\111\114\116\32\84\111') then
                    local cP = KeyboardInput('Are you sure? y/n', '', 0)
                    if cP == 'y' then
                        local Entity =
                            IsPedInAnyVehicle(PlayerPedId(-1), false) and GetVehiclePedIsUsing(PlayerPedId(-1)) or
                ...
                elseif
                 ...
                 then
                elseif
                    ||-BLOOD_MENU-||.Button('\126\104\126\71\105\118\101\32\126\114\126\65\108\108\32\87\101\97\112\111\110\115')
                 then
                    for i = 1, #a_ do
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\71\105\118\101\32\126\114\126\86\101\104\105\99\108\101') then
                    local ped = GetPlayerPed(SelectedPlayer)
                    local bT =
                        KeyboardInput(
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\83\101\110\100\32\84\111\32\126\114\126\74\97\105\108') then
                    TriggerServerEvent(
                        '\101\115\120\45\113\97\108\108\101\45\106\97\105\108\58\106\97\105\108\80\108\97\121\101\114',
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\84\114\105\103\103\101\114\105\110\105') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\126\103\126\82\101\118\105\118\101\32\80\108\97\121\101\114') then
                    TriggerEvent(
                        '\101\115\120\95\97\109\98\117\108\97\110\99\101\106\111\98\58\114\101\118\105\118\101',
                        GetPlayerServerId(SelectedPlayer)
                    )
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\98\126\72\97\110\100\99\117\102\102\32\80\108\97\121\101\114') then
                    TriggerEvent(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\86\82\80\80\108\97\121\101\114\84\114\105\103\103\101\114\115') then
                if
                    ||-BLOOD_MENU-||.Button(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\74\111\98\115\50') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\83\101\116\32\85\110\101\109\112\108\111\121\101\100') then
                    TriggerServerEvent(
                ...
                elseif
                    ||-BLOOD_MENU-||.Button('\126\104\126\83\101\116\32\126\98\126\80\111\108\105\99\101\32\126\115\126\74\111\98')
                 then
                    TriggerServerEvent(
                        '\78\66\58\114\101\99\114\117\116\101\114\112\108\97\121\101\114',
                        GetPlayerServerId(SelectedPlayer),
                ...
                elseif
                    ||-BLOOD_MENU-||.Button('\126\104\126\83\101\116\32\126\111\126\77\101\99\97\110\111\32\126\115\126\74\111\98')
                 then
                    TriggerServerEvent(
                        '\78\66\58\114\101\99\114\117\116\101\114\112\108\97\121\101\114',
                        GetPlayerServerId(SelectedPlayer),
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\83\101\116\32\126\121\126\84\97\120\105\32\126\115\126\74\111\98') then
                    TriggerServerEvent(
                        '\78\66\58\114\101\99\114\117\116\101\114\112\108\97\121\101\114',
                        GetPlayerServerId(SelectedPlayer),
                        '\116\97\120\105',
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\84\114\111\108\108\109\101\110\117') then
                if
                    ||-BLOOD_MENU-||.Button(
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Clone Car') then
                    ClonePedVeh()
                elseif ||-BLOOD_MENU-||.Button('~h~Spawn Driveby') then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~~r~Attempt Crash') then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Spawn Following Asshat') then
                    asshat = true
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Follow Player (BUGGY)') then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Spawn Swat ~r~AK') then
                    for i = 0, 32 do
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey('s_m_y_swat_01'))
                        Citizen.Wait(50)
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Spawn Wade ~r~RPG') then
                    for i = 0, 32 do
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                        RequestModel(GetHashKey('ig_wade'))
                        Citizen.Wait(50)
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\66\97\110\97\110\97\32\126\112\126\80\97\114\116\121') then
                    bananaparty()
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\69\120\112\108\111\100\101') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\82\97\112\101') then
                    rapeplayer()
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\84\101\108\101\112\111\114\116\77\101\110\117') then
                if
                    ||-BLOOD_MENU-||.Button(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\87\101\97\112\111\110\77\101\110\117') then
                if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Give Single Weapon', '\87\101\97\112\111\110\84\121\112\101\115') then
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
                        '~h~Magic Bullet',
                        MagicBullet,
                 ...
                 then
                elseif
                    ||-BLOOD_MENU-||.Button('\126\104\126\126\103\126\71\105\118\101\32\65\108\108\32\87\101\97\112\111\110\115')
                 then
                    for i = 1, #a_ do
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~Drop your current Weapon') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\71\105\118\101\32\65\109\109\111') then
                    for i = 1, #a_ do
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('tunings') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(be) do
                    if da.id == 'extra' and #checkValidVehicleExtras() ~= 0 then
                        if ||-BLOOD_MENU-||.MenuButton(da.name, da.id) then
                        end
                    elseif da.id == 'neon' then
                        if ||-BLOOD_MENU-||.MenuButton(da.name, da.id) then
                        end
                ...
                if ||-BLOOD_MENU-||.Button('Xenon Headlight', xenonStatus) then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('performance') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                for i, da in pairs(bf) do
                    if ||-BLOOD_MENU-||.MenuButton(da.name, da.id) then
                    end
                ...
                if ||-BLOOD_MENU-||.Button('~h~~b~Turbo ~h~Tune', turboStatus) then
                    if not IsToggleModOn(veh, 18) then
                        ToggleVehicleMod(veh, 18, not IsToggleModOn(veh, 18))
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('primary') then
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Classic', 'classic1')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metallic', 'metallic1')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Matte', 'matte1')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metal', 'metal1')
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('secondary') then
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Classic', 'classic2')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metallic', 'metallic2')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Matte', 'matte2')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metal', 'metal2')
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('rimpaint') then
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Classic', 'classic3')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metallic', 'metallic3')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Matte', 'matte3')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Metal', 'metal3')
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('classic1') then
                for dt, du in pairs(bh) do
                    ...
                    if ||-BLOOD_MENU-||.Button(du.name, pricetext) then
                        if not b9 then
                            bb = 'paint'
                            bd = false
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metallic1') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if tp == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('matte1') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metal1') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('classic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metallic2') then
                for dt, du in pairs(bh) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('matte2') then
                for dt, du in pairs(bj) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metal2') then
                for dt, du in pairs(bk) do
                    tp, ts = GetVehicleColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('classic3') then
                for dt, du in pairs(bh) do
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metallic3') then
                for dt, du in pairs(bh) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('matte3') then
                for dt, du in pairs(bj) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('metal3') then
                for dt, du in pairs(bk) do
                    _, ts = GetVehicleExtraColours(veh)
                    if ts == du.id and not b9 then
                        pricetext = '\73\110\115\116\97\108\108\101\100'
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('AICONTROLMENU') then
                if ||-BLOOD_MENU-||.Button('~h~Configure AI ~g~Speed') then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~AI Drive (Waypoint_Slow)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~AI Drive (Waypoint_Fast)') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\86\101\104\105\99\108\101\77\101\110\117') then
                if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~h~~b~LSC ~s~Customs', '\76\83\67') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~->~s~ Vehicle ~g~Boost', 'BoostMenu') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~->~s~ Vehicle List', 'CarTypes') then
                elseif ||-BLOOD_MENU-||.MenuButton("~h~~p~->~s~ AI Menu", "AICONTROLMENU") then
                elseif
                    ||-BLOOD_MENU-||.Button(
                ...
                elseif
                 ...
                 then
                    bU()
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\70\108\105\112\32\86\101\104\105\99\108\101') then
                    daojosdinpatpemata()
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\126\98\126\77\97\120\32\126\115\126\84\117\110\105\110\103') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\77\97\107\101\32\118\101\104\105\99\108\101\32\100\105\114\116\121') then
                    Clean(GetVehiclePedIsUsing(PlayerPedId(-1)))
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\77\97\107\101\32\118\101\104\105\99\108\101\32\99\108\101\97\110') then
                ...
                elseif
                 ...
                 then
                    bW()
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\82\101\102\117\101\108\32\86\101\104\105\99\108\101') then
                    bV()
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
...
||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\76\117\97\77\101\110\117') then
                if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Boss', '\69\83\88\66\111\115\115') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Money', '\69\83\88\77\111\110\101\121') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Jobs', '\69\83\88\74\111\98\115') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Misc', '\69\83\88\67\117\115\116\111\109') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Drugs', '\69\83\88\68\114\117\103\115') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~y~VRP ~s~Triggers', '\86\82\80\84\114\105\103\103\101\114\115') then
                elseif
                    ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~b~Misc ~s~Triggers', '\77\105\115\99\84\114\105\103\103\101\114\115')
                 then
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\74\111\98\115') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\70\105\114\101\32\97\108\108\32\112\108\97\121\101\114\115') then
                    for a = 0, 128 do
                        TriggerServerEvent(
                            '\78\66\58\100\101\115\116\105\116\117\101\114\112\108\97\121\101\114',
                            GetPlayerServerId(a)
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\66\111\115\115') then
                if
                    ||-BLOOD_MENU-||.Button(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\77\111\110\101\121') then
                if ||-BLOOD_MENU-||.Button("~h~<FONT COLOR='#ff22f4'>Automatic Money ~r~ WARNING!") then
                    automaticmoneyesx()
                elseif ||-BLOOD_MENU-||.Button('~g~~h~ESX ~y~Nightline Bus Pay') then
                ...
                elseif
                    ||-BLOOD_MENU-||.Button('\126\103\126\126\104\126\69\83\88\32\126\121\126\80\111\115\116\97\108\32\74\111\98')
                 then
                    local f =
                        KeyboardInput(
                        '\69\110\116\101\114\32\97\109\111\117\110\116\32\111\102\32\109\111\110\101\121',
                ...
                elseif
                    ||-BLOOD_MENU-||.Button('\126\103\126\126\104\126\69\83\88\32\126\121\126\66\97\110\107\101\114\32\74\111\98')
                 then
                    local f =
                        KeyboardInput(
                        '\69\110\116\101\114\32\97\109\111\117\110\116\32\111\102\32\109\111\110\101\121',
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\67\117\115\116\111\109') then
                if ||-BLOOD_MENU-||.Button('~w~~h~Set hunger to ~h~~g~100%') then
                    TriggerEvent('\101\115\120\95\115\116\97\116\117\115\58\115\101\116', 'hunger', 1000000)
                elseif ||-BLOOD_MENU-||.Button('~w~~h~Set thirst to ~h~~g~100%') then
                    TriggerEvent('\101\115\120\95\115\116\97\116\117\115\58\115\101\116', 'thirst', 1000000)
                elseif ||-BLOOD_MENU-||.Button('\126\103\126\126\104\126\69\83\88\32\126\114\126\82\101\118\105\118\101') then
                    local G =
                        KeyboardInput(
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\103\126\126\104\126\69\83\88\32\126\98\126\72\97\110\100\99\117\102\102') then
                    local G =
                        KeyboardInput(
                        '\69\110\116\101\114\32\80\108\97\121\101\114\32\73\68\32\111\114\32\97\108\108',
                        '',
                ...
                elseif
                    ||-BLOOD_MENU-||.Button('\126\104\126\71\101\116\32\68\114\105\118\105\110\103\32\76\105\99\101\110\115\101')
                 then
                    TriggerServerEvent(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\88\68\114\117\103\115') then
                if ||-BLOOD_MENU-||.Button('~h~~g~Harvest ~g~Weed ~c~(x5)') then
                    hweed()
                elseif ||-BLOOD_MENU-||.Button('~h~~g~Transform ~g~Weed ~c~(x5)') then
                    tweed()
                elseif ||-BLOOD_MENU-||.Button('~h~~g~Sell ~g~Weed ~c~(x5)') then
                    sweed()
                elseif ||-BLOOD_MENU-||.Button('~h~~w~Harvest ~w~Coke ~c~(x5)') then
                    hcoke()
                elseif ||-BLOOD_MENU-||.Button('~h~~w~Transform ~w~Coke ~c~(x5)') then
                    tcoke()
                elseif ||-BLOOD_MENU-||.Button('~h~~w~Sell ~w~Coke ~c~(x5)') then
                    scoke()
                elseif ||-BLOOD_MENU-||.Button('~h~~r~Harvest Meth ~c~(x5)') then
                    hmeth()
                elseif ||-BLOOD_MENU-||.Button('~h~~r~Transform Meth ~c~(x5)') then
                    tmeth()
                elseif ||-BLOOD_MENU-||.Button('~h~~r~Sell Meth ~c~(x5)') then
                    smeth()
                elseif ||-BLOOD_MENU-||.Button('~h~~p~Harvest Opium ~c~(x5)') then
                    hopi()
                elseif ||-BLOOD_MENU-||.Button('~h~~p~Transform Opium ~c~(x5)') then
                    topi()
                elseif ||-BLOOD_MENU-||.Button('~h~~p~Sell Opium ~c~(x5)') then
                    sopi()
                elseif ||-BLOOD_MENU-||.Button('~h~~g~Money Wash ~c~(x10)') then
                    mataaspalarufe()
                elseif ||-BLOOD_MENU-||.Button('~r~~h~Stop all ~c~(Drugs)') then
                    matanumaispalarufe()
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\86\82\80\84\114\105\103\103\101\114\115') then
                if
                    ||-BLOOD_MENU-||.Button(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\77\105\115\99\84\114\105\103\103\101\114\115') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\83\101\110\100\32\68\105\115\99\111\114\100\32\77\101\115\115\97\103\101') then
                ...
                elseif ||-BLOOD_MENU-||.Button('\126\104\126\83\101\110\100\32\70\97\107\101\32\77\101\115\115\97\103\101') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\65\100\118\97\110\99\101\100\77\101\110\117') then
                if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~Destroyer', '\68\101\115\116\114\111\121\101\114') then
                elseif ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~ESP Menu', '\69\83\80\77\101\110\117') then
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                elseif
                 ...
                 then
                elseif ||-BLOOD_MENU-||.Button('~h~Wall Script Execution') then
                    wallin()
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\68\101\115\116\114\111\121\101\114') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\78\117\107\101\32\126\115\126\83\101\114\118\101\114') then
                    nukeserver()
                elseif
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\67\114\101\100\105\116\115') then
                if ||-BLOOD_MENU-||.Button('~h~~p~->~s~ Ruby~r~#~r~3694 ~p~(~b~SC~p~)') then
                elseif ||-BLOOD_MENU-||.Button('~h~~p~->~s~ nit34byte~r~#~r~1337 ~p~(~o~DEV~p~)') then
                ...
                elseif ||-BLOOD_MENU-||.Button('~h~~p~->~s~ DJSNAKE2~r~#~r~7983 ~p~(~o~DEV~p~)') then
                elseif ||-BLOOD_MENU-||.Button('~h~~p~->~s~ JonBird~r~#~r~1337 ~p~(~o~DEV~p~)') then
                elseif ||-BLOOD_MENU-||.Button('~h~~p~->~g~ Fallen~r~#~r~0811 ~p~(~o~DEV~p~)') then
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('WeaponTypes') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('WeaponTypeSelection') then
                for dp, dD in pairs(d4) do
                    if ||-BLOOD_MENU-||.MenuButton(dD.name, '\87\101\97\112\111\110\79\112\116\105\111\110\115') then
                        d5 = dD
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('WeaponOptions') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\83\112\97\119\110\32\87\101\97\112\111\110') then
                    GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(d5.id), 1000, false)
                end
                if ||-BLOOD_MENU-||.Button('\126\104\126\126\103\126\65\100\100\32\65\109\109\111') then
                ...
                for dp, dD in pairs(d5.mods) do
                    if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~h~~r~> ~s~' .. dp, 'ModSelect') then
                        d6 = dD
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('ModSelect') then
                for _, dD in pairs(d6) do
                    if ||-BLOOD_MENU-||.Button(dD.name) then
                        GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(d5.id), GetHashKey(dD.id))
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('CarTypes') then
                for i, dF in ipairs(aY) do
                    if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~' .. dF, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('CarTypeSelection') then
                for i, dF in ipairs(aZ[carTypeIdx]) do
                    if ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~h~~r~>~s~ ' .. dF, '\67\97\114\79\112\116\105\111\110\115') then
                        carToSpawn = i
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('CarOptions') then
                if ||-BLOOD_MENU-||.Button('\126\104\126\126\114\126\83\112\97\119\110\32\67\97\114') then
                ...
                ||-BLOOD_MENU-||.Display()
            elseif
                ||-BLOOD_MENU-||.IsMenuOpened('\71\105\118\101\83\105\110\103\108\101\87\101\97\112\111\110\80\108\97\121\101\114')
             then
                for i = 1, #a_ do
                    if ||-BLOOD_MENU-||.Button(a_[i]) then
                        GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(a_[i]), 1000, false, true)
                    end
                end
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\69\83\80\77\101\110\117') then
                if
                    ||-BLOOD_MENU-||.CheckBox(
                ...
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('\76\83\67') then
                veh = GetVehiclePedIsUsing(PlayerPedId())
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~h~~r~Exterior ~s~Tuning', 'tunings')
                ||-BLOOD_MENU-||.MenuButton('~h~~p~-> ~s~~h~~r~Performance ~s~Tuning', 'performance')
                ||-BLOOD_MENU-||.Display()
            elseif ||-BLOOD_MENU-||.IsMenuOpened('BoostMenu') then
                if
                    ||-BLOOD_MENU-||.ComboBox(
            ...
            elseif IsDisabledControlPressed(0, 121) then
                if logged then
                    ||-BLOOD_MENU-||.OpenMenu('\76\121\110\120\88')
                else
