    ...
    function()
        ...
        while bw do
            ...
            elseif LynxEvo.IsMenuOpened('crds') then
                if LynxEvo.Button('~h~~p~#~s~ shit34byte~r~#~r~0000 ~p~DEV') then
                    av('~h~~o~Dont click me BAKA!~s~.', false)
                    av('Im a fag?', false)
                    av('I had to take the liberty to modify this', false)
                elseif LynxEvo.Button('~h~~p~#~s~ vjuton~r~#~r~0000 ~p~DEV') then
                elseif LynxEvo.Button('~h~~p~#~s~ Łypcia~r~#~r~1337 ~p~DEV') then
                end
                LynxEvo.Display()
