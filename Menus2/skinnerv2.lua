    ...
    local message = "Skinner#1000 BEST CHEATS https://discord.gg/yHMzUsb"
    
    local logged = false
    local pass = "Skinner1223"
...
local function SetRP()
    ...
    SetRichPresence(tostring(nname) .. ' is developing SKINNER Modding Team')
...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^Skinner Memes",{141,211,255},"~g~Skinner Menu created by Skinner#1000: https://discord.gg/yHMzUsb")
            end
    ...
    Citizen.CreateThread(
        function()
            ...
            Outcasts666.CreateMenu("MainMenu", "~p~ Skinner ~p~ Memes")
            ...
            Outcasts666.CreateSubMenu("LS Customs", "VehMenu", "Welcome To Nigger Customs!")
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~Welcome To Skinner Memes!!!")
                ...
                if intro2 == 0 and intro >= 100 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~TO OPEN MENU PRESS F7   skinner#1000 :)")
                    DrawScaleformMovieFullscreen(scaleform, 80, 80, 80, 80, 0)
                    Citizen.CreateThread(function()
                        while true do
                            Wait(2000)
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and Outcasts666.Button(dA.name.." Upgrade 4", price4) then 
                ...
                if Outcasts666.IsMenuOpened("MainMenu") then
                    drawNotification("Skinner Memes Created By: Skinner#1000 https://discord.gg/yHMzUsb")
                ...
                elseif Outcasts666.IsMenuOpened("Credits") then
                    if Outcasts666.Button("Skinner Memes created by: Skinner#1000 https://discord.gg/yHMzUsb") then
                    end
			...
			local model = "mp_m_freemode_01"
                ...
                elseif IsDisabledControlPressed(0, 168) then --F7
                    if logged then
                        ...
                        if temp == pass then
                            drawNotification("~g~ welcome mother fucker!")
                            logged = true
                            Outcasts666.OpenMenu("MainMenu")
                        else
