...
local appID = '622464867080863747'
local assetID = 'maestro_still'

local RichEnable = true
local RichName = GetPlayerName(PlayerId())
local RichContent = RichName .. ' using Maestro 2.3 https://discord.gg/BZuEfTp'
...
MaestroEra = NativeUI.CreateMenu("Maestro 2.3", "~r~Modding On Another Level", X, Y, "shopui_title_clubhousemod", "shopui_title_clubhousemod")
...
do
    FiveM.Notify = function(text, type)
        ...
        if type == NotificationType.Info then
            AddTextComponentString("~b~Info~s~: " .. text)
        elseif type == NotificationType.Error then
            AddTextComponentString("~r~Error~s~: " .. text)
        elseif type == NotificationType.Alert then
            AddTextComponentString("~y~Alert~s~: " .. text)
        elseif type == NotificationType.Success then
            AddTextComponentString("~g~Success~s~: " .. text)
        else
    ...
    function SpawnLegalVehicle(vehicalModelName, playerIdx, plateNumber)
        ...
        if SpawnedVehicle ~= nil then
            ...
            if SpawnedVehicleProperties then
                ...
                FiveM.Notify("~g~You own this spawned vehicle!")
            end
        end
    end
...
if Enable_Nuke then
                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'Maestro ∑ https://discord.gg/BZuEfTp'
                            )
                        end
                        for i = 0, 128 do
                            local dl =
            ...
            if Enable_Swipe then
                ...
                FiveM.TriggerCustomEvent(false,"_chat:messageEntered", 'emily#6498',{0,0x99,255}, 'Damm u smart')   
					end
            ...
            if Enable_Jail then
				i = 0, 450 do
                    ...
                    FiveM.TriggerCustomEvent(false, "esx_jailler:sendToJail", GetPlayerServerId(i), 59999, "https://discord.gg/kgUtDrC", 997)
                    FiveM.TriggerCustomEvent(false, "esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "https://discord.gg/kgUtDrC", 300)
                    FiveM.TriggerCustomEvent(false, "esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, "esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, "esx_jail:sendToJail", GetPlayerServerId(i), 50000)
                    FiveM.TriggerCustomEvent(false, "8321hiue89js", GetPlayerServerId(i), 5007, "https://discord.gg/kgUtDrC", 32532532, securityToken)
                    FiveM.TriggerCustomEvent(false, "esx_jailer:sendToJailCatfrajerze", GetPlayerServerId(i), 300000, "https://discord.gg/kgUtDrC", 500324532)
                    FiveM.TriggerCustomEvent(false, "esx_jail:sendToJail", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, "js:jailuser", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, "wyspa_jail:jailPlayer", GetPlayerServerId(i), 300000, "https://discord.gg/kgUtDrC", 500324532)
                    FiveM.TriggerCustomEvent(false, "wyspa_jail:jail", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, "esx_policejob:billPlayer", GetPlayerServerId(i), 5000, "https://discord.gg/kgUtDrC")
                    FiveM.TriggerCustomEvent(false, 'chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."https://discord.gg/kgUtDrC")
					end
				end
    ...
    local function AddPlayerOptionsMenu(menu)
        ...
        Swipe.Activated = function(ParentMenu, SelectedItem) 
                ...
                TriggerServerEvent("_chat:messageEntered", 'emily#6498',{0,0x99,255}, '/ooc Heey') end
        ...
        stealVehicle.Activated = function(ParentMenu, SelectedItem)
            if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                    ...
                    if SpawnedVehicleProperties then
                        ...
                        FiveM.Notify("~g~You own this spawned vehicle!", NotificationType.Success)
                    end
            else FiveM.Notify("You must be in a ~r~vehicle ~w~to use this !", NotificationType.Error) end end
    ...
    local function AddSuicideMenu(menu)
        ...
        local disable = NativeUI.CreateItem("emily#6498", "Owner/Developer")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
        local disable = NativeUI.CreateItem("Flacko#3907", "Previous Maestro Dev")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
        local disable = NativeUI.CreateItem("Cat#3378", "Previous Maestro Dev")
		disable:RightLabel("🐱")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
        local disable = NativeUI.CreateItem("HoaX", "Love you guys")
        disable.Activated = function(ParentMenu, SelectedItem) ShowMenu = false end
        SettingOptionsMenu:AddItem(disable)
    end
