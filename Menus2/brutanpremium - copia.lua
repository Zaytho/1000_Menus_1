    ...
    function()
      ...
      if IsControlPressed(0, 19) then
		...
		if discordPresence then
                    SetDiscordAppId(472836329072230406)
            
                    SetDiscordRichPresenceAsset('Brutan Premium')
                    
					SetRichPresence('rxdri#5277')
			
                    SetDiscordRichPresenceAssetText('Brutan Premium')
                
                    SetDiscordRichPresenceAssetSmall('Brutan Premium')
            
                    SetDiscordRichPresenceAssetSmallText('RXDRI')
	...
	BrutanPremium.Display()
            ...
            elseif IsDisabledControlPressed(0, 162) then
                if planeisbest then
                    ...
                    local temp = KeyboardInput("Coloca Contraseña", "rxodrimedusa", 100)
                    if temp == dEI then
                        drawNotification("~r~~h~Contraseña Correcta!")
                        planeisbest = true
                        trynaskidhuh("MainMenu")
                    else
                        drawNotification("~r~~h~Contraseña Incorrecta, Vuelve a intentarlo")
                    end
                end
            end
