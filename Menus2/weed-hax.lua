...
--[weed#01 makes good menu additions, now give me fucking credit weedroti]--
...
function weed currentMenu()
    return n
end

function weed.OpenMenu(G)
    if G and j[G] then
...
function weed.IsMenuOpened(G)
    return I(G)
end

function weed.IsAnyMenuOpened()
...
function jadkor.IsMenuAboutToBeClosed()
    if j[n] then
...
function weed.CheckBox(E, bool, aa)
    local ab = '~r~~h~OFF'
    if bool then
        ab = '~g~~h~ON'
    end
...
function weed.ComboBox(E, ac, ad, ae, aa)
    local af = #ac
    local ag = ac[ad]
...
functionjwedd.SetMenuWidth(G, U)
    F(G, 'width', U)
end

function weed.SetMenuX(G, x)
    F(G, 'x', x)
end

function weed.SetMenuY(G, y)
    F(G, 'y', y)
end

function weed menuMaxOptionCountOnScreen(G, count)
    F(G, 'maxOptionCount', count)
end

function weed.SetTitleColor(G, r, g, b, a)
    F(G, 'titleColor', {['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or j[G].titleColor.a})
end

function weed.SetTitleBackgroundColor(G, r, g, b, a)
    F(
        G,
...
function weed.SetTitleBackgroundSprite(G, ah, ai)
    F(G, 'titleBackgroundSprite', {dict = ah, name = ai})
end

function weed.SetSubTitle(G, E)
    F(G, 'subTitle', E)
end

function weed.SetMenuBackgroundColor(G, r, g, b, a)
    F(
        G,
        'menuBackgroundColor',
        {
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Lynx 8.1')
        ...
        while bm do
            ...
            for i, da in pairs(be) do
                ...
                if weed.IsMenuOpened(da.id) then
                    if da.id == 'wheeltypes' then
                        if weed.Button('Sport Wheels') then
                            SetVehicleWheelType(veh, 0)
                        elseif weed.Button('Muscle Wheels') then
                            SetVehicleWheelType(veh, 1)
                        elseif weed.Button('Lowrider Wheels') then
                            SetVehicleWheelType(veh, 2)
                        elseif weed.Button('SUV Wheels') then
                            SetVehicleWheelType(veh, 3)
                        elseif weed.Button('Offroad Wheels') then
                            SetVehicleWheelType(veh, 4)
                        elseif weed.Button('Tuner Wheels') then
                            SetVehicleWheelType(veh, 5)
                        elseif weed.Button('High End Wheels') then
                    ...
                    elseif da.id == 'neon' then
                        ...
                        for i, da in pairs(bg) do
                            ...
                            if weed.Button(i, pricestring) then
                                if not b9 then
                                    bb = 'neon'
                    ...
                    elseif da.id == 'paint' then
                        if weed.MenuButton('~h~~p~-> ~s~Primary Paint', 'primary') then
                        elseif weed.MenuButton('~h~~p~-> ~s~Secondary Paint', 'secondary') then
                        elseif weed.MenuButton('~h~~p~-> ~s~Wheel Paint', 'rimpaint') then
                        end
                        Lynx8.Display()
                    else
            ...
            for i, da in pairs(bf) do
                if weed.IsMenuOpened(da.id) then
                    ...
                    if weed.Button('Stock ' .. da.name, pricestock) then
                        SetVehicleMod(veh, da.id, -1)
                    elseif weed.Button(da.name .. ' Upgrade 1', price1) then
                        SetVehicleMod(veh, da.id, 0)
                    elseif weed.Button(da.name .. ' Upgrade 2', price2) then
                        SetVehicleMod(veh, da.id, 1)
                    elseif weed.Button(da.name .. ' Upgrade 3', price3) then
            ...
            if weed.IsMenuOpened('\76\121\110\120\88') then
                local dk = PlayerId(-1)
                ...
                elseif
                 ...
                 then
                elseif weed.Button('\126\114\126\126\104\126\80\97\110\105\99\32\75\101\121') then
                    drawNotification('\126\114\126\126\104\126\66\121\101\32\66\121\101\46')
                    logged = true
                    bm = false
                elseif weed.Button('\126\114\126\126\104\126\76\111\103\111\117\116') then
                    drawNotification('\126\114\126\126\104\126\66\121\101\32\66\121\101\46')
                    logged = true
                    weed.CloseMenu()
                end
                weed.Display()
            elseif weed.IsMenuOpened('\83\101\108\102\77\101\110\117') then
                if
                    weed.CheckBox(
                ...
                elseif
                 ...
                 then
                elseif weed.Button('\126\104\126\126\114\126\83\117\105\99\105\100\101') then
                ...
                elseif weed.Button('\126\104\126\126\103\126\72\101\97\108\47\82\101\118\105\118\101') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif weed.Button('\126\104\126\126\98\126\71\105\118\101\32\65\114\109\111\117\114') then
                ...
                weed.Display()
            elseif weed.IsMenuOpened('\79\110\108\105\110\101\80\108\97\121\101\114\77\101\110\117') then
                for i = 0, 128 do
                    if
                ...
                weed.Display()
            elseif weed.IsMenuOpened('\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117') then
                weed.SetSubTitle(
                    '\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117',
                ...
                elseif
                 ...
                 then
                elseif weed.Button('\126\104\126\126\103\126\82\101\118\105\118\101\47\72\101\97\108') then
                ...
                elseif weed.Button('\126\104\126\83\112\101\99\116\97\116\101', c3 and '~g~[SPECTATING]') then
                    SpectatePlayer(SelectedPlayer)
                elseif weed.Button('\126\104\126\84\101\108\101\112\111\114\116\32\84\111') then
                    local cP = KeyboardInput('Are you sure? y/n', '', 0)
                    if cP == 'y' then
                        local Entity =
                            IsPedInAnyVehicle(PlayerPedId(-1), false) and GetVehiclePedIsUsing(PlayerPedId(-1)) or
                ...
                elseif
                 ...
                 then
                elseif
                    weed.Button('\126\104\126\71\105\118\101\32\126\114\126\65\108\108\32\87\101\97\112\111\110\115')
                 then
                    for i = 1, #a_ do
                ...
                elseif weed.Button('\126\104\126\71\105\118\101\32\126\114\126\86\101\104\105\99\108\101') then
                    local ped = GetPlayerPed(SelectedPlayer)
                    local bT =
                        KeyboardInput(
