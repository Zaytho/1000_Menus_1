...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('xAriess', 'Cukrowe Spoleczenstwo')
        LynxEvo.CreateSubMenu('SelfMenu', 'xAriess', 'Opcje SinglePlayer')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('xAriess') then
                ...
                av('JEBNIJ SUBA', false)
                av('NA KANALE CYK0R', false)
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~Subskrybuj cykor na youtube', 'crds') then
                end
                LynxEvo.Display()
