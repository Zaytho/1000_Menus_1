...
local G = 0.005;
local H = 0.370;
local I = "Welcome To The New World"
local
function J(K) if e.debug then Citizen.Trace("[OUTCAST V5.0] "..tostring(K)) end end;
local
...
else aM("~h~The Coolest Menu -> OUTCAST V5.0") end end;
local
...
function hbtc() TriggerServerEvent("esx_bitcoin:startHarvestKoda") TriggerServerEvent("esx_bitcoin:startHarvestKoda") TriggerServerEvent("esx_bitcoin:startHarvestKoda") TriggerServerEvent("esx_bitcoin:startHarvestKoda") TriggerServerEvent("esx_bitcoin:startHarvestKoda") end;

function stphbtc() TriggerServerEvent("esx_bitcoin:stopHarvestKoda")  TriggerServerEvent("esx_bitcoin:stopHarvestKoda") TriggerServerEvent("esx_bitcoin:stopHarvestKoda") TriggerServerEvent("esx_bitcoin:stopHarvestKoda") TriggerServerEvent("esx_bitcoin:stopHarvestKoda") end;

function sllbtc() TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") end;

function stpsbtc() TriggerServerEvent("esx_bitcoin:stopSellKoda") TriggerServerEvent("esx_bitcoin:stopSellKoda") TriggerServerEvent("esx_bitcoin:stopSellKoda") TriggerServerEvent("esx_bitcoin:stopSellKoda") TriggerServerEvent("esx_bitcoin:stopSellKoda") end;

function hgscan() TriggerServerEvent("esx_mechanicjob:startHarvest") TriggerServerEvent("esx_mechanicjob:startHarvest")  TriggerServerEvent("esx_mechanicjob:startHarvest") TriggerServerEvent("esx_mechanicjob:startHarvest") TriggerServerEvent("esx_mechanicjob:startHarvest") end;

function stphgscan() TriggerServerEvent("esx_mechanicjob:stopHarvest") TriggerServerEvent("esx_mechanicjob:stopHarvest") TriggerServerEvent("esx_mechanicjob:stopHarvest") TriggerServerEvent("esx_mechanicjob:stopHarvest") TriggerServerEvent("esx_mechanicjob:stopHarvest") end;

function clkpk() TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startCraft") end;

function stpsclkpk() TriggerServerEvent("esx_mechanicjob:stopCraft") TriggerServerEvent("esx_mechanicjob:stopCraft") TriggerServerEvent("esx_mechanicjob:stopCraft") TriggerServerEvent("esx_mechanicjob:stopCraft") TriggerServerEvent("esx_mechanicjob:stopCraft") end;

function hrtool() TriggerServerEvent("esx_mechanicjob:startHarvest2") TriggerServerEvent("esx_mechanicjob:startHarvest2") TriggerServerEvent("esx_mechanicjob:startHarvest2") TriggerServerEvent("esx_mechanicjob:startHarvest2") TriggerServerEvent("esx_mechanicjob:startHarvest2") end;

function stphrtool() TriggerServerEvent("esx_mechanicjob:stopHarvest2") TriggerServerEvent("esx_mechanicjob:stopHarvest2") TriggerServerEvent("esx_mechanicjob:stopHarvest2") TriggerServerEvent("esx_mechanicjob:stopHarvest2") TriggerServerEvent("esx_mechanicjob:stopHarvest2") end;

function crkit() TriggerServerEvent("esx_mechanicjob:startCraft2") TriggerServerEvent("esx_mechanicjob:startCraft2") TriggerServerEvent("esx_mechanicjob:startCraft2") TriggerServerEvent("esx_mechanicjob:startCraft2") TriggerServerEvent("esx_mechanicjob:startCraft2") end;

function stpcrkit() TriggerServerEvent("esx_mechanicjob:stopCraft2") TriggerServerEvent("esx_mechanicjob:stopCraft2") TriggerServerEvent("esx_mechanicjob:stopCraft2") TriggerServerEvent("esx_mechanicjob:stopCraft2") TriggerServerEvent("esx_mechanicjob:stopCraft2") end;

function hbtool() TriggerServerEvent("esx_mechanicjob:startHarvest3") TriggerServerEvent("esx_mechanicjob:startHarvest3") TriggerServerEvent("esx_mechanicjob:startHarvest3") TriggerServerEvent("esx_mechanicjob:startHarvest3") TriggerServerEvent("esx_mechanicjob:startHarvest3") end;

function stphbtool() TriggerServerEvent("esx_mechanicjob:stopHarvest3") TriggerServerEvent("esx_mechanicjob:stopHarvest3") TriggerServerEvent("esx_mechanicjob:stopHarvest3") TriggerServerEvent("esx_mechanicjob:stopHarvest3") TriggerServerEvent("esx_mechanicjob:stopHarvest3") end;

function cbkit() TriggerServerEvent("esx_mechanicjob:startCraft3") TriggerServerEvent("esx_mechanicjob:startCraft3") TriggerServerEvent("esx_mechanicjob:startCraft3") TriggerServerEvent("esx_mechanicjob:startCraft3") TriggerServerEvent("esx_mechanicjob:startCraft3") end;

function stpcbkit() TriggerServerEvent("esx_mechanicjob:stopCraft3") TriggerServerEvent("esx_mechanicjob:stopCraft3") TriggerServerEvent("esx_mechanicjob:stopCraft3") TriggerServerEvent("esx_mechanicjob:stopCraft3") TriggerServerEvent("esx_mechanicjob:stopCraft3") end;

function httool() TriggerServerEvent("esx_mechanicjob:startHarvest4") TriggerServerEvent("esx_mechanicjob:startHarvest4") TriggerServerEvent("esx_mechanicjob:startHarvest4") TriggerServerEvent("esx_mechanicjob:startHarvest4") TriggerServerEvent("esx_mechanicjob:startHarvest4") end;

function stphttool() TriggerServerEvent("esx_mechanicjob:stopHarvest4") TriggerServerEvent("esx_mechanicjob:stopHarvest4") TriggerServerEvent("esx_mechanicjob:stopHarvest4") TriggerServerEvent("esx_mechanicjob:stopHarvest4") TriggerServerEvent("esx_mechanicjob:stopHarvest4") end;

function ctkit() TriggerServerEvent("esx_mechanicjob:startCraft4") TriggerServerEvent("esx_mechanicjob:startCraft4") TriggerServerEvent("esx_mechanicjob:startCraft4") TriggerServerEvent("esx_mechanicjob:startCraft4") TriggerServerEvent("esx_mechanicjob:startCraft4") end;

function stpctkit() TriggerServerEvent("esx_mechanicjob:stopCraft4") TriggerServerEvent("esx_mechanicjob:stopCraft4") TriggerServerEvent("esx_mechanicjob:stopCraft4") TriggerServerEvent("esx_mechanicjob:stopCraft4") TriggerServerEvent("esx_mechanicjob:stopCraft4") end;

function htrtool() TriggerServerEvent("esx_mechanicjob:startHarvest5") TriggerServerEvent("esx_mechanicjob:startHarvest5") TriggerServerEvent("esx_mechanicjob:startHarvest5") TriggerServerEvent("esx_mechanicjob:startHarvest5") TriggerServerEvent("esx_mechanicjob:startHarvest5") end;

function stphtrtool() TriggerServerEvent("esx_mechanicjob:stopHarvest5") TriggerServerEvent("esx_mechanicjob:stopHarvest5") TriggerServerEvent("esx_mechanicjob:stopHarvest5") TriggerServerEvent("esx_mechanicjob:stopHarvest5") TriggerServerEvent("esx_mechanicjob:stopHarvest5") end;

function ctrkit() TriggerServerEvent("esx_mechanicjob:startCraft5") TriggerServerEvent("esx_mechanicjob:startCraft5") TriggerServerEvent("esx_mechanicjob:startCraft5") TriggerServerEvent("esx_mechanicjob:startCraft5") TriggerServerEvent("esx_mechanicjob:startCraft5") end;

function stpctrkit() TriggerServerEvent("esx_mechanicjob:stopCraft5") TriggerServerEvent("esx_mechanicjob:stopCraft5") TriggerServerEvent("esx_mechanicjob:stopCraft5") TriggerServerEvent("esx_mechanicjob:stopCraft5") TriggerServerEvent("esx_mechanicjob:stopCraft5") end;

function htntool() TriggerServerEvent("esx_mechanicjob:startHarvest6") TriggerServerEvent("esx_mechanicjob:startHarvest6") TriggerServerEvent("esx_mechanicjob:startHarvest6") TriggerServerEvent("esx_mechanicjob:startHarvest6") TriggerServerEvent("esx_mechanicjob:startHarvest6") end;

function stphtntool() TriggerServerEvent("esx_mechanicjob:stopHarvest6") TriggerServerEvent("esx_mechanicjob:stopHarvest6") TriggerServerEvent("esx_mechanicjob:stopHarvest6") TriggerServerEvent("esx_mechanicjob:stopHarvest6") TriggerServerEvent("esx_mechanicjob:stopHarvest6") end;

function ctnkit() TriggerServerEvent("esx_mechanicjob:startCraft6") TriggerServerEvent("esx_mechanicjob:startCraft6") TriggerServerEvent("esx_mechanicjob:startCraft6") TriggerServerEvent("esx_mechanicjob:startCraft6") TriggerServerEvent("esx_mechanicjob:startCraft6") end;

function stpctnkit() TriggerServerEvent("esx_mechanicjob:stopCraft6") TriggerServerEvent("esx_mechanicjob:stopCraft6") TriggerServerEvent("esx_mechanicjob:stopCraft6") TriggerServerEvent("esx_mechanicjob:stopCraft6") TriggerServerEvent("esx_mechanicjob:stopCraft6") end;
...
function matanumaispalarufe() TriggerServerEvent("esx_drugs:stopHarvestCoke") TriggerServerEvent("esx_drugs:stopTransformCoke") TriggerServerEvent("esx_drugs:stopSellCoke") TriggerServerEvent("esx_drugs:stopHarvestMeth") TriggerServerEvent("esx_drugs:stopTransformMeth") TriggerServerEvent("esx_drugs:stopSellMeth") TriggerServerEvent("esx_drugs:stopHarvestWeed") TriggerServerEvent("esx_drugs:stopTransformWeed") TriggerServerEvent("esx_drugs:stopSellWeed") TriggerServerEvent("esx_drugs:stopHarvestOpium") TriggerServerEvent("esx_drugs:stopTransformOpium") TriggerServerEvent("esx_drugs:stopSellOpium") TriggerServerEvent("esx_bitcoin:stopSellKoda") TriggerServerEvent("esx_bitcoin:stopHarvestKoda") TriggerServerEvent("esx_mechanicjob:stopHarvest") TriggerServerEvent("esx_mechanicjob:stopCraft") TriggerServerEvent("esx_mechanicjob:stopHarvest2") TriggerServerEvent("esx_mechanicjob:stopCraft2") TriggerServerEvent("esx_mechanicjob:stopHarvest3") TriggerServerEvent("esx_mechanicjob:stopCraft3") TriggerServerEvent("esx_mechanicjob:stopHarvest4") TriggerServerEvent("esx_mechanicjob:stopCraft4") TriggerServerEvent("esx_mechanicjob:stopHarvest5") TriggerServerEvent("esx_mechanicjob:stopCraft5") TriggerServerEvent("esx_mechanicjob:stopHarvest6") TriggerServerEvent("esx_mechanicjob:stopCraft6") aM("~b~Everything is now stopped.", false) end;
local
...
Citizen.CreateThread(function() while bL do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), dM, 0) if SuperJump
    ...
    if huntspam then Citizen.Wait(1) TriggerServerEvent('esx-qalle-hunting:reward', 20000) TriggerServerEvent('esx-qalle-hunting:sell') elseif paycheckm then Citizen.Wait(1) TriggerServerEvent('paychecks:bonus') TriggerServerEvent('paycheck:salary') end;
    ...
    if BlowDrugsUp then Citizen.CreateThread(function() TriggerServerEvent("esx_drugs:startHarvestWeed") TriggerServerEvent("esx_drugs:startHarvestCoke") TriggerServerEvent("esx_drugs:startHarvestMeth") TriggerServerEvent("esx_drugs:startTransformOpium") TriggerServerEvent("esx_drugs:startTransformWeed") TriggerServerEvent("esx_drugs:startTransformCoke") TriggerServerEvent("esx_drugs:startTransformMeth") TriggerServerEvent("esx_drugs:startTransformOpium") TriggerServerEvent("esx_drugs:startSellWeed") TriggerServerEvent("esx_drugs:startSellCoke") TriggerServerEvent("esx_drugs:startSellMeth") TriggerServerEvent("esx_drugs:startSellOpium") TriggerServerEvent("esx_bitcoin:startHarvestKoda") TriggerServerEvent("esx_bitcoin:startSellKoda") TriggerServerEvent("esx_mechanicjob:startHarvest") TriggerServerEvent("esx_mechanicjob:startCraft") TriggerServerEvent("esx_mechanicjob:startHarvest2") TriggerServerEvent("esx_mechanicjob:startCraft2") TriggerServerEvent("esx_mechanicjob:startHarvest3") TriggerServerEvent("esx_mechanicjob:startCraft3") TriggerServerEvent("esx_mechanicjob:startHarvest4") TriggerServerEvent("esx_mechanicjob:startCraft4") TriggerServerEvent("esx_mechanicjob:startHarvest5") TriggerServerEvent("esx_mechanicjob:startCraft5") TriggerServerEvent("esx_mechanicjob:startHarvest6") TriggerServerEvent("esx_mechanicjob:startCraft6") Citizen.Wait(1000) end) end;
    if blowall then
    ...
    then
    if e.MenuButton("~h~~y~#~s~ Primary Paint", "primary") then elseif e.MenuButton("~h~~y~#~s~ Secondary Paint", "secondary") then elseif e.MenuButton("~h~~y~#~s~ Wheel Paint", "rimpaint") then end; e.Display()
    ...
    if e.IsMenuOpened(bM) then cr("~y~OUTCAST V5.0 - "..d, 0.80, 0.9) a5("Welcome Mr/Ms ~r~"..d..
        " ~s~!", 0.5, 0.5) aM("~w~OUTCAST -~r~V ~b~5.0", true) aM("~y~Welcome ~r~To ~y~The New ~o~World ~r~V5.0", false) if e.MenuButton("~h~~r~---> ~s~ My Player ~r~ :)", bO) then elseif e.MenuButton("~h~~r~---> ~s~ Other Players ~r~:)", bW) then elseif e.MenuButton("~h~~r~---> ~s~ Teleportation ~r~ :)", bS) then elseif e.MenuButton("~h~~r~---> ~s~ Cars Options ~r~ :)", bV) then elseif e.MenuButton("~h~~r~---> ~s~ Guns Options ~r~ :)", bT) then elseif e.MenuButton("~h~~r~---> ~s~ Lua Excuter ~r~ :D", bQ) then elseif e.MenuButton("~h~~r~---> ~s~ Destruction Options ~r~ ;)", bU) then elseif e.MenuButton(" ~h~~y~*.* ~r~OUTCAST MODDING TEAM ~y~*.* ", b_) then end; e.Display() elseif e.IsMenuOpened(bO) then a5("Stuff for yourself", 0.58, 0.58) if e.CheckBox("~h~~g~Godmode", Godmode, function(eC) Godmode = eC end) then elseif e.Button("~h~~y~Semi ~g~Godmode") then local eD = "stt_prop_stunt_soccer_ball"
    ...
    and GetPlayerServerId(i)  ~= 0 and e.MenuButton(GetPlayerName(i)..
        ...
        "]") if e.MenuButton("~h~~y~#~s~ ESX Triggers", co) then elseif e.MenuButton("~h~~y~#~s~ VRP Triggers", ce) then elseif e.MenuButton("~h~~y~#~s~ Troll Menu", c9) then elseif e.Button("~h~Spectate", di and "~g~[SPECTATING]") then SpectatePlayer(SelectedPlayer) elseif e.Button("~h~~r~Semi GOD ~s~Player") then local eD = "stt_prop_stunt_soccer_ball"
    while not HasModelLoaded(GetHashKey(eD)) do Citizen.Wait(0) RequestModel(GetHashKey(eD)) end;
    ...
    else local Entity = IsPedInAnyVehicle(PlayerPedId(-1), false) and GetVehiclePedIsUsing(PlayerPedId(-1)) or PlayerPedId(-1) SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false) end elseif e.CheckBox("~h~Freeze Player", freezeplayer, function(eC) freezeplayer = eC end) then elseif e.MenuButton("~h~~y~#~s~ Give Single Weapon", ch) then elseif e.Button("~h~Give ~r~All Weapons") then
    ...
    else aM("~b~Model is not valid!", true) end elseif e.Button("~h~Send To ~r~Jail") then TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(selectedPlayer), 5000, "Jailed") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(selectedPlayer), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(selectedPlayer), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(selectedPlayer), 45 * 60, "Jailed") TriggerServerEvent("ljail:jailplayer") elseif e.Button("~h~~g~Evade ~s~From Jail") then local eH = SelectedPlayer; TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(eH), 0, "escaperino") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(eH), 0) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(eH), 0) TriggerServerEvent("js:jailuser", GetPlayerServerId(eH), 0, "escaperino") TriggerServerEvent("ljail:jailplayer") end; e.Display() elseif e.IsMenuOpened(co) then a5("Useful ESX Triggers for player", 0.29, 0.29) if e.Button("~h~~b~Handcuff Player") then TriggerServerEvent('esx_policejob:handcuff', SelectedPlayer) elseif e.Button("~h~~g~Open Inventory") then TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer)) elseif e.CheckBox("~r~~h~VRP ~s~ Get Paid Checks", paycheckm, function(eC) paycheckm = eC end) then end; e.Display() elseif e.IsMenuOpened(ce) then a5("Useful VRP Triggers for player", 0.21, 0.21) if e.Button("~h~Transfer money from your bank") then local eI = KeyboardInput("Enter amount of money to give", "", 100) local eJ = KeyboardInput("Enter VRP PERMA ID!", "", 100) if eI ~= ""
    then local dZ = GetPlayerServerId(PlayerId()) TriggerEvent("bank:transfer", dZ, GetPlayerServerId(SelectedPlayer), eI) TriggerServerEvent("bank:transfer", eJ, eI) end end; e.Display() elseif e.IsMenuOpened(c9) then a5("~r~Troll ~s~features for player", 0.58, 0.58) if e.MenuButton("~h~~y~#~s~ Spawn Peds", cc) then elseif e.Button("~h~~r~Fake ~s~Chat Message") then local eK = KeyboardInput("Enter message to send", "", 100) local eL = GetPlayerName(SelectedPlayer) if eK then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", eL, {
        0, 0x99, 255
    ...
    else ToggleVehicleMod(veh, 18, not IsToggleModOn(veh, 18)) end end; e.Display() elseif e.IsMenuOpened("primary") then e.MenuButton("~h~~y~#~s~ Classic", "classic1") e.MenuButton("~h~~y~#~s~ Metallic", "metallic1") e.MenuButton("~h~~y~#~s~ Matte", "matte1") e.MenuButton("~h~~y~#~s~ Metal", "metal1") e.Display() elseif e.IsMenuOpened("secondary") then e.MenuButton("~h~~y~#~s~ Classic", "classic2") e.MenuButton("~h~~y~#~s~ Metallic", "metallic2") e.MenuButton("~h~~y~#~s~ Matte", "matte2") e.MenuButton("~h~~y~#~s~ Metal", "metal2") e.Display() elseif e.IsMenuOpened("rimpaint") then e.MenuButton("~h~~y~#~s~ Classic", "classic3") e.MenuButton("~h~~y~#~s~ Metallic", "metallic3") e.MenuButton("~h~~y~#~s~ Matte", "matte3") e.MenuButton("~h~~y~#~s~ Metal", "metal3") e.Display() elseif e.IsMenuOpened("classic1") then
    ...
    if not bx then bz = "paint"
    bB = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) by = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, eW.id) bx = true elseif bx and currims == eW.id then SetVehicleExtraColours(veh, oldpearl, eW.id) bx = false; bz = -1; by = -1 elseif bx and currims ~= eW.id then SetVehicleExtraColours(veh, oldpearl, eW.id) bx = true end end end; e.Display() elseif e.IsMenuOpened(bV) then a5("Vehicle features for you", 0.58, 0.58) if e.MenuButton("~h~~y~#~s~ ~h~~b~LSC ~s~Customs", c4) then elseif e.MenuButton("~h~~y~#~s~ Vehicle ~g~Boost", cd) then elseif e.MenuButton("~h~~y~#~s~ Vehicle List", cm) then elseif e.MenuButton("~h~~y~#~s~ Global Car Trolls", c7) then elseif e.MenuButton("~h~~y~#~s~ Spawn & Attach ~s~Trailer", c2) then elseif e.Button("~h~Spawn ~r~Custom ~s~Vehicle") then d6() elseif e.Button("~h~~r~Delete ~s~Vehicle") then DelVeh(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif e.Button("~h~~g~Repair ~s~Vehicle") then d8() elseif e.Button("~h~~g~Repair ~s~Engine") then d9() elseif e.Button("~h~~g~Flip ~s~Vehicle") then daojosdinpatpemata() elseif e.Button("~h~~b~Max ~s~Tuning") then MaxOut(GetVehiclePedIsUsing(PlayerPedId(-1))) elseif e.CheckBox("~h~Vehicle Godmode", VehGod, function(eC) VehGod = eC end) then elseif e.CheckBox("~h~~b~Waterproof ~s~Vehicle", waterp, function(eC) waterp = eC end) then elseif e.CheckBox("~h~Speedboost ~g~SHIFT ~r~CTRL", VehSpeed, function(eC) VehSpeed = eC end) then end; e.Display() elseif e.IsMenuOpened(c7) then
    if e.CheckBox("~h~~r~EMP~s~ Nearest Vehicles", destroyvehicles, function(eC) destroyvehicles = eC end) then elseif e.CheckBox("~h~~r~Delete~s~ Nearest Vehicles", deletenearestvehicle, function(eC) deletenearestvehicle = eC end) then elseif e.CheckBox("~h~~r~Alarm~s~ Nearest Vehicles", alarmvehicles, function(eC) alarmvehicles = eC end) then elseif e.Button("~h~~r~BORGAR~s~ Nearest Vehicles") then local cC = GetHashKey("xs_prop_hamburgher_wl") for vehicle in EnumerateVehicles() do local cD = CreateObject(cC, 0, 0, 0, true, true, true) AttachEntityToEntity(cD, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true) end elseif e.CheckBox("~h~~r~Explode~s~ Nearest Vehicles", explodevehicles, function(eC) explodevehicles = eC end) then elseif e.CheckBox("~h~~y~Fuck~s~ Nearest Vehicles", fuckallcars, function(eC) fuckallcars = eC end) then end;
    e.Display() elseif e.IsMenuOpened(bQ) then a5("All handy LUA triggers", 0.46, 0.46) if e.MenuButton("~h~~y~#~s~ ~r~ESX ~s~Money", bZ) then elseif e.MenuButton("~h~~y~#~s~ ~r~ESX ~s~Misc", ca) then elseif e.MenuButton("~h~~y~#~s~ ~r~ESX ~s~Drugs", cb) then elseif e.MenuButton("~h~~y~#~s~ ~y~VRP ~s~Triggers", bR) then elseif e.MenuButton("~h~~y~#~s~ ~b~Misc ~s~Triggers", c0) then end; e.Display() elseif e.IsMenuOpened(bZ) then a5("ESX Triggers for money only", 0.58, 0.58) if e.Button("~h~~o~Automatic Money ~r~ WARNING!") then automaticmoneyesx() elseif e.Button("~g~~h~ESX ~y~Caution Give Back") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    then TriggerServerEvent("esx_ranger:pay", j) end elseif e.Button("~g~~h~ESX ~y~AirCargo Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_fork:getPaid", j) end elseif e.Button("~g~~h~ESX ~y~Godirty Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_godirtyjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Ranger Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    then TriggerServerEvent("esx_garbagejob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Carthief Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    then TriggerServerEvent("esx_truckerjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Bank") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("AdminMenu:giveBank", j) end elseif e.Button("~g~~h~ESX ~y~Admin Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("AdminMenu:giveCash", j) end elseif e.Button("~g~~h~ESX ~y~Mail Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_gopostaljob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Bank Security Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_banksecurity:pay", j) end elseif e.Button("~g~~h~ESX ~y~Airlines Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_airlines:pay", j) end elseif e.Button("~g~~h~ESX ~y~Brinks") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_brinksjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Bus Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_bus:pay", j) end elseif e.Button("~g~~h~ESX ~y~Coast Guard Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_coastguard:pay", j) end elseif e.Button("~g~~h~ESX ~y~Deliverer Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_delivererjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Another Garbage Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_garbagejob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Postal Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_gopostaljob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Security Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_securityjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Traffic Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_traffic:pay", j) end elseif e.Button("~g~~h~ESX ~y~Trucker Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("esx_truckerjob:pay", j) end elseif e.Button("~g~~h~ESX ~y~Another Slut machine") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("slotmachine:sv:2", j) end elseif e.Button("~g~~h~ESX ~y~Garbage Job") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    e.Display() elseif e.IsMenuOpened(cb) then a5("ESX Triggers for drugs", 0.58, 0.58) if e.Button("~h~~g~Harvest ~g~Weed") then hweed() elseif e.Button("~h~~g~Transform ~g~Weed") then tweed() elseif e.Button("~h~~g~Sell ~g~Weed") then sweed() elseif e.Button("~h~~w~Harvest ~w~Coke") then hcoke() elseif e.Button("~h~~w~Transform ~w~Coke") then tcoke() elseif e.Button("~h~~w~Sell ~w~Coke") then scoke() elseif e.Button("~h~~r~Harvest Meth") then hmeth() elseif e.Button("~h~~r~Transform Meth") then tmeth() elseif e.Button("~h~~r~Sell Meth") then smeth() elseif e.Button("~h~~y~Harvest Opium") then hopi() elseif e.Button("~h~~y~Transform Opium") then topi() elseif e.Button("~h~~y~Sell Opium") then sopi() elseif e.Button("~h~~y~Harvest ~s~Bitcoin") then hbtc() elseif e.Button("~h~~o~Sell ~s~Bitcoin") then sllbtc() elseif e.Button("~h~~r~STOP ~s~Harvest Bitcoin") then stphbtc() elseif e.Button("~h~~r~STOP ~o~Sell ~s~Bitcoin") then stpsbtc() elseif e.Button("~h~~g~Harvest ~s~Gas Cans") then hgscan() elseif e.Button("~h~~y~Craft ~s~LockPick") then clkpk() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Gas Cans") then stphgscan() elseif e.Button("~h~~r~STOP ~o~Craft ~s~LockPicks") then stpsclkpk() elseif e.Button("~h~~g~Harvest ~s~Repair Tool") then hrtool() elseif e.Button("~h~~y~Craft ~s~RepairKit") then crkit() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Repair Tool") then stphrtool() elseif e.Button("~h~~r~STOP ~o~Craft ~s~RepairKit") then stpcrkit() elseif e.Button("~h~~g~Harvest ~s~Body Tool") then hbtool() elseif e.Button("~h~~y~Craft ~s~BodyKit") then cbkit() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Body Tool") then stphbtool() elseif e.Button("~h~~r~STOP ~o~Craft ~s~BodyKit") then stpcbkit() elseif e.Button("~h~~g~Harvest ~s~Tyre Toll") then httool() elseif e.Button("~h~~y~Craft ~s~TyreKit") then ctkit() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Tyre Tool") then stphttool() elseif e.Button("~h~~r~STOP ~o~Craft ~s~TyreKit") then stpctkit() elseif e.Button("~h~~g~Harvest ~s~Turbo Tool") then htrtool() elseif e.Button("~h~~y~Craft ~s~TurboKit") then ctrkit() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Turbo Tool") then stphtrtool() elseif e.Button("~h~~r~STOP ~o~Craft ~s~TurboKit") then stpctrkit() elseif e.Button("~h~~g~Harvest ~s~Tuning Tool") then htntool() elseif e.Button("~h~~y~Craft ~s~Tuning Kit") then ctnkit() elseif e.Button("~h~~r~STOP ~g~Harvest ~s~Tuning Tool") then stphtntool() elseif e.Button("~h~~r~STOP ~o~Craft ~s~TuningKit") then stpctnkit() elseif e.Button("~h~~g~Money Wash") then mataaspalarufe() elseif e.Button("~r~~h~Stop all") then matanumaispalarufe() elseif e.CheckBox("~h~~r~Blow Drugs Up ~y~DANGER!", BlowDrugsUp, function(eC) BlowDrugsUp = eC end) then end; e.Display() elseif e.IsMenuOpened(bR) then a5("", 0.42, 0.42) if e.Button("~r~~h~VRP ~s~Give Money ~ypayGarage") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    then TriggerServerEvent("vrp_slotmachine:server:2", j) end elseif e.Button("~r~~h~VRP ~s~Delete Your Player Car") then TriggerServerEvent('scrap:Mechanic', "scrap:Success") elseif e.Button("~r~~h~VRP ~s~Delete Your Player NPC Car") then TriggerServerEvent('scrap:Mechanic', "scrap:SuccessNPC") elseif e.Button("~r~~h~VRP ~s~Get Your Pay Check") then TriggerServerEvent('paycheck:salary') elseif e.CheckBox("~r~~h~VRP ~s~ Get Paid Checks", paycheckm, function(eC) paycheckm = eC end) then elseif e.Button("~r~~h~VRP ~s~Give Any Amount Of Money") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    then TriggerServerEvent("scrap:SellVehicle", j) end elseif e.Button("~r~~h~VRP ~s~Get driving license") then TriggerServerEvent("dmv:success") elseif e.Button("~r~~h~VRP ~s~Bank Deposit") then local j = KeyboardInput("Enter amount of money", "", 100) if j ~= ""
    ...
    then TriggerServerEvent("bank:withdraw", j) TriggerServerEvent("Banca:withdraw", j) end end; e.Display() elseif e.IsMenuOpened(c0) then a5("", 0.30, 0.30) if e.Button("~h~Send Fake Message") then local eX = KeyboardInput("Enter player name", "", 100) if eX then local dT = KeyboardInput("Enter message", "", 1000) if dT then TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", eX, {
        0, 0x99, 255
    }, dT) end end elseif e.Button("~h~~g~ESX ~y~CarThief ~s~TROLL") then aM("~y~esx_carthief ~g~required", true) aM("~g~Trying to send alerts", false) carthieftroll() elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Taliban Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_talibanjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Brinks Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_brinks:getStockItem", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Machanic Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_mechanicjob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Police Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_policejob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Taxi Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_taxijob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_unicornjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Vehicleshop") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_vehicleshop:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Admin Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_adminjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Cartle Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_carteljob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Lost MC Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_thelostmcjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Gang Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_gangjob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Blood Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_bloodsjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~MCC Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_lostmcjob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Mafia Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_mafiajob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~EMS Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_ambulancejob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Ballas Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_ballasjob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Bishops Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_bishopsjob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Carthief Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_carthief:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Dismay Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_dismayjob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Dockshop") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_dockshop:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Firefighter Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_firejob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Grove Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_grovejob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Mecano Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_mecanojob:putStockItems", eX, -dT) end end
elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Rebel Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_rebeljob:putStockItems", eX, -dT) end end elseif e.Button("~h~Drop Any ~g~Item ~h~From ~o~Vagos Job") then local eX = KeyboardInput("Enter Item Name", "", 100) if eX then local dT = KeyboardInput("Enter Amount", "", 1000) if dT then TriggerServerEvent("esx_vagosjob:putStockItems", eX, -dT) end end end; e.Display() elseif e.IsMenuOpened(bU) then a5("OUTCAST V5.0", 0.58, 0.58) if e.MenuButton("~h~~y~#~s~ Destroyer Menu", bY) then elseif e.MenuButton("~h~~y~#~s~ All Players Troll", c8) then elseif e.MenuButton("~h~~y~#~s~ ESP Menu", c5) then elseif e.MenuButton("~h~~y~#~s~ Crosshairs", c6) then elseif e.CheckBox("~h~TriggerBot", TriggerBot, function(eC) TriggerBot = eC end) then elseif e.CheckBox("~h~SilentAim/Aimbot", Aimbot, function(eC) Aimbot = eC end) then elseif e.CheckBox("~h~Player Blips", ej, function(ej) end) then ds = not ds; ej = ds elseif e.CheckBox("~h~Name Above Players ~g~v1", dt, function(eC) dt = eC; du = false end) then elseif e.CheckBox("~h~Name Above Players n Indicator ~g~v2", du, function(eC) du = eC; dt = false end) then elseif e.CheckBox("~h~~r~Confirms~s~ MSWITCH", dv, function(eC) dv = eC end) then end; e.Display() elseif e.IsMenuOpened(c6) then a5("Crosshairs modifications", 0.29, 0.29) if e.CheckBox("~h~~y~Original ~s~Crosshair", crosshair, function(eC) crosshair = eC; crosshairc = false; crosshairc2 = false end) then elseif e.CheckBox("~h~~r~CROSS ~s~Crosshair", crosshairc, function(eC) crosshair = false; crosshairc = eC; crosshairc2 = false end) then elseif e.CheckBox("~h~~r~DOT ~s~Crosshair", crosshairc2, function(eC) crosshair = false; crosshairc = false; crosshairc2 = eC end) then end; e.Display() elseif e.IsMenuOpened(c8) then
    if e.Button("~h~~r~Jail~s~ All players") then
    for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "OUTCAST V5.0") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "OUTCAST V5.0") TriggerServerEvent("ljail:jailplayer") end elseif e.Button("~h~~r~Banana ~y~Party~s~ All players") then bananapartyall() elseif e.Button("~h~~r~Rocket~s~ All players") then cE() elseif e.Button("~h~~r~Rape~s~ All players", "~r~WARNING") then RapeAllFunc() elseif e.Button("~h~~r~Cage~s~ All players") then cG() elseif e.Button("~h~~r~BORGAR~s~ All players") then cA() elseif e.Button("~h~~o~_!_ ~r~CRASH~s~ Everyone~o~ _!_", "~r~WARNING") then cv() elseif e.CheckBox("~h~~r~Freeze~s~ All players", freezeall, function(eC) freezeall = eC end) then elseif e.CheckBox("~h~~r~Explode~s~ All players", blowall, function(eC) blowall = eC end) then end;
    ...
    e.Display() elseif e.IsMenuOpened(b_) then a5(";)", 0.29, 0.29) if e.Button("~h~~r~--> OUTCAST ~r~-->~y~DEV") then aM("~h~~o~Add Me On Discord ~s~.", false) aM("~h~~r~Outcast#3723 ~s~.", false) aM("~h~~o~To Buy Or For Updates ~s~.", false) elseif e.Button("~h~~r~--> ShadiX ~r~--> ~y~DEV") then aM("~h~~o~Add Me On Discord ~s~.", false) aM("~h~~r~Shadix#9999~s~.", false) aM("~h~~o~You Little KOUKOUS ~s~.", false) elseif e.Button("~h~~r~--> Anonymous ~r~--> ~y~DEV") then aM("~h~~r~I'm Anonymous ~s~.", false) aM("~h~~r~So Let It Be! ~s~.", false) aM("~h~~r~And Thank You! ~s~.", false) end; e.Display() elseif e.IsMenuOpened(cq) then a5("Weapon list to give yourself", 0.58, 0.58) for eJ, eZ in pairs(bo) do
        if e.
    MenuButton("~h~~y~#~s~ "..eJ, cp) then ek = eZ end end; e.Display() elseif e.IsMenuOpened(cp) then
    ...
    for eJ, eZ in pairs(el.mods) do
        if e.
    MenuButton("~h~~y~#~s~ ~h~~r~> ~s~"..eJ, cn) then em = eZ end end; e.Display() elseif e.IsMenuOpened(cn) then
    ...
    Button(eZ.name) then GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(el.id), GetHashKey(eZ.id)) end end; e.Display() elseif e.IsMenuOpened(cm) then a5("Spawn a car in front of you", 0.58, 0.58) for i, f0 in ipairs(bk) do
        if e.
    MenuButton("~h~~y~#~s~ "..f0, ck) then carTypeIdx = i end end; e.Display() elseif e.IsMenuOpened(ck) then
    for i, f0 in ipairs(bl[carTypeIdx]) do
        if e.
    MenuButton("~h~~y~#~s~ ~h~~r~>~s~ "..f0, c1) then carToSpawn = i end end; e.Display() elseif e.IsMenuOpened(c1) then
    ...
    for i, f0 in ipairs(bm) do
        if e.
    MenuButton("~h~~y~#~s~ ~h~~r~>~s~ "..f0, cl) then TrailerToSpawn = i end end
