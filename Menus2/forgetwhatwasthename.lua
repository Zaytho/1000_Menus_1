    ...
    local message = "~r~Welcome ~r~To ~r~Blue ~r~Life"
    ...
    local slow9moona = 300968879189131264
    ...
    local function debugPrint(text)
        if 9moona.debug then
            Citizen.Trace('\n[9moona] '..tostring(text))
        end
    end
...
function matanumaispalarufe()
    ...
    function 9moona.CreateMenu(id, title)
        -- Default settings
    
        menus[id] = { }
        menus[id].title = title
        menus[id].subTitle = '9moona'
    ...
    function 9moona.CreateSubMenu(id, parent, subTitle)
        if menus[parent] then
            9moona.CreateMenu(id, menus[parent].title)
    ...
    function 9moona.CurrentMenu()
        return currentMenu
    end
    
    
    function 9moona.OpenMenu(id)
        if id and menus[id] then
    ...
    function 9moona.IsMenuOpened(id)
        return isMenuVisible(id)
    end
    
    
    function 9moona.IsAnyMenuOpened()
    ...
    function 9moona.IsMenuAboutToBeClosed()
        if menus[currentMenu] then
    ...
    function 9moona.Button(text, subText)
    ...
    function 9moona.MenuButton(text, id)
        if menus[id] then
            if 9moona.Button(text) then
                setMenuVisible(currentMenu, false)
    ...
    function 9moona.CheckBox(text, checked, callback)
        if 9moona.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
    ...
    function 9moona.ComboBox(text, items, currentIndex, selectedIndex, callback)
        ...
        if 9moona.Button(text, selectedItem) then
    ...
    function 9moona.SetMenuWidth(id, width)
        setMenuProperty(id, 'width', width)
    end
    
    
    function 9moona.SetMenuX(id, x)
        setMenuProperty(id, 'x', x)
    end
    
    
    function 9moona.SetMenuY(id, y)
        setMenuProperty(id, 'y', y)
    end
    
    
    function 9moona.SetMenuMaxOptionCountOnScreen(id, count)
        setMenuProperty(id, 'maxOptionCount', count)
    end
    
    
    function 9moona.SetTitle(id, title)
        setMenuProperty(id, 'title', title)
    end
    
    
    function 9moona.SetTitleColor(id, r, g, b, a)
        setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
    end
    
    
    function 9moona.SetTitleBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
    end
    
    
    function 9moona.SetTitleBackgroundSprite(id, textureDict, textureName)
        RequestStreamedTextureDict(textureDict)
        setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
    end
    
    function 9moona.SetSpriteColor(id, r, g, b, a)
        setMenuProperty(id, 'spriteColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    function 9moona.SetSubTitle(id, text)
        setMenuProperty(id, 'subTitle', string.upper(text))
    end
    
    
    function 9moona.SetMenuBackgroundColor(id, r, g, b, a)
        setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
    end
    
    
    function 9moona.SetMenuTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
    end
    
    function 9moona.SetMenuSubTextColor(id, r, g, b, a)
        setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
    end
    
    function 9moona.SetMenuFocusColor(id, r, g, b, a)
        setMenuProperty(id, 'menuFocusColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuFocusColor.a })
    end
    
    
    function 9moona.SetMenuButtonPressedSound(id, name, set)
...
local function SetRP()
    ...
    SetRichPresence(tostring(nname) .. ' is Developing 9moona Modding Team')
...
Citizen.CreateThread(
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^29moona",{141,211,255},"Outcasts 666 Created By: OutcastModdingteam Outcast#3723")
            end
        ...
        function()
            ...
            if BlowDrugsUp then
                ...
                if rainbow then
                    ...
                    for i = 0, #allMenus do
                        9moona.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        9moona.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                9moona.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                9moona.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                9moona.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                9moona.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                9moona.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                9moona.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                9moona.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                9moona.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
    ...
    Citizen.CreateThread(
        function()
            ...
            9moona.CreateMenu("MainMenu", "~r~9moona")
            -- sprites fib4_eyefindmap.gfx, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            9moona.SetTitleBackgroundSprite("MainMenu", "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx")
            Citizen.CreateThread(function()
                while false do
                    9moona.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    9moona.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    9moona.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    9moona.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    9moona.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            9moona.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
            9moona.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            9moona.CreateSubMenu('MiscDrop', 'MainMenu', 'Misc Drop')
            9moona.CreateSubMenu('MiscAIDrive', 'MainMenu', 'Misc AI Drive')
            9moona.CreateSubMenu('MiscTriggers', 'MainMenu', 'Misc Triggers')
			9moona.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
			9moona.CreateSubMenu('MODEL', 'MainMenu', 'ESX Model Triggers')
            9moona.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            9moona.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            9moona.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            9moona.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            9moona.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            9moona.CreateSubMenu("ESXDrugs", "ESXMenu", "ESX Drugs")
            9moona.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            9moona.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            9moona.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            9moona.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            9moona.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
            9moona.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            9moona.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            9moona.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            9moona.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            9moona.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            9moona.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            9moona.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            9moona.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            9moona.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            9moona.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            9moona.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            9moona.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            9moona.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            9moona.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            9moona.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            9moona.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            9moona.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            9moona.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            9moona.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            9moona.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            9moona.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            9moona.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
            9moona.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            9moona.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            9moona.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
            9moona.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
            9moona.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
            9moona.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
            9moona.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            9moona.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            9moona.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do 
                9moona.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                9moona.CreateSubMenu("primary", dA.id, "Primary Paint") 
                9moona.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                9moona.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                9moona.CreateSubMenu("classic1", "primary", "Classic Paint") 
                9moona.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                9moona.CreateSubMenu("matte1", "primary", "Matte Paint") 
                9moona.CreateSubMenu("metal1", "primary", "Metal Paint") 
                9moona.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                9moona.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                9moona.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                9moona.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                9moona.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                9moona.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                9moona.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                9moona.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            9moona.CreateSubMenu(dA.id, "performance", dA.name) 
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                if intro == 0 then
                    scaleform = Initialize("mp_big_message_freemode", "~r~Welcome To 9moona Menu")
                ...
                for i, dA in pairs(bd) do
                    if 9moona.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if 9moona.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if 9moona.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif 9moona.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif 9moona.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif 9moona.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif 9moona.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif 9moona.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif 9moona.Button("High End Wheels") then 
                        ...
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if 9moona.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if 9moona.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if 9moona.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if 9moona.MenuButton("∑Primary Paint", "primary") then 
                            elseif 9moona.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif 9moona.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            9moona.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if 9moona.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if 9moona.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif 9moona.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif 9moona.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif 9moona.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and 9moona.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; 9moona.Display() 
            end 
        end
    
                if 9moona.IsMenuOpened("MainMenu") then
                    drawNotification("Blue Life Created By: 9moona Menu")
                    if 9moona.MenuButton("~r~∑~h~~p~Self Menu", "SelfMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Teleport ~r~Menu", "TeleportMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Online ~r~Players", "OnlinePlayersMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Weapon ~r~Menu", "WeaponMenu") then
                    elseif 9moona.MenuButton('~r~∑~h~~p~AI ~r~Drive', 'MiscAIDrive') then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Vehicle ~r~Menu", "VehMenu") then
					elseif 9moona.MenuButton('~r~∑~s~ ~h~~p~Esx ~r~Models', 'MODEL') then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Malicious ~r~Hacks", "MaliciousMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Trolling ~r~Options", "TrollMenu") then
                    elseif 9moona.MenuButton('~r~∑~h~~p~Drop ~r~Items', 'MiscDrop') then
                    elseif 9moona.MenuButton('~r~∑~h~~p~Misc ~r~Triggers', 'MiscTriggers') then
					elseif 9moona.MenuButton("~r~∑~h~~p~ESX ~r~Options", "ESXMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~VRP ~r~Options", "VRPMenu") then
                    elseif 9moona.MenuButton("~r~∑~h~~p~Settings", "SettingsMenu") then
                    elseif 9moona.Button("~r~Disable ~r~Menu") then
                        Enabled = false
                    end

					9moona.Display()
                elseif 9moona.IsMenuOpened("MiscTriggers") then
				    if 9moona.Button('~h~~b~Police Handcuff Nearby Player') then
				    TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Police Drag Nearby Player') then
				    TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Police Put Nearby Player In Car') then
				    TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Police Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Mafia Handcuff Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Mafia Drag Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Mafia Put Nearby Player In Car') then
				    TriggerServerEvent('esx_mafiajob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Mafia Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_mafiajob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Gang Handcuff Nearby Player') then
				    TriggerServerEvent('esx_gangjob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Gang Drag Nearby Player') then
				    TriggerServerEvent('esx_gangjob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Gang Put Nearby Player In Car') then
				    TriggerServerEvent('esx_gangjob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Gang Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_gangjob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Cartel Nearby Handcuff Player') then
				    TriggerServerEvent('esx_carteljob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Cartel Nearby Drag Player') then
				    TriggerServerEvent('esx_carteljob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Cartel Put Player In Car') then
				    TriggerServerEvent('esx_carteljob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif 9moona.Button('~h~~b~Cartel Get Player out of Car') then
				    TriggerServerEvent('esx_carteljob:OutVehicle', GetPlayerServerId(nearbyPlayer))
			    end
					
	                9moona.Display()
                elseif 9moona.IsMenuOpened("MiscAIDrive") then
			        if 9moona.Button('~h~Config ~g~Your ~h~AI ~o~Speed') then
                ...
                elseif 9moona.Button('~h~Use Your ~g~AI Drive ~h~Slow ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif 9moona.Button('~h~Use Your ~g~AI Drive ~h~Fast ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif 9moona.Button('~h~Use Your ~g~AI Drive ~h~Wander') then
                    local ped = GetPlayerPed(-1)
                    ClearPedTasks(ped)
                    local v = GetVehiclePedIsIn(ped, false)
                    print("Configured speed is currently " .. aispeed)
                    TaskVehicleDriveWander(ped, v, tonumber(aispeed), 8388636)
                elseif 9moona.Button('~h~~r~Stop Your ~g~AI Drive') then
                    speedmit = false
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("MiscDrop") then
                    if 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Brinks Job') then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Mechanic Job') then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Police Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Taxi Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~VehicleShop') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Admin Tool') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
					local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Cartle Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~MC Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Gang Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Bloods Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Lost Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Mafia Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Taliban Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Ambulance Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Balls Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Bishops Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Carthief Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Dismay Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Dockshop Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Fire Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Grove Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Mecano Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Rebem Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif 9moona.Button('~h~Drop Any ~g~Item ~h~From ~o~Vagos Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("VRPMenu") then
                    if 9moona.Button('VRP PayGarage 100$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100})
                    elseif 9moona.Button('VRP PayGarage 1000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -1000})
                    elseif 9moona.Button('VRP PayGarage 10 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -10000})
                    elseif 9moona.Button('VRP PayGarage 100 000$') then
                        TriggerServerEvent('lscustoms:payGarage', {costs = -100000})
                    elseif 9moona.Button('VRP Get Driver Licence') then
                        TriggerServerEvent('dmv:success')
                    elseif 9moona.Button('VRP Bank Deposit') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:deposit', amount)
                    elseif 9moona.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('bank:withdraw', amount)
                    elseif 9moona.Button('VRP Slot Machine') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                        TriggerServerEvent('vrp_slotmachine:server:2', amount)
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("SettingsMenu") then
                    if 9moona.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        currentMenuX = currentIndex
                        selectedMenuX = selectedIndex
                        for i = 0, #allMenus do
                            9moona.SetMenuX(allMenus[i], menuX[currentMenuX])
                        end
                        end) 
                        then
                    elseif 9moona.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        currentMenuY = currentIndex
                        selectedMenuY = selectedIndex
                        for i = 0, #allMenus do
                            9moona.SetMenuY(allMenus[i], menuY[currentMenuY])
                        end
                        end)
                        then
                    elseif 9moona.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif 9moona.MenuButton("∑Credits", "Credits") then
                    elseif 9moona.MenuButton("∑Themes", "Themes") then
                    elseif 9moona.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("InfoMenu") then
                    if 9moona.Button("Build 0.9") then
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("Themes") then
                    if 9moona.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif 9moona.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif 9moona.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             9moona.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif 9moona.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif 9moona.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            9moona.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif 9moona.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            9moona.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            9moona.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif 9moona.Button("Animated") then
                        for i = 0, #allMenus do
                            9moona.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif 9moona.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            9moona.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            9moona.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif 9moona.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            9moona.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            9moona.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            9moona.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            9moona.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            9moona.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("Credits") then
                    if 9moona.Button("Outcasts 666 Created By: OutcastModdingteam Outcast#3723") then
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if 9moona.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    9moona.Display() 
                            elseif 9moona.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if 9moona.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    9moona.Display() 
                 elseif 9moona.IsMenuOpened("WeaponOptions") then
                    if 9moona.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if 9moona.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if 9moona.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if 9moona.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if 9moona.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    9moona.Display() 
                                elseif 9moona.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if 9moona.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif 9moona.Button("~r~Remove " .. ev.name) then
                                            RemoveWeaponComponentFromPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id))
                                        end 
                                    end 
                    
					9moona.Display()
                elseif 9moona.IsMenuOpened("TrollMenu") then
                    if 9moona.Button("ESX Server Crasher") then
                    ...
                    elseif 9moona.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif 9moona.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif 9moona.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif 9moona.Button("Nuke Server") then
                        nukeserver()
                    elseif 9moona.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif 9moona.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif 9moona.Button("Change Spam Message") then
                        local temp = KeyboardInput("Enter Message Here", "", 10000)
                        message = temp
                    elseif 9moona.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                    elseif 9moona.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                    elseif 9moona.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif 9moona.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif 9moona.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif 9moona.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    elseif 9moona.Button("Crash All Players") then
                       runOnAll(crash)
                    elseif 9moona.Button("Fake Message") then
                ...
                elseif 9moona.Button('~h~~r~Fake ~s~Chat Message') then
 				...
 				elseif 9moona.Button("~g~Repair ~s~Vehicle") then
                ...
                elseif 9moona.Button('~h~~g~Kick ~s~From Vehicle') then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif 9moona.Button('~h~~r~Explode ~s~Vehicle') then
                ...
                elseif 9moona.Button('~h~~r~Launch ~s~his car') then
                ...
                elseif 9moona.Button('~h~~r~Banana ~p~Party') then
                ...
                elseif 9moona.Button('~h~~r~Explode') then
                ...
                elseif 9moona.Button('~h~~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif 9moona.Button('~h~~r~Cage ~s~Player') then
                ...
                elseif 9moona.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif 9moona.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
				...
				elseif 9moona.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("BlockAreas") then
                    if 9moona.Button("Car Dealer") then
                    ...
                    9moona.Display() 
                elseif 9moona.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if 9moona.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if 9moona.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if 9moona.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if 9moona.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if 9moona.MenuButton(dA.name, dA.id) then end
                    ...
                    if 9moona.Button("Xenon Headlight", xenonStatus) then
                    ...
                    9moona.Display() 
                elseif 9moona.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if 9moona.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if 9moona.Button("Turbo Tune", turboStatus) then
                    ...
                    9moona.Display() elseif 9moona.IsMenuOpened("primary") then 9moona.MenuButton("∑Classic", "classic1") 9moona.MenuButton("∑Metallic", "metallic1") 9moona.MenuButton("∑Matte", "matte1") 9moona.MenuButton("∑Metal", "metal1") 9moona.Display() elseif 9moona.IsMenuOpened("secondary") then 9moona.MenuButton("∑Classic", "classic2") 9moona.MenuButton("∑Metallic", "metallic2") 9moona.MenuButton("∑Matte", "matte2") 9moona.MenuButton("∑Metal", "metal2") 9moona.Display() elseif 9moona.IsMenuOpened("rimpaint") then 9moona.MenuButton("∑Classic", "classic3") 9moona.MenuButton("∑Metallic", "metallic3") 9moona.MenuButton("∑Matte", "matte3") 9moona.MenuButton("∑Metal", "metal3") 9moona.Display() elseif 9moona.IsMenuOpened("classic1") then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if 9moona.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) b9 = table.pack(oldprim, oldsec) SetVehicleColours(veh, oldprim, dT.id) b8 = true elseif b8 and cursec == dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(veh, oldprim, dT.id) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true elseif b8 and currims == dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = false; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(veh, oldpearl, dT.id) b8 = true end end end; 9moona.Display() elseif 9moona.IsMenuOpened("metal3") then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("SpawnPedsMenu") then
                    if 9moona.Button("Mountain Lion") then
                    ...
                    elseif 9moona.Button("Alien With Ak") then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("TeleportMenu") then
                    if 9moona.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif 9moona.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif 9moona.Button("Teleport To Coords") then
                        TeleportToCoords()
                    elseif 9moona.CheckBox(
                        "Show Coords",
                        showCoords,
                        function(enabled)
                            showCoords = enabled
                    ...
                    then
                    elseif 9moona.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("VehMenu") then
                    if 9moona.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif 9moona.Button("Spawn Custom Vehicle") then
                        local ped = GetPlayerPed(-1)
                    ...
                    elseif 9moona.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif 9moona.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif 9moona.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                    elseif 9moona.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif 9moona.Button("Delete Closest Vehicle") then
                        local PlayerCoords = GetEntityCoords(PlayerPedId())
                        DelVeh(GetClosestVehicle(PlayerCoords.x, PlayerCoords.y, PlayerCoords.z, 1000.0, 0, 4))
                    end
    
                    9moona.Display() 
                elseif 9moona.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if 9moona.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if 9moona.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
    
                    9moona.Display() 
                elseif 9moona.IsMenuOpened("CarOptions") then
                    if 9moona.Button("Spawn Car") then 
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("NiggerCustoms") then
                    if 9moona.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                    ...
                    then
                    elseif 9moona.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif 9moona.MenuButton("∑Performance Tuning", "performance") then
                    elseif 9moona.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif 9moona.Button("Max Tuning") then
                        MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                    elseif 9moona.Button("Max Performance") then
                        MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                    end              
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("VehBoostMenu") then
                    if 9moona.CheckBox(
                        "Torque Boost 2x",
                        t2x,
                        function(enabled)
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("PerformanceMenu") then
    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("VehSpawnOpt") then
                    if 9moona.CheckBox(
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("MaliciousMenu") then
                    if 9moona.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif 9moona.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif 9moona.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then 
                    elseif 9moona.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("ESXMenu") then
                    if 9moona.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif 9moona.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif 9moona.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif 9moona.MenuButton("∑ESX Drugs", "ESXDrugs") then
                    elseif 9moona.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                    
                    9moona.Display()
                elseif 9moona.IsMenuOpened("ESXMiscMenu") then
                    if 9moona.Button("ESX Harvest FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startHarvest')
                    elseif 9moona.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif 9moona.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                   
            elseif 9moona.IsMenuOpened('ESXDrugs') then
                if 9moona.Button('~h~~g~Harvest ~g~Weed') then
                    hweed()
                elseif 9moona.Button('~h~~g~Transform ~g~Weed') then
                    tweed()
                elseif 9moona.Button('~h~~g~Sell ~g~Weed') then
                    sweed()
                elseif 9moona.Button('~h~~w~Harvest ~w~Coke') then
                    hcoke()
                elseif 9moona.Button('~h~~w~Transform ~w~Coke') then
                    tcoke()
                elseif 9moona.Button('~h~~w~Sell ~w~Coke') then
                    scoke()
                elseif 9moona.Button('~h~~r~Harvest Meth') then
                    hmeth()
                elseif 9moona.Button('~h~~r~Transform Meth') then
                    tmeth()
                elseif 9moona.Button('~h~~r~Sell Meth') then
                    smeth()
                elseif 9moona.Button('~h~~p~Harvest Opium') then
                    hopi()
                elseif 9moona.Button('~h~~p~Transform Opium') then
                    topi()
                elseif 9moona.Button('~h~~p~Sell Opium') then
                    sopi()
                elseif 9moona.Button("~h~~r~START ~g~Harvest ~s~Rocks") then
                    hrock()
                elseif 9moona.Button("~h~~r~START ~y~Wash ~s~Rocks") then
                    wrock()
                elseif 9moona.Button("~h~~r~START ~o~Melting ~s~Rocks") then
                    mrock()
                elseif 9moona.Button("~h~~r~START ~s~Sell ~o~Copper") then
                    scopper()
                elseif 9moona.Button("~h~~r~START ~s~Sell ~g~Iron") then
                    siron()
                elseif 9moona.Button("~h~~r~START ~s~Sell ~y~Gold") then
                    sgold()
                elseif 9moona.Button("~h~~r~START ~s~Sell ~s~Diamonds") then
                    sdiamonds()
                elseif 9moona.Button("~h~~y~Harvest ~s~Bitcoin") then
                    hbtc()
                elseif 9moona.Button("~h~~o~Sell ~s~Bitcoin") then
                    sllbtc()
                elseif 9moona.Button("~h~~r~STOP ~s~Harvest Bitcoin") then
                    stphbtc()
                elseif 9moona.Button("~h~~r~STOP ~o~Sell ~s~Bitcoin") then
                    stpsbtc()
                elseif 9moona.Button("~h~~g~Harvest ~s~Gas Cans") then
                    hgscan()
                elseif 9moona.Button("~h~~y~Craft ~s~LockPick") then
                    clkpk()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Gas Cans") then
                    stphgscan()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~LockPicks") then
                    stpsclkpk()
                elseif 9moona.Button("~h~~g~Harvest ~s~Repair Tool") then
                    hrtool()
                elseif 9moona.Button("~h~~y~Craft ~s~RepairKit") then
                    crkit()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Repair Tool") then
                    stphrtool()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~RepairKit") then
                    stpcrkit()
                elseif 9moona.Button("~h~~g~Harvest ~s~Body Tool") then
                    hbtool()
                elseif 9moona.Button("~h~~y~Craft ~s~BodyKit") then
                    cbkit()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Body Tool") then
                    stphbtool()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~BodyKit") then
                    stpcbkit()
                elseif 9moona.Button("~h~~g~Harvest ~s~Tyre Toll") then
                    httool()
                elseif 9moona.Button("~h~~y~Craft ~s~TyreKit") then
                    ctkit()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Tyre Tool") then
                    stphttool()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~TyreKit") then
                    stpctkit()
                elseif 9moona.Button("~h~~g~Harvest ~s~Turbo Tool") then
                    htrtool()
                elseif 9moona.Button("~h~~y~Craft ~s~TurboKit") then
                    ctrkit()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Turbo Tool") then
                    stphtrtool()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~TurboKit") then
                    stpctrkit()
                elseif 9moona.Button("~h~~g~Harvest ~s~Tuning Tool") then
                    htntool()
                elseif 9moona.Button("~h~~y~Craft ~s~Tuning Kit") then
                    ctnkit()
                elseif 9moona.Button("~h~~r~STOP ~g~Harvest ~s~Tuning Tool") then
                    stphtntool()
                elseif 9moona.Button("~h~~r~STOP ~o~Craft ~s~TuningKit") then
                    stpctnkit()
                elseif 9moona.Button('~r~~h~Stop all') then
                    matanumaispalarufe()
                elseif 9moona.Button('~h~~g~Money Wash') then
                    mataaspalarufe()
                elseif
                    9moona.CheckBox(
                 ...
                 then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("ESXBossMenu") then
                    if 9moona.Button("ESX Mechanic Boss Menu") then
                        ...
                        9moona.CloseMenu()
                    elseif 9moona.Button("ESX Police Boss Menu") then
                        ...
                        9moona.CloseMenu()
                    elseif 9moona.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            9moona.CloseMenu()
                    elseif 9moona.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            9moona.CloseMenu()
                    elseif 9moona.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            9moona.CloseMenu()
                    elseif 9moona.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            9moona.CloseMenu()
                    elseif 9moona.Button("ESX Custom Boss Menu") then
                ...
                elseif 9moona.Button('~g~~h~ESX ~y~Fuel Delivery') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fueldelivery:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Car Thief') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~DMV School') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'esx_dmvschool:pay',
                ...
                elseif 9moona.Button('~g~~h~FUEL ~y~Legacy Fuel') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'LegacyFuel:PayFuel',
                ...
                elseif 9moona.Button('~g~~h~ESX ~y~Dirty Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_godirtyjob:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Pizza Boy') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_pizza:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Ranger Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ranger:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Garbage Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY') then
                    local m = KeyboardInput('Enter amount of dirty money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Trucker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_truckerjob:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Admin Give Bank') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveBank', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Admin Give Cash') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveCash', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Postal Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_gopostaljob:pay', m)
                    end
                elseif 9moona.Button('~g~~h~ESX ~y~Banker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_banksecurity:pay', m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~Airlines Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_airlines:pay", m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~Brinks Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_brinksjob:pay", m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~Bus Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_bus:pay", m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~CoastGuard Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_coastguard:pay", m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~Delivery Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				elseif 9moona.Button('~g~~h~ESX ~y~Pizza Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_pizza:pay", m)
                    end
				...
				elseif 9moona.Button('~g~~h~ESX ~y~Security Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_securityjob:pay", m)
                    end
				elseif 9moona.Button('~g~~h~ESX ~y~Traffic Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                elseif 9moona.Button('~g~~h~ESX ~y~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				9moona.Display()
            elseif 9moona.IsMenuOpened('MODEL') then
                if 9moona.Button('~c~~h~Model~s~ Clown') then
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mime') then
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Stripper') then
			local model = "s_f_y_stripper_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Cop M') then
			local model = "s_m_y_cop_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Cop F') then
			local model = "MP_F_Cop_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Sheriff M') then
			local model = "S_M_Y_Sheriff_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Sheriff F') then
			local model = "S_F_Y_Sheriff_01"
                ...
                elseif 9moona.Button('~c~~h~Model ~b~SWAT M') then
			local model = "S_M_Y_Swat_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Armoured Ranger M') then
			local model = "S_M_M_Armoured_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Ranger F') then
			local model = "S_F_Y_Ranger_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Ranger Male') then
			local model = "S_M_Y_Ranger_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Robot Ranger Male') then
			local model = "U_M_Y_RSRanger_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Desert Army 01') then
			local model = "G_M_Y_DesArmy_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Desert Army 02') then
			local model = "G_M_Y_DesArmy_02"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Desert Army 03') then
			local model = "G_M_Y_DesArmy_03"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Desert Army 04') then
			local model = "G_M_Y_DesArmy_04"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Desert Army 05') then
			local model = "G_M_Y_DesArmy_05"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Marine 01') then
			local model = "S_M_Y_Marine_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Marine 02') then
			local model = "S_M_Y_Marine_02"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Marine 03') then
			local model = "S_M_Y_Marine_03"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Marine Commander') then
			local model = "S_M_M_Marine_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Marine General') then
			local model = "S_M_M_Marine_02"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Black OPS1 M') then
			local model = "S_M_Y_BlackOps_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Black OPS2 M') then
			local model = "S_M_Y_BlackOps_02"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Black OPS3 M') then
			local model = "S_M_Y_BlackOps_03"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Prison Guard M') then
			local model = "S_M_M_PrisGuard_01"
                ...
                elseif 9moona.Button('~c~~h~Model~b~ Paramedic M') then
			local model = "S_M_M_Paramedic_01"
                ...
                elseif 9moona.Button('~c~~h~Model~y~ Vagos F') then
			local model = "G_F_Y_Vagos_01"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Ramp Gang M') then
			local model = "IG_Ramp_Gang"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Ramp Gang Boss M') then
			local model = "CSB_Ramp_gang"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Fam Gang 01 M') then
			local model = "MP_M_FamDD_01"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Fam Gang 02 M') then
			local model = "G_M_Y_FamDNF_01"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Fam Gang Boss M') then
			local model = "G_M_Y_FamCA_01"
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang 01 M') then
			local model = "G_M_Y_BallaEast_01"
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang 02 M') then
			local model = "G_M_Y_BallaSout_01"
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang 03 M') then
			local model = "IG_BallasOG"
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang 04 M') then
			local model = "IG_BallasOG"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang F') then
			local model = "G_F_Y_Ballas_01"
                ...
                elseif 9moona.Button('~c~~h~Model~p~ Bella Gang Boss M') then
			local model = "G_M_Y_BallaOrig_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Jewel F') then
			local model = "U_F_Y_JewelAss_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Jewel Thief') then
			local model = "U_M_M_JewelThief"
                ...
                elseif 9moona.Button('~c~~h~Model~o~ Prisoner 01 M') then
			local model = "S_M_Y_PrisMuscl_01"
                ...
                elseif 9moona.Button('~c~~h~Model~o~ Prisoner 02 M') then
			local model = "S_M_Y_Prisoner_01"
                ...
                elseif 9moona.Button('~c~~h~Model~o~ Prisoner 03 M') then
			local model = "U_M_Y_Prisoner_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder 01 M') then
			local model = "A_M_Y_MusclBeac_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder 02 M') then
			local model = "A_M_Y_MusclBeac_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder 03 M') then
			local model = "A_M_Y_Surfer_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder 04 M') then
			local model = "IG_TylerDix"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder 05 M') then
			local model = "u_m_y_babyd"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Body Builder F') then
			local model = "CS_MaryAnn"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Beach 01 F') then
			local model = "A_F_M_Beach_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Beach 02 F') then
			local model = "A_F_Y_Beach_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Beach Fat F') then
			local model = "A_F_M_FatCult_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 01') then
			local model = "A_F_Y_BevHills_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 02') then
			local model = "A_F_Y_BevHills_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 03') then
			local model = "A_F_Y_BevHills_03"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 04') then
			local model = "A_F_Y_BevHills_04"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 05') then
			local model = "CSB_Bride"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 06') then
			local model = "U_F_Y_PoppyMich"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 07') then
			local model = "A_F_Y_SouCent_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Female 08') then
			local model = "CSB_Anita"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Skater Female') then
			local model = "A_F_Y_Skater_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Old Man') then
			local model = "U_M_O_TapHillBilly"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 01') then
			local model = "S_M_Y_Barman_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 02') then
			local model = "A_M_Y_BreakDance_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 03') then
			local model = "U_M_Y_Chip"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 04') then
			local model = "U_M_Y_GunVend_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 05') then
			local model = "CSB_Groom"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Rich Guy 06') then
			local model = "A_M_Y_Business_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Chinese M 01') then
			local model = "G_M_M_ChiBoss_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Chinese M 02') then
			local model = "G_M_M_ChiGoon_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Chinese M 03') then
			local model = "G_M_M_ChiGoon_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Chinese M 04') then
			local model = "CSB_Hao"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Chinese F') then
			local model = "A_F_Y_Vinewood_03"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean M 01') then
			local model = "A_M_Y_KTown_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean M 02') then
			local model = "A_M_Y_KTown_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean M 03') then
			local model = "G_M_M_KorBoss_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean M 04') then
			local model = "G_M_Y_Korean_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean M 05') then
			local model = "G_M_Y_Korean_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean F 01') then
			local model = "S_F_Y_MovPrem_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean F 02') then
			local model = "A_F_M_KTown_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean F 03') then
			local model = "A_F_M_KTown_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Korean F 04') then
			local model = "A_F_O_KTown_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 01') then
			local model = "A_M_M_MexCntry_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 02') then
			local model = "A_M_M_MexLabor_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 03') then
			local model = "A_M_Y_MexThug_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 04') then
			local model = "G_M_M_MexBoss_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 05') then
			local model = "G_M_M_MexBoss_02"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 06') then
			local model = "U_M_Y_Mani"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican M 07') then
			local model = "S_M_M_Mariachi_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican F') then
			local model = "U_F_Y_SpyActress"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Mexican HMaid F') then
			local model = "S_F_M_Maid_01"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Boar') then
			local model = "A_C_Boar"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Pig') then
			local model = "A_C_Pig"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Deer') then
			local model = "A_C_Deer"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Chicken') then
			local model = "A_C_Hen"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Hawk') then
			local model = "A_C_Chickenhawk"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Crow') then
			local model = "A_C_Crow"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Monkey') then
			local model = "A_C_Chimp"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Dog Chop') then
			local model = "A_C_Chop"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Dog Husky') then
			local model = "A_C_Husky"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Dog Rottweiler') then
			local model = "A_C_Rottweiler"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Dog Shepherd') then
			local model = "A_C_shepherd"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Lion') then
			local model = "A_C_MtLion"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Rat') then
			local model = "A_C_Rat"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Shark') then
			local model = "A_C_SharkTiger"
                ...
                elseif 9moona.Button('~c~~h~Model Animal~s~ Coyote') then
			local model = "A_C_Coyote"
                ...
                elseif 9moona.Button('~c~~h~Model~g~ Alien') then
			local model = "s_m_m_movalien_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Pongo') then
			local model = "u_m_y_pogo_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ Bartender F') then
			local model = "S_F_Y_Bartender_01"
                ...
                elseif 9moona.Button('~c~~h~Model~s~ FiveM') then
			local model = "mp_m_freemode_01"
                ...
                elseif 9moona.Button('~c~~h~Randomize~s~ Clothing') then
				     SetPedRandomComponentVariation(PlayerPedId(), true)
                end
					
					9moona.Display()
                elseif 9moona.IsMenuOpened("SelfMenu") then
                                    if
                    9moona.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                 ...
                 then
                elseif 9moona.Button('~h~~y~Semi ~g~Godmode') then
                ...
                elseif
                 ...
                 then
                elseif 9moona.Button('~h~~r~Suicide') then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif 9moona.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                elseif 9moona.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif 9moona.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                    TriggerEvent('ambulancier:selfRespawn')
                elseif 9moona.Button('~h~~g~ESX~s~ 2ndRevive ~s~') then
                    ...
                    DoScreenFadeIn(800)
                elseif 9moona.Button("~h~~r~ESX ~s~Open Menu Jail") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif 9moona.Button("~h~~g~ESX ~s~Unjail") then
                    TriggerServerEvent('esx_jailer:unjailTime', -1)
                    TriggerServerEvent('JailUpdate', 0)
                    TriggerEvent('UnJP')
                    TriggerEvent('esx-qalle-jail:unJailPlayer')
                elseif 9moona.Button("~s~~h~Set hunger to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                elseif 9moona.Button("~s~~h~Set thirst to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "thirst", 1000000)
                elseif 9moona.Button("~h~~g~Heal") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif 9moona.Button("~h~~b~Armour") then
                    SetPedArmour(PlayerPedId(-1), 200)
                elseif 9moona.Button('~g~~h~ESX ~r~Revive') then
                ...
                elseif
                 ...
                 then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and 9moona.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerOptionsMenu") then
                        9moona.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if 9moona.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif 9moona.Button('Teleport To') then
                            local Entity = IsPedInAnyVehicle(PlayerPedId(), false) and GetVehiclePedIsUsing(PlayerPedId()) or PlayerPedId()
                            SetEntityCoords(Entity, GetEntityCoords(GetPlayerPed(SelectedPlayer)), 0.0, 0.0, 0.0, false)
                        elseif 9moona.Button("Crash Player") then
                            crash(SelectedPlayer)
                        elseif 9moona.Button("Semi God") then
                        ...
                        elseif 9moona.Button("Heal Player") then
                        ...
                        elseif 9moona.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif 9moona.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif 9moona.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        elseif 9moona.Button("Give Ammo") then
                            for i = 1, #allWeapons do
                                AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                            end
                        elseif 9moona.Button("Give All Weapons") then
                            for i = 1, #allWeapons do
                                GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                            end	
                        elseif 9moona.Button("Remove All Weapons") then
                            for i = 1, #allWeapons do
                                RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                            end
                        elseif 9moona.Button("Give Vehicle") then
                            local ped = GetPlayerPed(SelectedPlayer)
                            local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
                        ...
                        elseif 9moona.Button("Kick From Vehicle") then
                            ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        elseif 9moona.Button("Delete Vehicle") then
                        ...
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerESXMenu") then
                        if 9moona.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif 9moona.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
    
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerESXTriggerMenu") then
                        if 9moona.Button("ESX Revive") then
                            TriggerServerEvent("esx_ambulancejob:revive",GetPlayerServerId(selectedPlayer))
                        elseif 9moona.Button("ESX Give Money To Player From Your Wallet") then
                        ...
                        elseif 9moona.Button("ESX Steal Money From Player") then
                        ...
                        elseif 9moona.Button("ESX Send To Jail") then
                        ...
                        elseif 9moona.Button("ESX Get Out Of Jail") then
                        ...
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerESXJobMenu") then
                        if 9moona.Button("Unemployed") then
                        ...
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerTrollMenu") then
                        if 9moona.Button ("Fake Chat Message") then 
                        ...
                        elseif 9moona.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif 9moona.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif 9moona.Button("Mellotrainer Ban") then
                        ...
                        elseif 9moona.Button("Mellotrainer Kick") then
                        ...
                        elseif 9moona.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif 9moona.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif 9moona.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif 9moona.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                    ...
                    elseif 9moona.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        then
                        elseif 9moona.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                            currentBone = currentIndex
                            selectedBone = selectedIndex
                        end)
                        then
                        elseif 9moona.Button("Weed") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif 9moona.Button("Windmill") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        elseif 9moona.Button("Custom Prop") then
                            local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                        ...
                        9moona.Display()
                    elseif 9moona.IsMenuOpened("PlayerSpawnPedsMenu") then
				if 9moona.Button('~r~~r~Spawn ~s~Mountain Lion ~r~Attack') then
				...
				elseif 9moona.Button('~r~~r~Spawn ~s~Dog Rottweiler ~r~Attack') then
				...
				elseif 9moona.Button('~r~~r~Spawn ~s~Dog Husky ~r~Attack') then
				...
				elseif 9moona.Button('~r~~r~Sea Spawn ~s~Shark ~r~Attack') then
                    ...
                    for i = 0, 1 do
                        ...
                        if HasModelLoaded(GetHashKey(mtlion)) then
                            ...
                            elseif 9moona.Button("~h~Spawn ~s~Swat army with AK") then 
                            ...
                            elseif 9moona.Button("~h~Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif 9moona.Button("~h~Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif 9moona.Button("~h~Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
				...
				elseif 9moona.Button('~h~Spawn Swat in car ~r~Attack') then
				...
				elseif 9moona.Button('~h~Spawn Marines in car ~r~Attack') then
				...
				elseif 9moona.Button('~h~Spawn Italian Mafia in car ~r~Attack') then
				...
				elseif 9moona.Button('~h~Spawn The Lost MC Club ~r~Attack') then
				...
				elseif 9moona.Button('~h~Spawn Terrorists In Cars ~r~Attack') then
                    ...
                    if HasModelLoaded(veh) then
                        ...
                        9moona.Display()
                elseif 9moona.IsMenuOpened("VehicleRamMenu") then
                    if 9moona.Button("Futo") then
                    ...
                    elseif 9moona.Button("Bus") then
                        ...
                        9moona.Display()
                elseif 9moona.IsMenuOpened("SingleWepPlayer") then
                    for i = 1, #allWeapons do
                        if 9moona.Button(allWeapons[i]) then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("WeaponMenu") then
                    if 9moona.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif 9moona.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif 9moona.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif 9moona.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif 9moona.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                
                    9moona.Display()
                elseif 9moona.IsMenuOpened("WeaponCustomization") then
                    if 9moona.CheckBox(
                        "Rainbow Tint",
                        rainbowTint,
                        function(enabled)
                    ...
                    then
                    elseif 9moona.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif 9moona.Button("Add Special Finish") then
                    ...
                    elseif 9moona.Button("Remove Special Finish") then
                    ...
                    9moona.Display()
                elseif 9moona.IsMenuOpened("BulletGunMenu") then
                    if 9moona.CheckBox(
                        "Vehicle Gun",
                        vehicleGun,
                        function(enabled)
                    ...
                    then
                    elseif 9moona.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                        currentVehicle = currentIndex
                        selectedVehicle = selectedIndex
    
                    end) 
                    then
                    elseif 9moona.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif 9moona.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                    ...
                    then
                    elseif 9moona.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
