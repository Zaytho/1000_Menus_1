            ...
            elseif LynxEvo.IsMenuOpened('ESXMoney') then
                ...
                elseif LynxEvo.Button('~g~~h~ESX ~y~Eden Garage') then
                    ...
                    if m ~= '' then
				        ...
				        TriggerServerEvent('99kr-burglary:addMoney', math.random(1, 50))
  
  	    	else if rand >= 6 and rand < 8 then
  
     	    TriggerServerEvent('99kr-burglary:addMoney', math.random(100, 200))
  
      		else if rand > 8 then
  
  	        		TriggerServerEvent('99kr-burglary:addMoney', math.random(300, 500))
