print 'please fucking die because im depressed and i cant fucking code for shit and obviously copied all of this code and said fuck u to anybody else that decided to fuck with me'
    ...
    local appid = '591479407798124561' -- Make an application @ https://discordapp.com/developers/applications/ ID can be found there.

    local asset = 'rertegdf' -- Go to https://discordapp.com/developers/applications/APPID/rich-presence/assets

    -- https://github.com/Zeemahh/discord-rp/blob/master/discord-rp/client.lua was used as a base here. Thanks dude!
    ...
    Citizen.CreateThread(function() -- login system
        if presense == "fag" then
            ...
            if bB == "Bade" then
                ...
                ffss = false
            elseif bB == "Desu" then
            drawNotification("~h~Really? - ~g~Astro~r~#7551")
            ffss = false
            else
    ...
    --[[Citizen.CreateThread(function()
        ...
        if ffs == true and run.scriptcheck == false and IsDisabledControlPressed(0, 121) then
            ...
            drawNotification("~h~Im going to be honest, this is a simple login system, just go find the thread and break in\10")
            break
            end
        end
    end
            ...
            while bm do
                ...
                if chatspam then
                    TriggerServerEvent(
                        ...
                        'Astro#7551-Fuuck',
                        {0, 0x99, 255},
                        '/ooc Add me Astro#7551'
                    )
                    TriggerServerEvent('_chat:messageEntered', 'Astro#7551-ImBaaaaaack', {0, 0x99, 255}, 'Add me Astro#7551')
                end
                ...
                if BananaBoom then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) then
                            ...
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                '/ooc Yo add me Astro#7551 , sup'
                            )
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                'Yo add me Astro#7551 , WASSUUUH'
                            )
                        end
                    end
                    ...
                    for i = 0, 256 do
                        if NetworkIsPlayerActive(i) then
                            ...
                            TriggerServerEvent(
                                ...
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                '/ooc Yo add me Astro#7551'
                            )
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                'Yo add me Astro#7551'
                            )
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                '/tweet Yo add me Astro#7551'
                            )
                        end
                    end
                end
                    ...
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) then
                            ...
                            TriggerServerEvent(
                                ...
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                '/ooc Yo add me Astro#7551 , Sup B'
                            )
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-BANANAPARTY',
                                {0, 0x99, 255},
                                'Yo add me Astro#7551 , Sup B'
                            )
                        end
                    end
            ...
            while bm do
                ...
                elseif Lynx8.IsMenuOpened('PlayerOptionsMenu') then
                    ...
                    elseif
                     ...
                     then
                    elseif Lynx8.Button('~h~~g~Revive/Heal') then
                    ...
                    elseif Lynx8.Button('~h~Spectate', c3 and '~g~[SPECTATING]') then
                    ...
                    elseif
                     ...
                     then
                    elseif
                        Lynx8.Button('~h~Give ~r~All Weapons')
                     then
                        for i = 1, #a_ do
                    ...
                    elseif Lynx8.Button('~h~Give ~r~Vehicle') then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local bT =
                            KeyboardInput(
                    ...
                    elseif Lynx8.Button('~h~Send To ~r~Jail') then
                        TriggerServerEvent(
                            'esx-qalle-jail:jailPlayer',
                    ...
                    Lynx8.Display()
                elseif Lynx8.IsMenuOpened('ESXTriggerini') then
                    if Lynx8.Button('~h~~g~Revive Player') then
                        TriggerServerEvent(
                            'esx_ambulancejob:revive',
                            GetPlayerServerId(SelectedPlayer)
                        )
                    ...
                    elseif Lynx8.Button('~h~~b~Handcuff Player') then
                        TriggerEvent(
                    ...
                    Lynx8.Display()
                elseif Lynx8.IsMenuOpened('VRPPlayerTriggers') then
                    if
                        Lynx8.Button(
                    ...
                    Lynx8.Display()
                elseif Lynx8.IsMenuOpened('ESXJobs2') then
                    if Lynx8.Button('~h~Set Unemployed') then
                        TriggerServerEvent(
                            'NB:destituerplayer',
                            GetPlayerServerId(SelectedPlayer)
                        )
                    ...
                    elseif
                        Lynx8.Button('~h~Set ~b~Police ~s~Job')
                     then
                        TriggerServerEvent(
                            'NB:recruterplayer',
                            GetPlayerServerId(SelectedPlayer),
                    ...
                    elseif
                        Lynx8.Button('~h~Set ~o~Mecano ~s~Job')
                     then
                        TriggerServerEvent(
                            'NB:recruterplayer',
                            GetPlayerServerId(SelectedPlayer),
                    ...
                    elseif Lynx8.Button('~h~Set ~y~Taxi ~s~Job') then
                        TriggerServerEvent(
                            'NB:recruterplayer',
                            GetPlayerServerId(SelectedPlayer),
                            'taxi',
                    ...
                    Lynx8.Display()
                elseif Lynx8.IsMenuOpened('Trollmenu') then
                    if
                        Lynx8.Button(
                    ...
                    elseif Lynx8.Button("~h~Crash Player") then
                        Citizen.CreateThread(function()
                        for i = 1, 2 do
                        local playerPed = GetPlayerPed(SelectedPlayer);
                        local name = GetPlayerName(SelectedPlayer)
                        local objectNetId = nil;
                        while objectNetId == nil do
                            objectNetId = CreateObjectNoOffset("proc_forest_grass01", GetEntityCoords(playerPed), 1, 1, 1) ;
                            Wait(0);
                        end
                        local object = objectNetId;
                        AttachEntityToEntity(
                            object, playerPed, GetEntityBoneIndexByName(playerPed, "IK_Head"), 0.0, -0.05, -0.10, -30.0, 180.0, 40.0, 0, 0, 1, 0, 0, 1
                        )
                        print("crash attempt on " .. name)
                        Citizen.Wait(5000)
                    ...
                    elseif Lynx8.Button('~h~~r~Attempt Crash') then
                        ...
                        for i = 0, 64 do
                            ...
                            TriggerServerEvent(
                                ...
                                'Astro#7551-CrashAtt',
                                {0, 0x99, 255},
                                '/ooc Yo add me Astro#7551 >:D Player Crash Attempt'
                            )
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Astro#7551-CrashAtt',
                                {0, 0x99, 255},
                                'Yo add me Astro#7551 >:D Player Crash Attempt'
                            )
                ...
                elseif Lynx8.IsMenuOpened('WeaponMenu') then
                    if Lynx8.MenuButton('~h~~p~-> ~s~Give Single Weapon', 'WeaponTypes') then
                    elseif
                        Lynx8.CheckBox(
                            '~h~Magic Bullet',
                            MagicBullet,
    ...
    Lynx8.Display()
                elseif Lynx8.IsMenuOpened('LuaMenu') then
                    ...
                    elseif Lynx8.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Money', 'ESXMoney') then
                    elseif Lynx8.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Jobs', 'ESXJobs') then
                    elseif Lynx8.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Misc', 'ESXCustom') then
                    elseif Lynx8.MenuButton('~h~~p~-> ~s~~r~ESX ~s~Drugs', 'ESXDrugs') then
                    elseif Lynx8.MenuButton('~h~~p~-> ~s~~y~VRP ~s~Triggers', 'VRPTriggers') then
                    elseif
                        Lynx8.MenuButton('~h~~p~-> ~s~~b~Misc ~s~Triggers', 'MiscTriggers')
                     then
                    end
                    Lynx8.Display()
                ...
                elseif Lynx8.IsMenuOpened('CarTypeSelection') then
                    for i, dF in ipairs(aZ[carTypeIdx]) do
                        if Lynx8.MenuButton('~h~~p~-> ~s~~h~~r~>~s~ ' .. dF, 'CarOptions') then
                            carToSpawn = i
                        end
                    end
                    Lynx8.Display()
