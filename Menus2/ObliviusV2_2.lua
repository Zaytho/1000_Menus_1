                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~LuaMenuFr#0221 Menu ~r~Oblivius V2 ~b~https://discord.gg/9ZxpCtb',
                                43161336
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"obl2 ~b~https://discord.gg/9ZxpCtb")
        end
...
Citizen.CreateThread(function()
    while waduyh487r64 do
        while discordPresence do
            ...
            SetDiscordRichPresenceAssetText("obl2| https://discord.gg/9ZxpCtb")
        ...
        while waduyh487r64 do
			...
			if chatspam then
                udwdj(
                    ...
                    'LuaMenuFr#0221 Menu',
                    {0, 0x99, 255},
                    '/ooc Oblivius V2 Menu https://discord.gg/9ZxpCtb'
                )
                udwdj('_chat:messageEntered', '^8ObliviusV2Menu', {0, 0x99, 255}, '^3Oblivius V2 ^2Made by LuaMenuFr#0221 ^1Achéte ici ^4https://discord.gg/9ZxpCtb')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Oblivius V2 ~g~LuaMenuFr#0221 Menu ~b~https://discord.gg/9ZxpCtb")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~Got Fucked By Oblivius V2 ~g~LuaMenuFr#0221 Menu ~b~https://discord.gg/9ZxpCtb")
					end
				end
