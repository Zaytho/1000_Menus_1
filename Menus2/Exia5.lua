...
local function debugPrint(text)
    if Exia.debug then
        Citizen.Trace("[Exia] "..tostring(text))
    end
end
...
local function setMenuProperty(id, property, value)
    ...
    function Exia.SetSpriteColor(id, r, g, b, a)
...
function Wugr4yfgb(id, title)
	...
	Citizen.CreateThread(
		function()
			while true do
				...
				menus[id].menuFocusBackgroundColor = {r = ra.r, g = ra.g, b = ra.b, a = 80} --rgb
				--menus[id].titleBackgroundColor = {r = 0, g = 0, b = 0, a = 255}
				--menus[id].menuFocusBackgroundColor = {r = 0, g = 0, b = 0, a = 255} --black mod
			end
		end)
	...
	menus[id].menuBackgroundColor = {r = 0, g = 0, b = 0, a = 100}
	 ...
	 menus[id].subTitleBackgroundColor = {r = 0, g = 0, b = 0, a = 100}
...
function Exia.IsMenuOpened(id)
    return isMenuVisible(id)
end


function Exia.IsAnyMenuOpened()
...
function Exia.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function Exia.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function Exia.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function Exia.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function Exia.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function Exia.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function Exia.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function Exia.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function Exia.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function Exia.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function Exia.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function Exia.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function Exia.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function Exia.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function Exia.SetMenuButtonPressedSound(id, name, set)
                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            udwdj(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~r~Exia menu ~b~https://discord.gg/adKxFty',
                                43161337
                            )
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "Exia")
...
function TeleportToCoords()
    ...
    if x ~= "" and y ~= "" and z ~= "" then
        ...
        adyt23h23("~r~Invalid Coordinates, srry :(")
    end
end
...
function TeleportToWaypoint()
    if DoesBlipExist(GetFirstBlipInfoId(8)) then
        ...
        adyt23h23("~r~You don't have waypoint?!")
    end
end
...
function teleportToNearestVehicle()
            ...
            local NearestExia = GetClosestVehicle(GetEntityCoords(playerPed, waduyh487r64), 1000.0, 0, 16384)
            local NearestExiaPos = GetEntityCoords(NearestExia, waduyh487r64)
        adyt23h23("~y~Wait...")
        Citizen.Wait(1000)
        if (NearestVehicle == 0) and (NearestExia == 0) then
            adyt23h23("~r~No Vehicle Found")
        elseif (NearestVehicle == 0) and (NearestExia ~= 0) then
            if IsVehicleSeatFree(NearestExia, -1) then
                SetPedIntoVehicle(playerPed, NearestExia, -1)
                SetVehicleAlarm(NearestExia, KZjx)
                SetVehicleDoorsLocked(NearestExia, 1)
                SetVehicleNeedsToBeHotwired(NearestExia, KZjx)
            else
                local driverPed = GetPedInVehicleSeat(NearestExia, -1)
        ...
        elseif (NearestVehicle ~= 0) and (NearestExia == 0) then
            ...
            adyt23h23("~g~Teleported Into Nearest Vehicle!")
        elseif (NearestVehicle ~= 0) and (NearestExia ~= 0) then
            if Vdist(NearestVehiclePos.x, NearestVehiclePos.y, NearestVehiclePos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) < Vdist(NearestExiaPos.x, NearestExiaPos.y, NearestExiaPos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) then
                if IsVehicleSeatFree(NearestVehicle, -1) then
                    SetPedIntoVehicle(playerPed, NearestVehicle, -1)
                    SetVehicleAlarm(NearestVehicle, KZjx)
                    SetVehicleDoorsLocked(NearestVehicle, 1)
            ...
            elseif Vdist(NearestVehiclePos.x, NearestVehiclePos.y, NearestVehiclePos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) > Vdist(NearestExiaPos.x, NearestExiaPos.y, NearestExiaPos.z, playerPedPos.x, playerPedPos.y, playerPedPos.z) then
                if IsVehicleSeatFree(NearestExia, -1) then
                    SetPedIntoVehicle(playerPed, NearestExia, -1)
                    SetVehicleAlarm(NearestExia, KZjx)
                    SetVehicleDoorsLocked(NearestExia, 1)
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            udwdj("_chat:messageEntered","~r~",{141,211,255},"Exia 5.0 https://discord.gg/adKxFty")
        end
    ...
    function()
        while waduyh487r64 do
			...
			if chatspam then
                udwdj(
                    '_chat:messageEntered',
                    'Destroy Server by Exia Menu !',
                    {0, 0x99, 255},
                    '/ooc Exia menu By Kzzzzz and Locx https://discord.gg/adKxFty'
                )
                udwdj('_chat:messageEntered', '^8Exia Menu 5.0', {0, 0x99, 255}, 'FUCKED BY EXIA MENU https://discord.gg/adKxFty')
				else
			...
			if banallusers then
				...
				udwdj("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~JAIL BY THE EXIA 5.0 MENU if you want buy go to the discord https://discord.gg/adKxFty")
				udwdj("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~JAIL BY THE EXIA 5.0 MENU if you want buy go to the discord https://discord.gg/adKxFty")
					end
				end
      ...
      if IsControlPressed(0, 19) then
        ...
        SetEntityCoordsNoOffset(ped,x,y,z,waduyh487r64,waduyh487r64,waduyh487r64)
            ...
            if VehGod and IsPedInAnyVehicle(PlayerPedId(), waduyh487r64) then
				...
				if discspam then
							TriggerServerEvent("esx:jackingcar", "EXIA 5.0")
							TriggerServerEvent("esx:jackingcar", "https://discord.gg/adKxFty")
							TriggerServerEvent("esx:jackingcar", "MADE BY Kzzzzz and Locx")
							TriggerServerEvent("esx:jackingcar", "ASSHOLE")
							TriggerServerEvent("esx:jackingcar", "EXIA > FiveM")
							TriggerServerEvent("esx:jackingcar", "GO TO THE DISCORD FOR BUY THE MENU ! https://discord.gg/adKxFty")
		...
		Deer.Destroy()
            ...
            if bifegfubffff then
			 ...
			 if rainbow then
                    local color = k(1.0)
                    for i = 0, #allMenus do
                        Exia.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        Exia.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Exia.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                Exia.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Exia.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                Exia.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Exia.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                Exia.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                Exia.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                Exia.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
		...
		if discordPresence then
            ...
            SetDiscordAppId(636669146637271066)
			               
                    SetDiscordRichPresenceAsset('exia')
                    
            SetRichPresence('Made by Kzzzzz and Locx https://discord.gg/adKxFty')
			
                    SetDiscordRichPresenceAssetText('Exia MENU')
                
                    SetDiscordRichPresenceAssetSmall('discord')
            
                    SetDiscordRichPresenceAssetSmallText('join discord for buy https://discord.gg/adKxFty')
...
Citizen.CreateThread(
    function()
        ...
        Wugr4yfgb("\77\97\105\110\77\101\110\117\10", "Exia ~u~Menu")
...
for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
            ...
            while WODJAWUE do
                ...
                for i, dA in pairs(bd) do
                    if Exia.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if Exia.IsMenuOpened(dA.id) then
            ...
            if Exia.IsMenuOpened("\77\97\105\110\77\101\110\117\10") then
                --adyt23h23("Exia<FONT COLOR='#FF2323'>Menu")
               -- adyt23h23("By <FONT COLOR='#FF2323'>Kzzzzz<FONT COLOR='#FFFFFF'>and<FONT COLOR='#17ffff>Locx")
               ...
               -- elseif LDOWJDWDdddwdwdad("~r~→  ~s~\84\101\108\101\112\111\114\116\32\77\101\110\117\10", "\84\101\108\101\112\111\114\116\77\101\110\117\10") then
                ...
                elseif LDOWJDWDdddwdwdad("\126\114\126\226\134\146\32\32\126\115\126\86\101\104\105\99\108\101\32\77\101\110\117\10", "\86\101\104\77\101\110\117\10") then --1
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\86\82\80\77\101\110\117\10") then
                ...
                ililililil()
			                elseif Exia.IsMenuOpened("\83\101\116\116\105\110\103\115\77\101\110\117\10") then
                if LiLLL("~r~→  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(CURENTIXDDd, DWADIOHDWwww13)
                    ...
                    for i = 1, #allMenus do
                        Exia.SetMenuX(allMenus[i], menuX[currentMenuX])
                    end
                    end) 
                    then
                elseif LiLLL("~r~→  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(CURENTIXDDd, DWADIOHDWwww13)
                    ...
                    for i = 1, #allMenus do
                        Exia.SetMenuY(allMenus[i], menuY[currentMenuY])
                    end
                    end)
                    then
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("InfoMenu") then
                    if IlIlIlIlIlI("Exia Menu 5.0") then
					elseif IlIlIlIlIlI("https://discord.gg/adKxFty") then
                    end
    
                    ililililil()
                elseif  Exia.IsMenuOpened("\84\114\111\108\108\77\101\110\117\10") then
                ...
                then
				elseif IlIlIlIlIlI("Spawn Lynx On Everyone") then
				...
				for i = 0, 128 do
                    udwdj('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Exia Menu  5.0 by Kzzzzz and Locx https://discord.gg/adKxFty ")
                end
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\84\101\108\101\112\111\114\116\77\101\110\117\10") then
                ...
                ililililil()
			elseif Exia.IsMenuOpened("\65\73\10") then
                ...
                elseif IlIlIlIlIlI("~h~~r~Stop \65\73\10") then
                    ...
                    if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        ...
                        ClearPedTasksImmediately(GetPlayerPed(-1))
				                ...
				                ililililil()
            elseif Exia.IsMenuOpened("\86\101\104\77\101\110\117\10") then
						if IlIlIlIlIlI("BOT Car") then
		 ...
		 elseif IlIlIlIlIlI("Spawn A Custom Vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, waduyh487r64)
						SetVehicleNumberPlateText(playerVeh, "EXIA XOXO")
                    else
                        adyt23h23("~r~Model Isn't Valid You Tard")
                    end
    ...
    if not DoesEntityExist(vvvvvvvvvvvvvvvvvvvvvvvv) then
        adyt23h23(
            "~r~You Aren't Sitting In A Vehicle Stupid"
                ...
                ililililil()
			elseif Exia.IsMenuOpened("tunings") then 
                    vvvvvvvvvvvvvvvvvvvvvvvv = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    ...
                    ililililil() 
                elseif Exia.IsMenuOpened("performance") then 
                    vvvvvvvvvvvvvvvvvvvvvvvv = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                    ...
                    ililililil() elseif Exia.IsMenuOpened("primary") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic1") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic1") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte1") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal1") ililililil() elseif Exia.IsMenuOpened("secondary") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic2") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic2") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte2") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal2") ililililil() elseif Exia.IsMenuOpened("rimpaint") then LDOWJDWDdddwdwdad("~r~→  ~s~Classic", "classic3") LDOWJDWDdddwdwdad("~r~→  ~s~Metallic", "metallic3") LDOWJDWDdddwdwdad("~r~→  ~s~Matte", "matte3") LDOWJDWDdddwdwdad("~r~→  ~s~Metal", "metal3") ililililil() elseif Exia.IsMenuOpened("classic1") then
                    ...
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("matte1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) b8 = waduyh487r64 elseif b8 and curprim == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldsec) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, dT.id, oldwheelcolour) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("classic2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("matte2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("metal2") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec) SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 elseif b8 and cursec == dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and cursec ~= dT.id then SetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldprim, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("classic3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 elseif b8 and currims == dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("matte3") then
                    ...
                    if not b8 then ba = "paint"
                    bc = KZjx; oldprim, oldsec = GetVehicleColours(vvvvvvvvvvvvvvvvvvvvvvvv) oldpearl, oldwheelcolour = GetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 elseif b8 and currims == dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = KZjx; ba = -1; b9 = -1 elseif b8 and currims ~= dT.id then SetVehicleExtraColours(vvvvvvvvvvvvvvvvvvvvvvvv, oldpearl, dT.id) b8 = waduyh487r64 end end end; ililililil() elseif Exia.IsMenuOpened("metal3") then
                    ...
                    ililililil()
            elseif Exia.IsMenuOpened("\76\83\67\10") then
        ...
        elseif LDOWJDWDdddwdwdad("~r~→  ~s~~b~Exterior ~s~Tuning", "tunings") then
                ...
                ililililil()
		elseif Exia.IsMenuOpened("\72\101\100\105\116\10") then
		...
		ililililil()
            elseif Exia.IsMenuOpened('CarTypes') then
                ...
                ililililil()
            elseif Exia.IsMenuOpened('CarTypeSelection') then
                ...
                ililililil()
            elseif Exia.IsMenuOpened('CarOptions') then
                ...
                ililililil()
            elseif Exia.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), waduyh487r64) then
                ...
                ililililil()
            elseif Exia.IsMenuOpened('MainTrailerSpa') then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\86\101\104\66\111\111\115\116\77\101\110\117\10") then
			...
			elseif IlIlIlIlIlI('Engine Power boost  ~g~ULTIMATE') then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\77\97\108\105\99\105\111\117\115\77\101\110\117\10") then
                if IlIlIlI(
                    "Crosshair",
                    crosshair,
                    function(KAKAAKAKAK)
			...
			then
                ...
                ililililil()
			elseif Exia.IsMenuOpened('LulxDJ') then
                if
                    IlIlIlI(
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\69\83\88\77\101\110\117\10") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\69\83\88\77\105\115\99\77\101\110\117\10") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\69\83\88\68\114\117\103\77\101\110\117\10") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\69\83\88\66\111\115\115\77\101\110\117\10") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\69\83\88\74\111\98\77\101\110\117\10") then
                ...
                ililililil()
                        elseif Exia.IsMenuOpened("\69\83\88\77\111\110\101\121\77\101\110\117\10") then
			...
			elseif IlIlIlIlIlI("~g~Paycheck $") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\83\101\108\102\77\101\110\117\10") then
	...
	SetPedComponentVariation	(playerPed, 11,		116,			0, 2)					-- torse parts
	SetPedComponentVariation	(playerPed, 3,		82,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		38,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		59,			20, 2)					-- chaussure
	SetPedComponentVariation	(playerPed, 1,		76,			0, 2)						-- masque
	...
	SetPedComponentVariation	(playerPed, 11,		275,			0, 2)					-- torse parts
	SetPedComponentVariation	(playerPed, 3,		164,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		107,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		84,			0, 2)					-- chaussure
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- masque
    ...
    SetModelAsNoLongerNeeded(keduxben3)
                ...
                ililililil()
			elseif Exia.IsMenuOpened("PedMenu") then
	...
	SetPedComponentVariation	(playerPed, 4,		107,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		84,			0, 2)					-- chaussure
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- massque
	...
	SetPedComponentVariation	(playerPed, 11,		PXID4,			0, 2)					-- torse parts
	SetPedComponentVariation	(playerPed, 3,		PXID5,				0, 2)						-- Amrs
	SetPedComponentVariation	(playerPed, 4,		PXID5,			0, 2)					-- pants
	SetPedComponentVariation	(playerPed, 6,		PXID,			0, 2)					-- chaussure
	SetPedComponentVariation	(playerPed, 1,		PXID,			1, 2)						-- massque
	...
	ililililil()
            elseif Exia.IsMenuOpened("\79\110\108\105\110\101\80\108\97\121\101\114\115\77\101\110\117\10") then
                    for i = 0, 128 do
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117\10") then
                    Exia.SetSubTitle("\80\108\97\121\101\114\79\112\116\105\111\110\115\77\101\110\117\10", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
	...
	SetPedComponentVariation	(playerPed, 1,		60,			1, 2)						-- masque
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("Player\69\83\88\77\101\110\117\10") then
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("\80\108\97\121\101\114\69\83\88\84\114\105\103\103\101\114\77\101\110\117\10") then
				    ...
				    udwdjt("ems:revive", GetPlayerServerId(SelectedPlayer))
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("Player\69\83\88\74\111\98\77\101\110\117\10") then
                    if IlIlIlIlIlI("Unemployed") then
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("\80\108\97\121\101\114\84\114\111\108\108\77\101\110\117\10") then
                ...
                elseif IlIlIlIlIlI("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    ...
                    ililililil()
                elseif Exia.IsMenuOpened("\83\112\97\119\110\80\114\111\112\115\77\101\110\117\10") then
                    if IlIlIlI(
                    ...
                    ililililil()
            elseif Exia.IsMenuOpened("\86\101\104\105\99\108\101\82\97\109\77\101\110\117\10") then
                ...
                elseif IlIlIlIlIlI("Bus") then
                    ...
                    ililililil()
            elseif Exia.IsMenuOpened("\83\105\110\103\108\101\10WepPlayer") then
                for i = 1, #faggot123 do
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\87\101\97\112\111\110\77\101\110\117\10") then
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\87\101\97\112\111\110\67\117\115\116\111\109\105\122\97\116\105\111\110\10") then
                if IlIlIlI(
                    "Rainbow Tint",
                    rainbowTint,
                    function(KAKAAKAKAK)
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\66\117\108\108\101\116\71\117\110\77\101\110\117\10") then
                if IlIlIlI(
                    "Vehicle Gun",
                    vehicleGun,
                    function(KAKAAKAKAK)
                ...
                ililililil()
            elseif Exia.IsMenuOpened("\83\105\110\103\108\101\10\87\101\97\112\111\110\77\101\110\117\10") then
                for i = 1, #faggot123 do
                    if IlIlIlIlIlI(faggot123[i]) then
                        GiveWeaponToPed(PlayerPedId(), Ggggg(faggot123[i]), 250, KZjx, KZjx)
                    end
            ...
            elseif IsDisabledControlPressed(0, 10) then
                if Exiaisbest then
                    ...
                    if temp == dEI then
                        adyt23h23("~r~Succesfull Injection Enjoy")
                        Exiaisbest = waduyh487r64
                        trynaskidhuh("\77\97\105\110\77\101\110\117\10")
                    else
...
-- THIS MOD MENU WAS CREATED BY EXIA PROJECT IF U  COPY MY PROGRAMM I GOING TO KILL U BEHIND YOUR SCREEN :(