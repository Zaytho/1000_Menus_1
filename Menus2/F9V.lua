    ...
    local allMenus = { "Bouba MainMenu", "Bouba SelfMenu", "Bouba OnlinePlayersMenu", "Bouba WeaponMenu", "SingleBouba WeaponMenu", "Bouba MODEL", "Bouba MaliciousMenu", 
                                "Bouba ESXMenu", "Bouba Bouba ESXJobMenu", "ESXMoneyMenu", "Bouba Bouba VehMenu", "VehSpawnOpt", "Bouba PlayerOptionsMenu", "Bouba MiscAIDrive",
                                "Bouba TeleportMenu", "NiggerCustoms", "Bouba PlayerTrollMenu", "PlayerBouba ESXMenu", "PlayerBouba Bouba ESXJobMenu", 
...
Citizen.CreateThread(
    ...
    Citizen.CreateThread(
        function()
            ...
            BOUBA.CreateMenu("Bouba MainMenu", "~r~BOUBA")
        ...
        local SelectedPlayer
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and BOUBA.Button(dA.name.." Upgrade 4", price4) then 
                ...
                elseif BOUBA.IsMenuOpened("VRPMenu") then
                    ...
                    BOUBA.Display()
                elseif BOUBA.IsMenuOpened("SettingsMenu") then
                    ...
                    BOUBA.Display()
                elseif BOUBA.IsMenuOpened("InfoMenu") then
                    if BOUBA.Button("Build 0.9") then
                    end
    
                    BOUBA.Display()
                elseif BOUBA.IsMenuOpened("Themes") then
                ...
                elseif BOUBA.IsMenuOpened("Credits") then
                    if BOUBA.Button("Outcasts 666 Created By: OutcastModdingteam Outcast#3723") then
                    end
