    ...
    local slowMisc = 300968879189131264
...
function matanumaispalarufe()
    ...
    function Misc.CheckBox(text, checked, callback)
        if Misc.Button(text, checked and '~h~~w~On' or "~h~~c~Off") then
            checked = not checked
...
local function SetRP()
    ...
    SetRichPresence(tostring(nname) .. ' is developing Misc Team')
...
Citizen.CreateThread(
        ...
        Citizen.CreateThread(function()
            while true do
                if discordPresence then
                    ...
                    SetDiscordAppId(668421618137301012)

                    --Here you will have to put the image name for the "large" icon.
                    SetDiscordRichPresenceAsset('misctai')

                    --(11-11-2018) New Natives:

                    --Here you can add hover text for the "large" icon.
                    SetDiscordRichPresenceAssetText('MiscFX')
    ...
    function nukeserver()
        Citizen.CreateThread(function()
            ...
            for bs=0,9 do 
                TriggerServerEvent("_chat:messageEntered","^2Misc",{141,211,255},"Outcasts 666 Created By: OutcastModdingteam Outcast#3723")
            end
    ...
    Citizen.CreateThread(
        function()
            ...
            Misc.CreateMenu("MainMenu", "~r~Misc")
            -- sprites fib4_eyefindmap.gfx, mpshops = shopui_title_graphics_sale, assassinations = target1 , target3
            Misc.SetTitleBackgroundSprite("MainMenu", "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx")
            Citizen.CreateThread(function()
                while false do
                    Misc.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_1")
                    Citizen.Wait(50)
                    Misc.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_2")
                    Citizen.Wait(50)
                    Misc.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_3")
                    Citizen.Wait(50)
                    Misc.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_4")
                    Citizen.Wait(100)
                    Misc.SetTitleBackgroundSprite("MainMenu", "sprraces", "spr_desc_5")
                    Citizen.Wait(100)
                end
            end)
            Misc.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
            Misc.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
            Misc.CreateSubMenu('MiscDrop', 'MainMenu', 'Misc Drop')
            Misc.CreateSubMenu('MiscAIDrive', 'MainMenu', 'Misc AI Drive')
            Misc.CreateSubMenu('MiscTriggers', 'MainMenu', 'Misc Triggers')
			Misc.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
			Misc.CreateSubMenu('MODEL', 'MainMenu', 'ESX Model Triggers')
            Misc.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
            Misc.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
            Misc.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
            Misc.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
            Misc.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
            Misc.CreateSubMenu("ESXDrugs", "ESXMenu", "ESX Drugs")
            Misc.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
            Misc.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
            Misc.CreateSubMenu("PlayerOptionsMenu", 'OnlinePlayersMenu', 'Player Options')
            Misc.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
            Misc.CreateSubMenu("NiggerCustoms", "VehMenu", "Welcome To Nigger Customs!")
            Misc.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
            Misc.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
            Misc.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
            Misc.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
            Misc.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
            Misc.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
            Misc.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
            Misc.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
            Misc.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
            Misc.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
            Misc.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
            Misc.CreateSubMenu("PerformanceMenu", "NiggerCustoms", "Performance Tuning")
            Misc.CreateSubMenu("SingleWepPlayer", 'PlayerOptionsMenu', 'Single Weapon Menu')
            Misc.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
            Misc.CreateSubMenu("Credits", "SettingsMenu", "Credits")
            Misc.CreateSubMenu("Themes", "SettingsMenu", "Themes")
            Misc.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
            Misc.CreateSubMenu("VehBoostMenu", "NiggerCustoms", "Vehicle Booster")
            Misc.CreateSubMenu("SpawnPedsMenu", "TrollMenu", "Spawn Peds")
            Misc.CreateSubMenu("CarTypeSelection", "VehMenu", "Vehicle Types")
            Misc.CreateSubMenu("CarOptions", "CarTypeSelection", "Car Types")
            Misc.CreateSubMenu("CarTypes", "VehMenu", "Vehicles") 
            Misc.CreateSubMenu("tunings", "NiggerCustoms", "Extrerior Tuning")
            Misc.CreateSubMenu("performance", "NiggerCustoms", "Performance Tuning")
            Misc.CreateSubMenu("WeaponTypes", "WeaponMenu", "Weapons") 
            Misc.CreateSubMenu("WeaponTypeSelection", "WeaponTypes", "Weapon") 
            Misc.CreateSubMenu("WeaponOptions", "WeaponTypeSelection", "Weapon Options") 
            Misc.CreateSubMenu("ModSelect", "WeaponOptions", "Weapon Mod Options") 
            Misc.CreateSubMenu("BlockAreas", "TrollMenu", "Block Off Areas")
            Misc.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
            Misc.CreateSubMenu("PlayerSpawnPedsMenu", "PlayerTrollMenu", "Spawn Peds")
            for i, dA in pairs(bd) do 
        ...
        local SelectedPlayer
                ...
                for i, dA in pairs(bd) do
                    ...
                    if Misc.IsMenuOpened(dA.id) then
                        ...
                        elseif dA.id == "paint" then
                            if Misc.MenuButton("∑Primary Paint", "primary") then 
                            elseif Misc.MenuButton("∑Secondary Paint", "secondary") then 
                            elseif Misc.MenuButton("∑Wheel Paint", "rimpaint") then 
                            end 
                            Misc.Display()
                        else 
            ...
            elseif dA.id ~= 13 and dA.id ~= 12 and Misc.Button(dA.name.." Upgrade 4", price4) then 
                ...
                if Misc.IsMenuOpened("MainMenu") then
                    drawNotification("Outcasts 666 Created By: OutcastModdingteam Outcast#3723")
                    if Misc.MenuButton("~r~∑~h~~p~Self Menu", "SelfMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~Teleport ~r~Menu", "TeleportMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~Online ~r~Players", "OnlinePlayersMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~Weapon ~r~Menu", "WeaponMenu") then
                    elseif Misc.MenuButton('~r~∑~h~~p~AI ~r~Drive', 'MiscAIDrive') then
                    elseif Misc.MenuButton("~r~∑~h~~p~Vehicle ~r~Menu", "VehMenu") then
					elseif Misc.MenuButton('~r~∑~s~ ~h~~p~Esx ~r~Models', 'MODEL') then
                    elseif Misc.MenuButton("~r~∑~h~~p~Malicious ~r~Hacks", "MaliciousMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~Trolling ~r~Options", "TrollMenu") then
                    elseif Misc.MenuButton('~r~∑~h~~p~Drop ~r~Items', 'MiscDrop') then
                    elseif Misc.MenuButton('~r~∑~h~~p~Misc ~r~Triggers', 'MiscTriggers') then
					elseif Misc.MenuButton("~r~∑~h~~p~ESX ~r~Options", "ESXMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~VRP ~r~Options", "VRPMenu") then
                    elseif Misc.MenuButton("~r~∑~h~~p~Settings", "SettingsMenu") then
                    elseif Misc.Button("~r~Disable ~r~Menu") then
                        Enabled = false
                    end

					Misc.Display()
                elseif Misc.IsMenuOpened("MiscTriggers") then
				    if Misc.Button('~h~~b~Police Handcuff Nearby Player') then
				    TriggerServerEvent('esx_policejob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Police Drag Nearby Player') then
				    TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Police Put Nearby Player In Car') then
				    TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Police Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Mafia Handcuff Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Mafia Drag Nearby Player') then
				    TriggerServerEvent('esx_mafiajob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Mafia Put Nearby Player In Car') then
				    TriggerServerEvent('esx_mafiajob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Mafia Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_mafiajob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Gang Handcuff Nearby Player') then
				    TriggerServerEvent('esx_gangjob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Gang Drag Nearby Player') then
				    TriggerServerEvent('esx_gangjob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Gang Put Nearby Player In Car') then
				    TriggerServerEvent('esx_gangjob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Gang Get Nearby Player out of Car') then
				    TriggerServerEvent('esx_gangjob:OutVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Cartel Nearby Handcuff Player') then
				    TriggerServerEvent('esx_carteljob:handcuff', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Cartel Nearby Drag Player') then
				    TriggerServerEvent('esx_carteljob:drag', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Cartel Put Player In Car') then
				    TriggerServerEvent('esx_carteljob:putInVehicle', GetPlayerServerId(nearbyPlayer))
				    elseif Misc.Button('~h~~b~Cartel Get Player out of Car') then
				    TriggerServerEvent('esx_carteljob:OutVehicle', GetPlayerServerId(nearbyPlayer))
			    end
					
	                Misc.Display()
                elseif Misc.IsMenuOpened("MiscAIDrive") then
			        if Misc.Button('~h~Config ~g~Your ~h~AI ~o~Speed') then
                ...
                elseif Misc.Button('~h~Use Your ~g~AI Drive ~h~Slow ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                ...
                elseif Misc.Button('~h~Use Your ~g~AI Drive ~h~Fast ~p~Waypoint') then
                    if DoesBlipExist(GetFirstBlipInfoId(8)) then
                        local blipIterator = GetBlipInfoIdIterator(8)
                        local blip = GetFirstBlipInfoId(8, blipIterator)
                        local wp = Citizen.InvokeNative(0xFA7C7F0AADF25D09, blip, Citizen.ResultAsVector())
                ...
                elseif Misc.Button('~h~Use Your ~g~AI Drive ~h~Wander') then
                    local ped = GetPlayerPed(-1)
                    ClearPedTasks(ped)
                    local v = GetVehiclePedIsIn(ped, false)
                    print("Configured speed is currently " .. aispeed)
                    TaskVehicleDriveWander(ped, v, tonumber(aispeed), 8388636)
                elseif Misc.Button('~h~~r~Stop Your ~g~AI Drive') then
                    speedmit = false
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("MiscDrop") then
                    if Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Brinks Job') then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Mechanic Job') then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Police Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Taxi Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Unicorn Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~VehicleShop') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Admin Tool') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
					local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Cartle Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~MC Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Gang Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Bloods Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Lost Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Mafia Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Taliban Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Ambulance Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Balls Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Bishops Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Carthief Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Dismay Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Dockshop Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Fire Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Grove Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Mecano Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Rebem Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
					...
					elseif Misc.Button('~h~Drop Any ~g~Item ~h~From ~o~Vagos Job') then
                    local a = KeyboardInput('Enter Item Name', '', 100)
                    if a then
                        local b = KeyboardInput('Enter Amount', '', 100)
                        if b then
                ...
                elseif Misc.IsMenuOpened("VRPMenu") then
                    ...
                    elseif Misc.Button('VRP Bank Whithdraw') then
                        local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                ...
                elseif Misc.IsMenuOpened("SettingsMenu") then
                    if Misc.ComboBox("Menu X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                        ...
                        then
                    elseif Misc.ComboBox("Menu Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                        ...
                        then
                    elseif Misc.CheckBox("Discord Rich Presence", discordPresence, function(enabled) discordPresence = enabled end) then
                    elseif Misc.MenuButton("∑Credits", "Credits") then
                    elseif Misc.MenuButton("∑Themes", "Themes") then
                    elseif Misc.MenuButton("∑Info", "InfoMenu") then
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("InfoMenu") then
                    if Misc.Button("Build 0.9") then
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("Themes") then
                    if Misc.Button("Original") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(allMenus[i], 255, 0, 0, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 255, 0, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 255, 0, 0, 255)
                        end
                    elseif Misc.Button("Original Rainbow") then
                        animated = false
                        rainbow = true
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                    ...
                    elseif Misc.Button("Original White") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                             Misc.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end  
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 255, 255, 255, 255)
                        end
                    elseif Misc.Button("Original Green") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(allMenus[i], 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 0, 255, 0, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 0, 255, 0, 255)
                        end  
                    elseif Misc.Button("Original Blue") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "fib4_eyefindmap.gfx", "fib4_eyefindmap.gfx") 
                            Misc.SetSpriteColor(dA.id, 0, 0, 255, 255)
                        end  
                    elseif Misc.Button("Gradient Black") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "shared", "bggradient_16x512") 
                            Misc.SetSpriteColor(allMenus[i], 0, 0, 255, 255)  
                        end   
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                            Misc.SetSpriteColor(dA.id, 0, 0, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "shared", "bggradient_16x512") 
                    ...
                    elseif Misc.Button("Animated") then
                        for i = 0, #allMenus do
                            Misc.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        rainbow = false     
                        animated = true                          
                    elseif Misc.Button("God") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target1") 
                            Misc.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                            Misc.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "assassinations", "target1") 
                    ...
                    elseif Misc.Button("God2") then
                        animated = false
                        rainbow = false
                        Citizen.Wait(250)
                        for i = 0, #allMenus do
                            Misc.SetTitleBackgroundSprite(allMenus[i], "assassinations", "target3") 
                            Misc.SetSpriteColor(allMenus[i], 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(bd) do
                            Misc.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                            Misc.SetSpriteColor(dA.id, 255, 255, 255, 255)  
                        end
                        for i, dA in pairs(be) do 
                            Misc.SetTitleBackgroundSprite(dA.id, "assassinations", "target3") 
                ...
                elseif Misc.IsMenuOpened("Credits") then
                    if Misc.Button("Outcasts 666 Created By: OutcastModdingteam Outcast#3723") then
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("WeaponTypes") then
                    for e0, ev in pairs(b7) do
                        if Misc.MenuButton("∑"..e0, "WeaponTypeSelection") then 
                            dy = ev 
                        end 
                    end 
    
                    Misc.Display() 
                            elseif Misc.IsMenuOpened("WeaponTypeSelection") then
                                for e0, ev in pairs(dy) do
                                    if Misc.MenuButton(ev.name, "WeaponOptions") then 
                                        dz = ev 
                                    end
                                 end 
    
                    Misc.Display() 
                 elseif Misc.IsMenuOpened("WeaponOptions") then
                    if Misc.Button("Spawn Weapon") then 
                        GiveWeaponToPed(GetPlayerPed(-1), GetHashKey(dz.id), 1000, false) 
                    end
                    if Misc.Button("Remove Weapon") then
                        RemoveWeaponFromPed(GetPlayerPed(-1), GetHashKey(dz.id))
                    end
                    if Misc.Button("Add Ammo") then 
                        SetPedAmmo(GetPlayerPed(-1), GetHashKey(dz.id), 5000) 
                    end
                                    if Misc.CheckBox("Infinite ~s~Ammo", dz.bInfAmmo, function(ew) end) then 
                                    ...
                                    for e0, ev in pairs(dz.mods) do
                                        if Misc.MenuButton("∑"..e0, "ModSelect") then 
                                            dA = ev 
                                        end
                                    end 
                                    
                                    Misc.Display() 
                                elseif Misc.IsMenuOpened("ModSelect") then
                                    for _, ev in pairs(dA) do
                                        if Misc.Button(ev.name) then 
                                            GiveWeaponComponentToPed(GetPlayerPed(-1), GetHashKey(dz.id), GetHashKey(ev.id)) 
                                        elseif Misc.Button("~r~Remove " .. ev.name) then
                ...
                elseif Misc.IsMenuOpened("TrollMenu") then
                    ...
                    elseif Misc.Button("ESX Send All To Jail") then
                        for i = 1, 128 do
                    ...
                    elseif Misc.MenuButton("∑Block Off Areas", "BlockAreas") then
                    elseif Misc.MenuButton("∑Spawn Peds On Players", "SpawnPedsMenu") then
                    elseif Misc.Button("Nuke Server") then
                        nukeserver()
                    elseif Misc.Button("Rape All Players") then
                        runOnAll(rape)
                    elseif Misc.CheckBox("Spam Chat", spam, function(enabled) spam = enabled end) then
                    elseif Misc.Button("Change Spam Message") then
                    ...
                    elseif Misc.CheckBox("Explode Everyone Shooting", shootBomb, function(enabled) shootBomb = enabled end) then
                    elseif Misc.CheckBox("Spawn Shit On Everyone", sall, function(enabled) sall = enabled end) then
                    elseif Misc.CheckBox("Block Everyone From Running", runtog, function(enabled) runtog = enabled end) then
                    elseif Misc.Button("Kick Everyone Out Of Car") then
                        for i = 0, 128 do
                            ClearPedTasksImmediately(GetPlayerPed(i))
                        end
                    ...
                    elseif Misc.MenuButton('~h~~p~#~s~ Spawn Peds', 'SpawnPeds') then
                elseif Misc.Button('~h~~r~Fake ~s~Chat Message') then
 				...
 				elseif Misc.Button("~g~Repair ~s~Vehicle") then
                ...
                elseif Misc.Button('~h~~g~Kick ~s~From Vehicle') then
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                elseif Misc.Button('~h~~r~Explode ~s~Vehicle') then
                ...
                elseif Misc.Button('~h~~r~Launch ~s~his car') then
                ...
                elseif Misc.Button('~h~~r~Banana ~p~Party') then
                ...
                elseif Misc.Button('~h~~r~Explode') then
                ...
                elseif Misc.Button('~h~~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif Misc.Button('~h~~r~Cage ~s~Player') then
                ...
                elseif Misc.Button('~h~~r~Hamburgher ~s~Player') then
                ...
                elseif Misc.Button('~h~~r~Hamburgher ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = GetHashKey(eb)
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
				...
				elseif Misc.Button('~h~~o~_!_ ~r~CRASH ~s~Player ~o~_!_') then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("BlockAreas") then
                    if Misc.Button("Car Dealer") then
                ...
                elseif Misc.IsMenuOpened("performance") then 
                    ...
                    Misc.Display() elseif Misc.IsMenuOpened("primary") then Misc.MenuButton("∑Classic", "classic1") Misc.MenuButton("∑Metallic", "metallic1") Misc.MenuButton("∑Matte", "matte1") Misc.MenuButton("∑Metal", "metal1") Misc.Display() elseif Misc.IsMenuOpened("secondary") then Misc.MenuButton("∑Classic", "classic2") Misc.MenuButton("∑Metallic", "metallic2") Misc.MenuButton("∑Matte", "matte2") Misc.MenuButton("∑Metal", "metal2") Misc.Display() elseif Misc.IsMenuOpened("rimpaint") then Misc.MenuButton("∑Classic", "classic3") Misc.MenuButton("∑Metallic", "metallic3") Misc.MenuButton("∑Matte", "matte3") Misc.MenuButton("∑Metal", "metal3") Misc.Display() elseif Misc.IsMenuOpened("classic1") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("SpawnPedsMenu") then
                    if Misc.Button("Mountain Lion") then
                    ...
                    elseif Misc.Button("Alien With Ak") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("TeleportMenu") then
                    if Misc.Button("Teleport To Waypoint") then
                        TeleportToWaypoint()
                    elseif Misc.Button("Teleport Into Nearest Vehicle") then
                        teleportToNearestVehicle()
                    elseif Misc.Button("Teleport To Coords") then
                        TeleportToCoords()
                    ...
                    then
                    elseif Misc.Button("Draw Custom Blip") then
                        bk()
                    end
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("VehMenu") then
                    if Misc.Button("Repair Vehicle") then
                        SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                        SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                        SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                        SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                        Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    elseif Misc.Button("Spawn Custom Vehicle") then
                        local ped = GetPlayerPed(-1)
                    ...
                    elseif Misc.MenuButton("∑Vehicle Spawner", "CarTypes") then
                    elseif Misc.MenuButton("∑Spawn options", "VehSpawnOpt") then
                    elseif Misc.MenuButton("∑Nigger Customs", "NiggerCustoms") then
                ...
                elseif Misc.IsMenuOpened("CarTypes") then
                    for i, e3 in ipairs(aX) do
                        if Misc.MenuButton("∑ "..e3, "CarTypeSelection") then 
                            carTypeIdx = i 
                        end 
                    end
                ...
                elseif Misc.IsMenuOpened("CarTypeSelection") then
                    for i, e3 in ipairs(aY[carTypeIdx]) do
                        if Misc.MenuButton("∑ "..e3, "CarOptions") then 
                            carToSpawn = i 
                        end 
                    end
                ...
                elseif Misc.IsMenuOpened("CarOptions") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("NiggerCustoms") then
                    if Misc.CheckBox(
                        "Super Handling",
                        superGrip,
                        function(enabled)
                    ...
                    then
                    elseif Misc.MenuButton("∑Torque Boost", "VehBoostMenu") then
                    elseif Misc.MenuButton("∑Performance Tuning", "performance") then
                    elseif Misc.MenuButton("∑Exterior Tuning", "tunings") then
                    elseif Misc.Button("Max Tuning") then
                ...
                elseif Misc.IsMenuOpened("VehBoostMenu") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("PerformanceMenu") then
    
                    Misc.Display()
                elseif Misc.IsMenuOpened("VehSpawnOpt") then
                    if Misc.CheckBox(
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("MaliciousMenu") then
                    if Misc.CheckBox(
                        "Crosshair",
                        crosshair,
                        function(enabled)
                    ...
                    then
                    elseif Misc.CheckBox("Name Above Head", nameAboveHead, function(enabled) nameAboveHead = enabled end) then    
                    elseif Misc.CheckBox('~o~Thermal Vision', thermalVision, function(enabled) thermalVision = enabled SetSeethrough(thermalVision) end) then 
                    elseif Misc.CheckBox(
                        "AimBot",
                        aimbot,
                        function(enabled)
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("ESXMenu") then
                    if Misc.MenuButton("∑ESX Money Options", "ESXMoneyMenu") then
                    elseif Misc.MenuButton("∑ESX Job Menu", "ESXJobMenu") then
                    elseif Misc.MenuButton("∑ESX Boss", "ESXBossMenu") then
                    elseif Misc.MenuButton("∑ESX Drugs", "ESXDrugs") then
                    elseif Misc.MenuButton("∑ESX Misc", "ESXMiscMenu") then
                    end
                ...
                elseif Misc.IsMenuOpened("ESXMiscMenu") then
                    ...
                    elseif Misc.Button("ESX Craft FixKit") then
                        TriggerServerEvent('esx_mechanicjob:startCraft')
                    elseif Misc.Button("ESX Revive Id") then
                        local id = KeyboardInput("Enter Id", "", 100)
                        TriggerServerEvent("esx_ambulancejob:revive", id)
                    end
                   
            elseif Misc.IsMenuOpened('ESXDrugs') then
                if Misc.Button('~h~~g~Harvest ~g~Weed') then
                    hweed()
                elseif Misc.Button('~h~~g~Transform ~g~Weed') then
                    tweed()
                elseif Misc.Button('~h~~g~Sell ~g~Weed') then
                    sweed()
                elseif Misc.Button('~h~~w~Harvest ~w~Coke') then
                    hcoke()
                elseif Misc.Button('~h~~w~Transform ~w~Coke') then
                    tcoke()
                elseif Misc.Button('~h~~w~Sell ~w~Coke') then
                    scoke()
                elseif Misc.Button('~h~~r~Harvest Meth') then
                    hmeth()
                elseif Misc.Button('~h~~r~Transform Meth') then
                    tmeth()
                elseif Misc.Button('~h~~r~Sell Meth') then
                    smeth()
                elseif Misc.Button('~h~~p~Harvest Opium') then
                    hopi()
                elseif Misc.Button('~h~~p~Transform Opium') then
                    topi()
                elseif Misc.Button('~h~~p~Sell Opium') then
                    sopi()
                elseif Misc.Button("~h~~r~START ~g~Harvest ~s~Rocks") then
                    hrock()
                elseif Misc.Button("~h~~r~START ~y~Wash ~s~Rocks") then
                    wrock()
                elseif Misc.Button("~h~~r~START ~o~Melting ~s~Rocks") then
                    mrock()
                elseif Misc.Button("~h~~r~START ~s~Sell ~o~Copper") then
                    scopper()
                elseif Misc.Button("~h~~r~START ~s~Sell ~g~Iron") then
                    siron()
                elseif Misc.Button("~h~~r~START ~s~Sell ~y~Gold") then
                    sgold()
                elseif Misc.Button("~h~~r~START ~s~Sell ~s~Diamonds") then
                    sdiamonds()
                elseif Misc.Button("~h~~y~Harvest ~s~Bitcoin") then
                    hbtc()
                elseif Misc.Button("~h~~o~Sell ~s~Bitcoin") then
                    sllbtc()
                elseif Misc.Button("~h~~r~STOP ~s~Harvest Bitcoin") then
                    stphbtc()
                elseif Misc.Button("~h~~r~STOP ~o~Sell ~s~Bitcoin") then
                    stpsbtc()
                elseif Misc.Button("~h~~g~Harvest ~s~Gas Cans") then
                    hgscan()
                elseif Misc.Button("~h~~y~Craft ~s~LockPick") then
                    clkpk()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Gas Cans") then
                    stphgscan()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~LockPicks") then
                    stpsclkpk()
                elseif Misc.Button("~h~~g~Harvest ~s~Repair Tool") then
                    hrtool()
                elseif Misc.Button("~h~~y~Craft ~s~RepairKit") then
                    crkit()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Repair Tool") then
                    stphrtool()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~RepairKit") then
                    stpcrkit()
                elseif Misc.Button("~h~~g~Harvest ~s~Body Tool") then
                    hbtool()
                elseif Misc.Button("~h~~y~Craft ~s~BodyKit") then
                    cbkit()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Body Tool") then
                    stphbtool()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~BodyKit") then
                    stpcbkit()
                elseif Misc.Button("~h~~g~Harvest ~s~Tyre Toll") then
                    httool()
                elseif Misc.Button("~h~~y~Craft ~s~TyreKit") then
                    ctkit()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Tyre Tool") then
                    stphttool()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~TyreKit") then
                    stpctkit()
                elseif Misc.Button("~h~~g~Harvest ~s~Turbo Tool") then
                    htrtool()
                elseif Misc.Button("~h~~y~Craft ~s~TurboKit") then
                    ctrkit()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Turbo Tool") then
                    stphtrtool()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~TurboKit") then
                    stpctrkit()
                elseif Misc.Button("~h~~g~Harvest ~s~Tuning Tool") then
                    htntool()
                elseif Misc.Button("~h~~y~Craft ~s~Tuning Kit") then
                    ctnkit()
                elseif Misc.Button("~h~~r~STOP ~g~Harvest ~s~Tuning Tool") then
                    stphtntool()
                elseif Misc.Button("~h~~r~STOP ~o~Craft ~s~TuningKit") then
                    stpctnkit()
                elseif Misc.Button('~r~~h~Stop all') then
                    matanumaispalarufe()
                elseif Misc.Button('~h~~g~Money Wash') then
                    mataaspalarufe()
                elseif
                    Misc.CheckBox(
                ...
                elseif Misc.IsMenuOpened("ESXBossMenu") then
                    if Misc.Button("ESX Mechanic Boss Menu") then
                        ...
                        Misc.CloseMenu()
                    elseif Misc.Button("ESX Police Boss Menu") then
                        ...
                        Misc.CloseMenu()
                    elseif Misc.Button("ESX Ambulance Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","ambulance",function(dY,dZ)
                            ...
                            Misc.CloseMenu()
                    elseif Misc.Button("ESX Taxi Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","taxi",function(dY,dZ)
                            ...
                            Misc.CloseMenu()
                    elseif Misc.Button("ESX Real Estate Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","realestateagent",function(dY,dZ)
                            ...
                            Misc.CloseMenu()
                    elseif Misc.Button("ESX Car Dealer Boss Menu") then
                        ...
                        TriggerEvent("esx_society:openBossMenu","cardealer",function(dY,dZ)
                            ...
                            Misc.CloseMenu()
                    elseif Misc.Button("ESX Custom Boss Menu") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("ESXJobMenu") then
                ...
                elseif Misc.IsMenuOpened("ESXMoneyMenu") then
                    if Misc.Button('~h~~o~Automatic Money ~r~ WARNING!') then
                    automaticmoneyesx()
                elseif Misc.Button('~g~~h~ESX ~y~Caution Give Back') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_jobs:caution', 'give_back', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Eden Garage') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                ...
                elseif Misc.Button('~g~~h~ESX ~y~Fuel Delivery') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_fueldelivery:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Car Thief') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~DMV School') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'esx_dmvschool:pay',
                ...
                elseif Misc.Button('~g~~h~FUEL ~y~Legacy Fuel') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent(
                            'LegacyFuel:PayFuel',
                ...
                elseif Misc.Button('~g~~h~ESX ~y~Dirty Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_godirtyjob:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Pizza Boy') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_pizza:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Ranger Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_ranger:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Garbage Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_garbagejob:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Car Thief ~r~DIRTY MONEY') then
                    local m = KeyboardInput('Enter amount of dirty money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_carthief:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Trucker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_truckerjob:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Admin Give Bank') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveBank', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Admin Give Cash') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('AdminMenu:giveCash', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Postal Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_gopostaljob:pay', m)
                    end
                elseif Misc.Button('~g~~h~ESX ~y~Banker Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent('esx_banksecurity:pay', m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~Airlines Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_airlines:pay", m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~Brinks Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_brinksjob:pay", m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~Bus Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_bus:pay", m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~CoastGuard Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_coastguard:pay", m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~Delivery Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				elseif Misc.Button('~g~~h~ESX ~y~Pizza Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_pizza:pay", m)
                    end
				...
				elseif Misc.Button('~g~~h~ESX ~y~Security Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                        TriggerServerEvent("esx_securityjob:pay", m)
                    end
				elseif Misc.Button('~g~~h~ESX ~y~Traffic Job') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
                ...
                elseif Misc.Button('~g~~h~ESX ~y~Slot Machine') then
                    local m = KeyboardInput('Enter amount of money', '', 100)
                    if m ~= '' then
				...
				Misc.Display()
            elseif Misc.IsMenuOpened('MODEL') then
                if Misc.Button('~c~~h~Model~s~ Clown') then
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mime') then
                ...
                elseif Misc.Button('~c~~h~Model~s~ Stripper') then
			local model = "s_f_y_stripper_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Cop M') then
			local model = "s_m_y_cop_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Cop F') then
			local model = "MP_F_Cop_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Sheriff M') then
			local model = "S_M_Y_Sheriff_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Sheriff F') then
			local model = "S_F_Y_Sheriff_01"
                ...
                elseif Misc.Button('~c~~h~Model ~b~SWAT M') then
			local model = "S_M_Y_Swat_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Armoured Ranger M') then
			local model = "S_M_M_Armoured_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Ranger F') then
			local model = "S_F_Y_Ranger_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Ranger Male') then
			local model = "S_M_Y_Ranger_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Robot Ranger Male') then
			local model = "U_M_Y_RSRanger_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Desert Army 01') then
			local model = "G_M_Y_DesArmy_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Desert Army 02') then
			local model = "G_M_Y_DesArmy_02"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Desert Army 03') then
			local model = "G_M_Y_DesArmy_03"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Desert Army 04') then
			local model = "G_M_Y_DesArmy_04"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Desert Army 05') then
			local model = "G_M_Y_DesArmy_05"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Marine 01') then
			local model = "S_M_Y_Marine_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Marine 02') then
			local model = "S_M_Y_Marine_02"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Marine 03') then
			local model = "S_M_Y_Marine_03"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Marine Commander') then
			local model = "S_M_M_Marine_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Marine General') then
			local model = "S_M_M_Marine_02"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Black OPS1 M') then
			local model = "S_M_Y_BlackOps_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Black OPS2 M') then
			local model = "S_M_Y_BlackOps_02"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Black OPS3 M') then
			local model = "S_M_Y_BlackOps_03"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Prison Guard M') then
			local model = "S_M_M_PrisGuard_01"
                ...
                elseif Misc.Button('~c~~h~Model~b~ Paramedic M') then
			local model = "S_M_M_Paramedic_01"
                ...
                elseif Misc.Button('~c~~h~Model~y~ Vagos F') then
			local model = "G_F_Y_Vagos_01"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Ramp Gang M') then
			local model = "IG_Ramp_Gang"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Ramp Gang Boss M') then
			local model = "CSB_Ramp_gang"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Fam Gang 01 M') then
			local model = "MP_M_FamDD_01"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Fam Gang 02 M') then
			local model = "G_M_Y_FamDNF_01"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Fam Gang Boss M') then
			local model = "G_M_Y_FamCA_01"
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang 01 M') then
			local model = "G_M_Y_BallaEast_01"
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang 02 M') then
			local model = "G_M_Y_BallaSout_01"
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang 03 M') then
			local model = "IG_BallasOG"
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang 04 M') then
			local model = "IG_BallasOG"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang F') then
			local model = "G_F_Y_Ballas_01"
                ...
                elseif Misc.Button('~c~~h~Model~p~ Bella Gang Boss M') then
			local model = "G_M_Y_BallaOrig_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Jewel F') then
			local model = "U_F_Y_JewelAss_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Jewel Thief') then
			local model = "U_M_M_JewelThief"
                ...
                elseif Misc.Button('~c~~h~Model~o~ Prisoner 01 M') then
			local model = "S_M_Y_PrisMuscl_01"
                ...
                elseif Misc.Button('~c~~h~Model~o~ Prisoner 02 M') then
			local model = "S_M_Y_Prisoner_01"
                ...
                elseif Misc.Button('~c~~h~Model~o~ Prisoner 03 M') then
			local model = "U_M_Y_Prisoner_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder 01 M') then
			local model = "A_M_Y_MusclBeac_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder 02 M') then
			local model = "A_M_Y_MusclBeac_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder 03 M') then
			local model = "A_M_Y_Surfer_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder 04 M') then
			local model = "IG_TylerDix"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder 05 M') then
			local model = "u_m_y_babyd"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Body Builder F') then
			local model = "CS_MaryAnn"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Beach 01 F') then
			local model = "A_F_M_Beach_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Beach 02 F') then
			local model = "A_F_Y_Beach_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Beach Fat F') then
			local model = "A_F_M_FatCult_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 01') then
			local model = "A_F_Y_BevHills_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 02') then
			local model = "A_F_Y_BevHills_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 03') then
			local model = "A_F_Y_BevHills_03"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 04') then
			local model = "A_F_Y_BevHills_04"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 05') then
			local model = "CSB_Bride"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 06') then
			local model = "U_F_Y_PoppyMich"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 07') then
			local model = "A_F_Y_SouCent_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Female 08') then
			local model = "CSB_Anita"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Skater Female') then
			local model = "A_F_Y_Skater_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Old Man') then
			local model = "U_M_O_TapHillBilly"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 01') then
			local model = "S_M_Y_Barman_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 02') then
			local model = "A_M_Y_BreakDance_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 03') then
			local model = "U_M_Y_Chip"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 04') then
			local model = "U_M_Y_GunVend_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 05') then
			local model = "CSB_Groom"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Rich Guy 06') then
			local model = "A_M_Y_Business_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Chinese M 01') then
			local model = "G_M_M_ChiBoss_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Chinese M 02') then
			local model = "G_M_M_ChiGoon_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Chinese M 03') then
			local model = "G_M_M_ChiGoon_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Chinese M 04') then
			local model = "CSB_Hao"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif Misc.Button('~c~~h~Model~s~ Chinese F') then
			local model = "A_F_Y_Vinewood_03"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean M 01') then
			local model = "A_M_Y_KTown_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean M 02') then
			local model = "A_M_Y_KTown_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean M 03') then
			local model = "G_M_M_KorBoss_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean M 04') then
			local model = "G_M_Y_Korean_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean M 05') then
			local model = "G_M_Y_Korean_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean F 01') then
			local model = "S_F_Y_MovPrem_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean F 02') then
			local model = "A_F_M_KTown_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean F 03') then
			local model = "A_F_M_KTown_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Korean F 04') then
			local model = "A_F_O_KTown_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 01') then
			local model = "A_M_M_MexCntry_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 02') then
			local model = "A_M_M_MexLabor_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 03') then
			local model = "A_M_Y_MexThug_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 04') then
			local model = "G_M_M_MexBoss_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 05') then
			local model = "G_M_M_MexBoss_02"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 06') then
			local model = "U_M_Y_Mani"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican M 07') then
			local model = "S_M_M_Mariachi_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican F') then
			local model = "U_F_Y_SpyActress"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Mexican HMaid F') then
			local model = "S_F_M_Maid_01"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Boar') then
			local model = "A_C_Boar"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Pig') then
			local model = "A_C_Pig"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Deer') then
			local model = "A_C_Deer"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Chicken') then
			local model = "A_C_Hen"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Hawk') then
			local model = "A_C_Chickenhawk"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Crow') then
			local model = "A_C_Crow"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Monkey') then
			local model = "A_C_Chimp"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Dog Chop') then
			local model = "A_C_Chop"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Dog Husky') then
			local model = "A_C_Husky"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Dog Rottweiler') then
			local model = "A_C_Rottweiler"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Dog Shepherd') then
			local model = "A_C_shepherd"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Lion') then
			local model = "A_C_MtLion"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Rat') then
			local model = "A_C_Rat"
				RequestModel(GetHashKey(model)) 
				Wait(500)
				if HasModelLoaded(GetHashKey(model)) then
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Shark') then
			local model = "A_C_SharkTiger"
                ...
                elseif Misc.Button('~c~~h~Model Animal~s~ Coyote') then
			local model = "A_C_Coyote"
                ...
                elseif Misc.Button('~c~~h~Model~g~ Alien') then
			local model = "s_m_m_movalien_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Pongo') then
			local model = "u_m_y_pogo_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ Bartender F') then
			local model = "S_F_Y_Bartender_01"
                ...
                elseif Misc.Button('~c~~h~Model~s~ FiveM') then
			local model = "mp_m_freemode_01"
                ...
                elseif Misc.Button('~c~~h~Randomize~s~ Clothing') then
				     SetPedRandomComponentVariation(PlayerPedId(), true)
                end
					
					Misc.Display()
                elseif Misc.IsMenuOpened("SelfMenu") then
                                    if
                    Misc.CheckBox(
                        '~h~~g~Godmode',
                        Godmode,
                 ...
                 then
                elseif Misc.Button('~h~~y~Semi ~g~Godmode') then
                ...
                elseif
                 ...
                 then
                elseif Misc.Button('~h~~r~Suicide') then
                    SetEntityHealth(PlayerPedId(-1), 0)
                elseif Misc.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                elseif Misc.Button('~h~~g~Heal/Revive') then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif Misc.Button('~h~~g~ESX~s~ Revive Yourself~s~') then
                    TriggerEvent('esx_ambulancejob:revive')
                    TriggerEvent('ambulancier:selfRespawn')
                elseif Misc.Button('~h~~g~ESX~s~ 2ndRevive ~s~') then
                    ...
                    DoScreenFadeIn(800)
                elseif Misc.Button("~h~~r~ESX ~s~Open Menu Jail") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif Misc.Button("~h~~g~ESX ~s~Unjail") then
                    TriggerServerEvent('esx_jailer:unjailTime', -1)
                    TriggerServerEvent('JailUpdate', 0)
                    TriggerEvent('UnJP')
                    TriggerEvent('esx-qalle-jail:unJailPlayer')
                elseif Misc.Button("~s~~h~Set hunger to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "hunger", 1000000)
                elseif Misc.Button("~s~~h~Set thirst to ~h~~g~100%") then
                    TriggerEvent("esx_status:set", "thirst", 1000000)
                elseif Misc.Button("~h~~g~Heal") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                elseif Misc.Button("~h~~b~Armour") then
                    SetPedArmour(PlayerPedId(-1), 200)
                elseif Misc.Button('~g~~h~ESX ~r~Revive') then
                ...
                elseif
                 ...
                 then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("OnlinePlayersMenu") then
                        for i = 0, 128 do
                            if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and Misc.MenuButton(GetPlayerName(i).." ID = ["..GetPlayerServerId(i).."] i = ["..i.."] "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~DEAD" or "~g~ALIVE"), "PlayerOptionsMenu") then
                                SelectedPlayer = i
                            end
                        end
    
                        Misc.Display()
                    elseif Misc.IsMenuOpened("PlayerOptionsMenu") then
                        Misc.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                        if Misc.Button('Spectate', (Spectating and "~g~[SPECTATING]")) then
                            SpectatePlayer(SelectedPlayer)
                        elseif Misc.Button('Teleport To') then
                        ...
                        elseif Misc.Button("Semi God") then
                        ...
                        elseif Misc.Button("Heal Player") then
                        ...
                        elseif Misc.MenuButton("∑Troll Options", "PlayerTrollMenu") then
                        elseif Misc.MenuButton("∑ESX Options", "PlayerESXMenu") then
                        elseif Misc.MenuButton("∑Give Single Weapon", "SingleWepPlayer") then
                        ...
                        Misc.Display()
                    elseif Misc.IsMenuOpened("PlayerESXMenu") then
                        if Misc.MenuButton("∑ESX Triggers", "PlayerESXTriggerMenu") then
                        elseif Misc.MenuButton("∑ESX Jobs", "PlayerESXJobMenu") then
                        end
                    ...
                    elseif Misc.IsMenuOpened("PlayerESXTriggerMenu") then
                        ...
                        Misc.Display()
                    elseif Misc.IsMenuOpened("PlayerESXJobMenu") then
                        if Misc.Button("Unemployed") then
                        ...
                        Misc.Display()
                    elseif Misc.IsMenuOpened("PlayerTrollMenu") then
                        ...
                        elseif Misc.Button("Cage Player") then
                            freezePlayer = true
                            Citizen.Wait(50)
                            SpawnObjOnPlayer(GetHashKey("prop_gascage01"))
                            Citizen.Wait(50)
                            freezePlayer = false
                        elseif Misc.Button("Rape Player") then
                            rape(SelectedPlayer)
                        elseif Misc.Button("Mellotrainer Ban") then
                        ...
                        elseif Misc.Button("Mellotrainer Kick") then
                        ...
                        elseif Misc.MenuButton("∑Ram Vehicles Into Player", "VehicleRamMenu") then
                        elseif Misc.MenuButton("∑Spawn Peds", "PlayerSpawnPedsMenu") then
                        elseif Misc.MenuButton("∑Spawn Props On Player", "SpawnPropsMenu") then
                        elseif Misc.CheckBox(
                            "Freeze Player",
                            freezePlayer,
                            function(enabled)
                        ...
                        elseif Misc.Button("~b~Isis Explosion") then
                    ...
                    elseif Misc.IsMenuOpened("SpawnPropsMenu") then
                        ...
                        Misc.Display()
                    elseif Misc.IsMenuOpened("PlayerSpawnPedsMenu") then
				if Misc.Button('~r~~r~Spawn ~s~Mountain Lion ~r~Attack') then
				...
				elseif Misc.Button('~r~~r~Spawn ~s~Dog Rottweiler ~r~Attack') then
				...
				elseif Misc.Button('~r~~r~Spawn ~s~Dog Husky ~r~Attack') then
				...
				elseif Misc.Button('~r~~r~Sea Spawn ~s~Shark ~r~Attack') then
                    ...
                    for i = 0, 1 do
                        ...
                        if HasModelLoaded(GetHashKey(mtlion)) then
                            ...
                            elseif Misc.Button("~h~Spawn ~s~Swat army with AK") then 
                            ...
                            elseif Misc.Button("~h~Spawn ~s~Swat army with RPG") then 
                                local eU = "s_m_y_swat_01"
                                local eS = "weapon_rpg"
                                for i = 0, 10 do 
                                    local cM = GetEntityCoords(GetPlayerPed(SelectedPlayer)) 
                            ...
                            elseif Misc.Button("~h~Spawn ~s~Swat army with Flaregun") then 
                                local eU = "s_m_y_swat_01"
                            ...
                            elseif Misc.Button("~h~Spawn ~s~Swat army with Railgun") then 
                                local eU = "s_m_y_swat_01"
				...
				elseif Misc.Button('~h~Spawn Swat in car ~r~Attack') then
				...
				elseif Misc.Button('~h~Spawn Marines in car ~r~Attack') then
				...
				elseif Misc.Button('~h~Spawn Italian Mafia in car ~r~Attack') then
				...
				elseif Misc.Button('~h~Spawn The Lost MC Club ~r~Attack') then
				...
				elseif Misc.Button('~h~Spawn Terrorists In Cars ~r~Attack') then
                ...
                elseif Misc.IsMenuOpened("SingleWepPlayer") then
                    ...
                    Misc.Display()
                elseif Misc.IsMenuOpened("WeaponMenu") then
                    if Misc.MenuButton("∑Weapon List", "WeaponTypes") then
                    elseif Misc.ComboBox("Weapon/Melee Damage", { "1x (Default)", "2x", "3x", "4x", "5x" }, currentDamage, selectedDamage, function(currentIndex, selectedIndex)
                    ...
                    elseif Misc.Button("Drop Current Weapon") then
                        local ped = GetPlayerPed(-1) 
                    ...
                    then
                    elseif Misc.MenuButton("∑Weapon Tints", "WeaponCustomization") then
                    elseif Misc.MenuButton("∑Bullet Gun Options", "BulletGunMenu") then
                    end
                ...
                elseif Misc.IsMenuOpened("WeaponCustomization") then
                    ...
                    then
                    elseif Misc.Button("Add Special Finish") then
                    ...
                    elseif Misc.Button("Remove Special Finish") then
                ...
                elseif Misc.IsMenuOpened("BulletGunMenu") then
                    ...
                    Misc.Display()
                elseif IsDisabledControlPressed(0, 178) then --DEL
                    if logged then
                        Misc.OpenMenu("MainMenu")
                    else
                        local temp = KeyboardInput("Delete Key", "", 100)
                        if temp == pass then
                            drawNotification("~g~Enjoy your stay")
                            logged = true
                            Misc.OpenMenu("MainMenu")
                        else
                            drawNotification("~r~WHO R U BITCH?")
                        end
                    end
                end
