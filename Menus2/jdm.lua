...
local function H(I)
    if LynxEvo.debug then
        Citizen.Trace('By : 9moona' .. tostring(I))
    end
end
            ...
            if fuckallcars then
                for ay in EnumerateVehicles() do
                    if not IsPedAPlayer(GetPedInVehicleSeat(ay, -1)) then
                        ...
                        SetVehicleNumberPlateText(ay, 'Double Ds')
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('LynxX', 'By : 9moona')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('LynxX') then
                ...
                elseif LynxEvo.MenuButton('~h~~p~Double Ds', 'crds') then
                end
                LynxEvo.Display()
            ...
            elseif LynxEvo.IsMenuOpened('crds') then
                if LynxEvo.Button('~h~~p~#~s~ Double Ds~r~.pl ~p~Krol') then
                    av('~h~~o~essa~s~.', false)
                    av('htfu?', false)
                    av('jol mnay', false)
                elseif LynxEvo.Button('~h~~p~#~s~ Double Ds3 ~p~DEV') then
                elseif LynxEvo.Button('~h~~p~#~s~ Double Ds ~p~DEV') then
                end
                LynxEvo.Display()
