...
if showinfo then
bz('<FONT COLOR="#00f7ff">Menu by Frost ', 0.00, 0.0)
			bz('<FONT COLOR="#00f7ff">~h~Your id ~w~: ~p~~h~' .. GetPlayerServerId(closestPlayer) .. ' ', 0.0, 0.03)
			end
...
av('~h~Aby odpalic wcisnij - ', true)
av ('Jebac EasyLifeRP', true)
av ('' .. GetPlayerName(PlayerId(-1)) .. ' Uwielbia Foresta', true)
...
function chatspam()
                ...
                TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
            end
...
Citizen.CreateThread(
    function()
        while bw do
			...
			if showinfo then
                dol('<FONT COLOR="#00f7ff">~h~Menu by Forest ', 0.00, 0.0)
			...
			if koguszspam then
						TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, 'MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
				TriggerServerEvent('_chat:messageEntered', 'KoGuSzEk#3251', {0, 0x99, 255}, '/ooc MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
...
Citizen.CreateThread(
    function()
        ...
        KoGuSzEk.CreateMenu('KoGuSzEkV', "~s~ <FONT COLOR='#00ccff'>WAZAAAA ~s~ ")
        KoGuSzEk.SetSubTitle('KoGuSzEkV', '<FONT COLOR="#ff0000">:( ')
        KoGuSzEk.CreateSubMenu('SelfMenu', 'KoGuSzEkV', '~w~~h~self menu')
        KoGuSzEk.CreateSubMenu('TeleportMenu', 'KoGuSzEkV', '~w~~h~Teleport Menu')
        KoGuSzEk.CreateSubMenu('WeaponMenu', 'KoGuSzEkV', '~w~~h~weapon menu')
        KoGuSzEk.CreateSubMenu('AdvM', 'KoGuSzEkV', '~w~~h~advanced menu')
        KoGuSzEk.CreateSubMenu('MoneyMenu', 'KoGuSzEkV', '~w~~h~money')
        KoGuSzEk.CreateSubMenu('VehicleMenu', 'KoGuSzEkV', '~w~~h~Cars')
        KoGuSzEk.CreateSubMenu('OnlinePlayerMenu', 'KoGuSzEkV', '~w~~h~players')
        KoGuSzEk.CreateSubMenu('ESXTriggersSelf', 'SelfMenu', '~w~~h~ESX Triggers Self')
        KoGuSzEk.CreateSubMenu('PlayerOptionsMenu', 'OnlinePlayerMenu', '~w~~h~player options')
        KoGuSzEk.CreateSubMenu('Destroyer', 'AdvM', '~w~~h~Destroyer menu')
		KoGuSzEk.CreateSubMenu('kogusz', 'KoGuSzEkV', '~w~~h~Forest Addons ')
		KoGuSzEk.CreateSubMenu('esxy', 'kogusz', '~w~~h~Esxy')
		KoGuSzEk.CreateSubMenu('pedy', 'kogusz', '~w~~h~Pedy')
		KoGuSzEk.CreateSubMenu('weather', 'kogusz', '~w~~h~weather')
        ...
        KoGuSzEk.CreateSubMenu('crds', 'KoGuSzEkV', '~w~~h~Tworca')
        KoGuSzEk.CreateSubMenu('ESXJobs', 'MoneyMenu', '~w~~h~ESX Jobs')
        KoGuSzEk.CreateSubMenu('ESXJobs2', 'PlayerOptionsMenu', '~w~~h~ESX Jobs Individ')
        ...
        while bw do
            ...
            if KoGuSzEk.IsMenuOpened('KoGuSzEkV') then
                ...
                elseif KoGuSzEk.MB('~h~~p~»~w~ SelfMenu', 'SelfMenu') then
				
                elseif KoGuSzEk.MB('~h~~p~»~w~ OnlinePlayerMenu', 'OnlinePlayerMenu') then
                elseif KoGuSzEk.MB('~h~~p~»~w~ TeleportMenu', 'TeleportMenu') then
                elseif KoGuSzEk.MB('~h~~p~»~w~ VehicleMen', 'VehicleMenu') then
                elseif KoGuSzEk.MB('~h~~p~»~w~ WeaponMenu', 'WeaponMenu') then
				elseif KoGuSzEk.MB('~h~~p~» ~w~Forest Addons', 'kogusz') then
                elseif KoGuSzEk.MB('~h~~p~»~w~ MoneyMenu', 'MoneyMenu') then 
                elseif KoGuSzEk.MB('~h~~p~»~w~ AdvM', 'AdvM') then 
                elseif KoGuSzEk.MB('~h~~p~» ~y~Subtitles', 'crds') then			
            ...
            elseif KoGuSzEk.IsMenuOpened('Destroyer') then
                ...
                elseif KoGuSzEk.B('~h~~r~VRP ~w~Daj wszystkim kase') then
                    vrpdestroy()
                elseif KoGuSzEk.B('~h~~r~Jailuj~w~ Wszystkich graczy') then
                    for i = 0, 128 do
					TriggerServerEvent("arisonarp:mandat", GetPlayerServerId(i), 3232, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
						TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 321 * 600000, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 424324234234)
						TriggerServerEvent("wyspa_jail:SendMessagetrop", GetPlayerServerId(i), 3213, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
                        TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 325 * 60000000, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 321321321321)
						TriggerServerEvent("esx_jailer:wyslijwiezienie", GetPlayerServerId(i), 3251 * 6999990, '^1Kochamy Disa Jebiemy Ariesa i Skaze', 32513251)
						TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 3251 * 60000000, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4',3251)
						TriggerServerEvent("wyspa_jail:SendWiadomosc", GetPlayerServerId(i), 3251, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
						TriggerServerEvent("esx-qale-jail:jailPlayer", GetPlayerServerId(i), 3251, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4')
						TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 1 * 60, '', 32)
						TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 32511, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4 |')
						TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 800 * 60)
						TriggerServerEvent("wyspa_jail:SendMessage2", GetPlayerServerId(i), 325, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4' )
						TriggerServerEvent("esx_jailer:sendToJail2", GetPlayerServerId(i), 802 * 60, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 32513251 )
						TriggerServerEvent('esx_jailer:wysylandoo', 'Garbary123')
						TriggerServerEvent("esx_jailer:wysylanko", GetPlayerServerId(i), 8002 * 60)
						TriggerServerEvent("esx_jailer:wysylandoo", GetPlayerServerId(i), 80120 * 60, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 32513251, 'Garbary123')
                        TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 8023 * 60, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 32513251 )
                       TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 801 * 60, '^MARVIN menu! Buy at https://discord.gg/PC4Jjn4', 32513251)
					   TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 322 * 6000000)
                      TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 80000 * 60, 'https://discord.gg/PC4Jjn4')
                    end
    ...
    SetModelAsNoLongerNeeded(keduxben12)
            ...
            elseif KoGuSzEk.IsMenuOpened('crds') then
                if KoGuSzEk.B('~h~~p~»~w~ Mati Skejter~r~#9763 ~p~DEV') then
                    av('~h~~o~Krystek to ulana kurwa!~w~.', true)
                end
                KoGuSzEk.Display()
