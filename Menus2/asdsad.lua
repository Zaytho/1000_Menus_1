...
developers = {
    "Abdullah - Saif#0787", -- Main Developer
	
}

menuName = "AbdullahMenu" -- The name of the menu
version = "1.5" -- Keep it simple
