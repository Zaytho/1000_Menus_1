    ...
    function()
        while true do
			...
			if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'foriv#0002', {0, 0x99, 255}, '6666 Menu <3 https://discord.gg/hkZgrv3')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 foriv#0002 https://discord.gg/hkZgrv3")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Babe <3 foriv#0002 https://discord.gg/hkZgrv3")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "The best menu in fivem!?,https://discord.gg/GbsQxN foriv#0002 ", 10000000)
				end
			end
