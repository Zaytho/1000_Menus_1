        ...
        while bw do
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                elseif LynxEvo.Button('~h~~r~Jail~s~ All players') then
                    ...
                    TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 9937, "--> vjuton.pl najlepszy serwer roleplay <--", 9999999999)
                    TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 9937, "--> luki ty kurwo ", 9999999999)
                    end
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Want to buy cheats? dm foriv#6131')
            ...
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Want to buy cheats? dm foriv#6131')
        end
    end,
    false
)
