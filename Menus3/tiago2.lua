...
function RapeAllFunc()
    for bs=0,9 do
        TriggerServerEvent("_chat:messageEntered","gkkss#3491",{141,211,255},"QUERES HACK COMO ESTE? VENDO SOLO POR 5USD DISC gkkss#3491")
    end
end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","gkkss#3491",{141,211,255},"VENDO CHEATS DISCORD 5 USD :gkkss#3491")
        end
	...
	if sall then
			...
			if spam then
                for i = 0, 128 do
                    ...
                    'DISCORD: gkkss#3491',
                    {0, 0x99, 255},
                    'QUERES HACK COMO ESTE? VENDO SOLO POR 5USD DISC gkkss#3491'
                )
                TriggerServerEvent('_chat:messageEntered', 'gkkss#3491', {0, 0x99, 255}, 'QUERES HACK COMO ESTE? VENDO SOLO POR 5USD DISC gkkss#3491')
                end
			end
