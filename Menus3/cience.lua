...
local menus = { }
local keys = { up = 172, down = 173	, left = 174, right = 175, select = 215, back = 178 }
local optionCount = 0
...
function RapeAllFunc()
    for bs=0,9 do 
        TriggerServerEvent("","^1Cience",{141,211,255},"You got raped by Cience https://discord.gg/VTaeCZm")
    end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do 
            TriggerServerEvent("","^1Cience",{141,211,255},"Cience Menu By: Mestari Halla-aho#7167 https://discord.gg/VTaeCZm")
        end
    ...
    function()
        ...
        while Enabled do
            ...
            elseif Cience.IsMenuOpened("TrollMenu") then
                ...
                elseif Cience.Button("Fake Message") then
                    ...
                    if da then 
                        ...
                        if ck then 
                            TriggerServerEvent('',da,{0,0x99,255},ck)
                        end 
                    end 
            ...
            elseif Cience.IsMenuOpened("OnlinePlayersMenu") then
                ...
                elseif Cience.IsMenuOpened("PlayerTrollMenu") then
                    if Cience.Button ("Fake Chat Message") then 
                        ...
                        if cX then 
                            TriggerServerEvent('',cY,{0,0x99,255},cX)
                        end 
            ...
            if VehSpeed and IsPedInAnyVehicle(PlayerPedId(-1), true) then
                ...
                Cience.Display()
            elseif IsDisabledControlPressed(0, 110) then
                if logged then
