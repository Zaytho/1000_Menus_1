...
drawNotification('~h~~b~b00mek#0001')
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.SetSubTitle('\76\121\110\120\88', 'b00mek#0001')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("<FONT COLOR='#22ff40'>LIND DO KUPNA CHEATOW W OPISIE!")
                if
                    Lynx8.MenuButton(
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\67\114\101\100\105\116\115') then
                if Lynx8.Button('~h~~p~->~s~ b00mek~b~#~b~0001') then
                    drawNotification("~h~<FONT COLOR='#ff22f4'>O siema!~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Fajne czitsyyyy~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Wez zniszcz serwer~s~.")
                end
                Lynx8.Display()
