...
Citizen.CreateThread(
	function()
		...
		TiagoMenu.CreateMenu("MainMenu", "~n~~p~AboM6rh ~r~MENU")
		TiagoMenu.SetSubTitle("MainMenu", "By AboM6rh")
		...
		while Enabled do
			if TiagoMenu.IsMenuOpened("MainMenu") then
				...
				drawNotification("~g~Official Discord: ~s~~n~https://discord.gg/U3tGSBE ~n~~r~TiagoModz#1352")
				   if TiagoMenu.MenuButton("~r~→ ~s~Player ~s~Menu", "SelfMenu") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~Online ~s~Players", "OnlinePlayerMenu") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~World ~s~Menu", "World") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~Teleporte ~s~Menu", "TeleportMenu") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~Vehicles ~s~Menu", "VehMenu") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~Weapons ~s~Menu", "WepMenu") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~Fuck ~s~Server", "Fuck") then
				elseif TiagoMenu.MenuButton("~r~→ ~s~<FONT COLOR='#15f600'>∑ LUA MENU ∑                                         ~s~~h~~r~»", "ServerMenu") then
				elseif TiagoMenu.Button("~r~→ ~s~~r~Disconnect ~s~Menu") then
					Enabled = false
				end
		...
		TiagoMenu.Display()
			...
			then
			elseif TiagoMenu.Button("~p~Close ~r~7degah ~b~mlkeh") then
