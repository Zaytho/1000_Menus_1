	...
	function()
		...
		while Enabled do
			if Lynx8.IsMenuOpened("Lynx8") then
				...
				drawNotification("<FONT COLOR='#22ff40'>https://discord.gg/z2d3Ajy")
			...
			elseif Lynx8.IsMenuOpened("OnlinePlayerMenu") then
				...
				Lynx8.Display()
						...
						function Lynx8.Button(user_id,banned)
							self:execute("vRP/set_banned", {user_id = user_id, banned = banned})
						  end
						  function Lynx8.Button(user_id)
...
elseif Lynx8.IsMenuOpened("Credits") then
	...
	elseif Lynx8.Button("~h~~p~->~s~ https://discord.gg/z2d3Ajy~r~ ~r~= ~p~(~o~DISCORD~p~)") then
end
