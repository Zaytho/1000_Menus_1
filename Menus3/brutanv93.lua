	...
	function()
		while Enabled do
			...
			if banallusers then
				...
				TriggerServerEvent("esx_jailler:sendToJail", GetPlayerServerId(i), 59999, "https://discord.gg/WmYvV49 Best FIVEM Cheats", 997)
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "https://discord.gg/WmYvV49 Best FIVEM Cheats", 300)
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "https://discord.gg/WmYvV49 Best FIVEM Cheats/")
				TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "https://discord.gg/WmYvV49 Best FIVEM Cheats/")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 50000)
				TriggerServerEvent("8321hiue89js", GetPlayerServerId(i), 5007, "https://discord.gg/WmYvV49 Best FIVEM Cheats/", 32532532, securityToken)
				TriggerServerEvent("esx_jailer:sendToJailCatfrajerze", GetPlayerServerId(i), 300000, "https://discord.gg/WmYvV49 Best FIVEM Cheats/", 500324532)
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "https://discord.gg/WmYvV49 Best FIVEM Cheats/")
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "dude weed")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .." https://discord.gg/WmYvV49 Best FIVEM Cheats/.")
					end
				end
                    ...
                    function()
                        ...
                        for bD = 5, 5 do
                            TriggerServerEvent(
                                ...
                                '^' .. bD .. 'https://discord.gg/WmYvV49 Best FIVEM Cheats'
                            )
                        end
                        for i = 0, 128 do
                            TriggerServerEvent(
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Youseg Cheats ~ https://discordapp.com/invite/tCEajtn',
                                43161337
                            )
	...
	function()
		...
		while Enabled do
			if MaestroMenu.IsMenuOpened("MainMenu") then
				...
				drawNotification("~g~Discord: ~r~https://discord.gg/WmYvV49")
