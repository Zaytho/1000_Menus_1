...
theme = "basic" -- Feel free to make your own
...
menuKeybind = "F10" -- Key to open the menu. Supported ones are shown below - Find new ones at https://docs.fivem.net/game-references/controls/
noclipKeybind = "F0" -- Key to toggle Noclip
