...
local function wait(self)
	...
	if not rets then
		if self.r then
			...
			error("^1LUX ERROR : async->wait() = nil | contact https://discord.gg/qJMQMjW")
		end
	end
...
local function drawFooter()
	if menus[currentMenu] then
		...
		if welcomeMsg then
			welcomeMsg = false
			LuxUI.SendNotification({text = "If you experience any issues, please contact https://discord.gg/qJMQMj on Discord!", type = "info"})
		end
	end
end
