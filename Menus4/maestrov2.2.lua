...
HoaxMenu = NativeUI.CreateMenu("Maestro v2.2", "¦ ~b~Hacking System!", X, Y)
    ...
    Citizen.CreateThread(function()
        while ShowMenu do
            ...
            if ShowMenu and IsPedInAnyVehicle(GetPlayerPed(-1), 0) then
                local carModel = ""..GetDisplayName(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0)))
