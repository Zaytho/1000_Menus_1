...
function RapeAllFunc()
    for bs=0,9 do 
        TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"You got communised by Soviet Bear ")
    end
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do 
            TriggerServerEvent("_chat:messageEntered","^1Cat",{141,211,255},"Soviet H4X Modified By: Flaxen#7016")
        end
...
Citizen.CreateThread(
    function()
        ...
        Cience.CreateMenu("MainMenu", "Soviet H4X By Flaxen")
        ...
        while Enabled do
            if Cience.IsMenuOpened("MainMenu") then
                drawNotification("~h~~r~Soviet H4X ∑")
                drawNotification("~h~~r~Modified by The Flaxen#7016 ;)")
