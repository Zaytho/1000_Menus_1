        ...
        while bm do
            ...
            if chatspam then
                TriggerServerEvent(
                    ...
                    'Saykaa#6087-Fuuck',
                    {0, 0x99, 255},
                    '/ooc Add me Saykaa#6087'
                )
                TriggerServerEvent('_chat:messageEntered', 'Saykaa#6087-Mllll', {0, 0x99, 255}, 'Add me Saykaa#6087')
            end
            ...
            if BananaBoom then
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Saykaa#6087-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me Saykaa#6087'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Saykaa#6087-BANANAPARTY',
                            {0, 0x99, 255},
                            'Yo add me Saykaa#6087'
                        )
                    end
                end
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Saykaa')
        Lynx8.SetSubTitle('\76\121\110\120\88', 'iZeiKo Community + 10')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("~h~Saykaa <FONT COLOR='#FF2323'>.")
                drawNotification("<FONT COLOR='#22ff40'>Modified By iZeiKo👺🤯#6666")
                if
                    Lynx8.MenuButton(
            ...
            elseif Lynx8.IsMenuOpened('\84\114\111\108\108\109\101\110\117') then
                ...
                elseif Lynx8.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Saykaa#6087-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc Yo add me Saykaa#6087 >:D Player Crash Attempt'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Saykaa#6087-CrashAtt',
                            {0, 0x99, 255},
                            'Yo add me Saykaa#6087 >:D Player Crash Attempt'
                        )
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\67\114\101\100\105\116\115') then
                ...
                elseif Lynx8.Button('~h~~p~->~s~ Saykaa#6087~r~#~r~1337 ~p~(~o~DEV~p~)') then
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Ajoute Moi!~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Pour Acheter! ~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>https://discord.gg/Z4w4J6v qweqwe~s~.")
                elseif Lynx8.Button('~h~~p~->~s~ iZeiKo👺🤯#6666~r~#~r~7983 ~p~(~o~DEV+SUPPORT~p~)') then
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Ajoute Moi!~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>Pour Acheter <3 ~s~.")
                    drawNotification("~h~<FONT COLOR='#ff22f4'>https://discord.gg/WUxumbv qweqwe~s~.")
