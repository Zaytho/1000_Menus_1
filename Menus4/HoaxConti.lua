    ...
    local function AddVehicleOptionsMenu(menu)
        ...
        stealVehicle.Activated = function(ParentMenu, SelectedItem)
            if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                    ...
                    if SpawnedVehicleProperties then
                        FiveM.TriggerCustomEvent(true, 'esx_vehicleshop:setVehicleOwnedtozPlayerId', GetPlayerServerId(PlayerId()), SpawnedVehicleProperties, SpawnedVehicleModelName, SpawnedVehicleModel, false)
