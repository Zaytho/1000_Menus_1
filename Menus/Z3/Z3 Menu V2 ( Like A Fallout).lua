...
CreateThread(function()
    ...
    function FM.FreeCam:Spawner(where, heading, type)
        ...
        FM.Painter:DrawText("~w~[~y~Z3 Menu~w~] " .. (name or "?"), 4, false, FM:ScrW() - 360 - 21 - offX, 21, 0.35, 255, 255, 255, 255)
        local sY = 30
        local max_opts = 30
    ...
    function FM.FreeCam:DrawMode()
        ...
        FM:ScreenText("~w~[~y~Z3 Menu~w~] Freecam Mode: ~y~" .. name, 4, 1.0, 0.5, 0.97, 0.35, 255, 255, 255, 225)
    end
    ...
    function FM:DrawNotifications()
        ...
        self.Painter:DrawText("~w~[~y~Z3 Menu~w~] Notifications", 4, false, n_x, n_y, 0.35, 255, 255, 255, dict.math.ceil(notif_alpha + 55))
