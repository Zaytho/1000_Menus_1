...
local function wBQ8ncN2OyoKWmCo(Tlyrrz46tw)
    if Emperor.debug then
        Citizen.Trace("[Emperor] " .. tostring(Tlyrrz46tw) .. ".")
    end
end
...
function Emperor.CreateSubMenu(o5_Y4K3Wo8umqV9Jq, K_UkYz2xIa, S30rdV)
    if jwZvXv7xDjl3iWV[K_UkYz2xIa] then
        Emepror.CreateMenu(o5_Y4K3Wo8umqV9Jq, jwZvXv7xDjl3iWV[K_UkYz2xIa].title)
        if S30rdV then
...
function Emperor.CurrentMenu()
    return j0P1aYqgapaJmkYWlSEjf
end
function Emperor.OpenMenu(Wy2HuhjnUT)
...
function Emperor.IsMenuOpened(lz9JKSXu5)
    return nwxCxw1(lz9JKSXu5)
end
function Emperor.IsAnyMenuOpened()
...
function Emperor.IsMenuAboutToBeClosed()
    if jwZvXv7xDjl3iWV[j0P1aYqgapaJmkYWlSEjf] then
...
function Emperor.Button(ku9eSQBeIjpD5OSIkEo, k59Afs, oMOmUf0EItEu1d)
...
function Emperor.CheckboxButton(ljn2uEed0X, TRO)
...
function Emperor.Button2(W, oE9cO8vpv, c)
    local lRCYjuz7bRV = W
    if oE9cO8vpv then
...
function Emperor.MenuButton(hDOYO949Fc, mnVwL3mcwGAyE, FizEWTAQ, sLhJB6ohtIp)
    if jwZvXv7xDjl3iWV[mnVwL3mcwGAyE] then
        if Emperor.Button2(hDOYO949Fc, FizEWTAQ, sLhJB6ohtIp) then
            RAmmfIbUBx(j0P1aYqgapaJmkYWlSEjf, false)
...
function Emperor.CheckBox(xD5CgeU35u, bUg2BlhBw, ziLpaLqbs1dFH)
    if Emperor.CheckboxButton(xD5CgeU35u, bUg2BlhBw) then
...
function Emperor.ComboBoxSlider(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, iINeVnHA, w0EClroT29grzQ0E_I, WuP)
    ...
    if Emperor.Button3(gOMf0jixx786jq6klHUCm, l8P5V6w3Li12FpYzFLt, njkLWKLLSIthhKUd5NsAs, iINeVnHA) then
...
function Emperor.Button3(wwMtNhL, bkCC_, aym, l2CcmmxUJy)
...
function Emperor.SetMenuWidth(FqbKu5KeWxhMu8N8, fF)
    XO8g1Wb5PogWmMOsj4(FqbKu5KeWxhMu8N8, "width", fF)
end
function Emperor.SetMenuX(Ml6, w1shwzn8WML)
    XO8g1Wb5PogWmMOsj4(Ml6, "x", w1shwzn8WML)
end
function Emperor.SetMenuY(hoQ0HGXgRiIhd6JbbL0LL, vhzQtrri2a8NXR00xFGN)
    XO8g1Wb5PogWmMOsj4(hoQ0HGXgRiIhd6JbbL0LL, "y", vhzQtrri2a8NXR00xFGN)
end
function Emperor.SetMenuMaxOptionCountOnScreen(DKcQHP, qKgxysukgKx4Vb5lYqUx8)
    XO8g1Wb5PogWmMOsj4(DKcQHP, "maxOptionCount", qKgxysukgKx4Vb5lYqUx8)
end
function Emperor.SetTitle(UqNF1, UpCQllq0jeGlXokp6xss1)
    XO8g1Wb5PogWmMOsj4(UqNF1, "title", UpCQllq0jeGlXokp6xss1)
end
function Emperor.SetTitleColor(tULkl49rjy, mQILWyLbfvqZI, fEocg0k7gq, muFd3KRBBrBEm, UJkWFtONNKE_aLyvF)
    XO8g1Wb5PogWmMOsj4(
        tULkl49rjy,
        "titleColor",
        {
...
function Emperor.SetTitleBackgroundColor(
...
function Emperor.SetTitleBackgroundSprite(nlsLV4yw5e4YYOG_PzEb, lxOkm, Pae5)
    RequestStreamedTextureDict(lxOkm)
    XO8g1Wb5PogWmMOsj4(nlsLV4yw5e4YYOG_PzEb, "titleBackgroundSprite", {dict = lxOkm, name = Pae5})
end
function Emperor.SetTitleBackgroundSpriteNil(_Atq4VCp)
    XO8g1Wb5PogWmMOsj4(_Atq4VCp, "titleBackgroundSprite", nil)
end
function Emperor.SetSubTitle(TRNvg0, t1eB3iqrRPzszInjmNPk)
    XO8g1Wb5PogWmMOsj4(TRNvg0, "subTitle", t1eB3iqrRPzszInjmNPk)
end
function Emperor.SetMenuBackgroundColor(ACvgXgAvTupM1gqF41, P3cpQ8LTcG0G, GJ2HaoQiLCe, gV0bS, wTPil)
    XO8g1Wb5PogWmMOsj4(
        ACvgXgAvTupM1gqF41,
        "menuBackgroundColor",
        {
...
function Emperor.SetMenuSubTitleBackgroundColor(IwF, kQC8, LZlongbMs8yG, C1CiCIhhjVwo83n4zyS, UOCa3yWuuJnK23h9a0)
    XO8g1Wb5PogWmMOsj4(
        IwF,
        "subTitleBackgroundColor",
        {
...
function Emperor.SetMenuTextColor(ar2c, W_3O6_b3, MoSP696sUotNv, USQCshqEJw, oKhHjxk)
    XO8g1Wb5PogWmMOsj4(
        ar2c,
        "menuTextColor",
        {
...
function Emperor.SetMenuSubTextColor(P7oINxXfnDPl5m, CkUxXge7i4, UirrSST0Jjmy8, t3E3pzso8ojMCpDjBv, xy36PhzoHlvo1H)
    XO8g1Wb5PogWmMOsj4(
        P7oINxXfnDPl5m,
        "menuSubTextColor",
        {
...
function Emperor.SetMenuFocusTextColor(IWkRdzeDQLXGUBli, iw0xYMwyEUhZ4C, uhhYDRigRRKaJNF3af, Y0WDIf90Qh, n2XImUrRcF)
    XO8g1Wb5PogWmMOsj4(
        IWkRdzeDQLXGUBli,
        "menuFocusTextColor",
        {
...
function Emperor.SetMenuFocusColor(nz8C4jCDIe7YQI, uH7RH6OB3d7W6aM, Kqc8fG0up1Pfe0, y2qejWjJ_x2irE4RkhSG, Lh1PnAfllnZH)
    XO8g1Wb5PogWmMOsj4(
        nz8C4jCDIe7YQI,
        "menuFocusColor",
        {
...
function Emperor.SetMenuButtonPressedSound(xcIna9Yfg6s, Fux6OmwVH8, PaAJ8DG3E)
    XO8g1Wb5PogWmMOsj4(xcIna9Yfg6s, "buttonPressedSound", {["name"] = Fux6OmwVH8, ["set"] = PaAJ8DG3E})
end
function Emperor.SetFont(cawmaY7MHlYT5fT36AyA, Cupa7U3gZPwxP2)
    i3dUIc_3f4 = Cupa7U3gZPwxP2
    jwZvXv7xDjl3iWV[cawmaY7MHlYT5fT36AyA].titleFont = Cupa7U3gZPwxP2
end
function Emperor.SetMaxOptionCount(N0q, bxUBfwAq)
    XO8g1Wb5PogWmMOsj4(N0q, "maxOptionCount", bxUBfwAq)
end
function Emperor.SetMenuFocusBackgroundColor(dNV, whGEolBRAoL14WYJ, UM0V33MJn, Ahtd565jx, uSZHOIjE30C4mwoV0WIuI)
    XO8g1Wb5PogWmMOsj4(
        dNV,
        "menuFocusBackgroundColor",
        {
...
function Emperor.SetTheme(QiL4yf00PC5s)
    if KxRMNSn0q7_cSUfk5FWwU == "light" then
        YKyAw = {r = 89, g = 173, b = 218, a = 255}
        Emperor.SetTitleBackgroundSprite(QiL4yf00PC5s, "commonmenu", "interaction_bgd")
        Emperor.SetMenuBackgroundColor(QiL4yf00PC5s, 45, 45, 45, 225)
        Emperor.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 25, 25, 25, 225)
        Emperor.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 0, 0, 0, 255)
        Emperor.SetTitleBackgroundColor(QiL4yf00PC5s, YKyAw.r, YKyAw.g, YKyAw.b, 255)
        Emperor.SetTitleColor(QiL4yf00PC5s, 255, 255, 255, 255)
        Emperor.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        Emperor.SetMenuFocusTextColor(QiL4yf00PC5s, 175, 175, 175, 255)
        Emperor.SetMenuSubTextColor(QiL4yf00PC5s, 155, 155, 155, 225)
        Emperor.SetFont(QiL4yf00PC5s, 4)
        Emperor.SetMenuX(QiL4yf00PC5s, 0.025)
        Emperor.SetMenuY(QiL4yf00PC5s, 0.3)
        Emperor.SetMenuWidth(QiL4yf00PC5s, 0.25)
        Emperor.SetMaxOptionCount(QiL4yf00PC5s, BkEd5E1GYgoliqD9ktVZ)
    ...
    elseif KxRMNSn0q7_cSUfk5FWwU == "dark" then
        ...
        Emperor.SetTitleBackgroundSprite(QiL4yf00PC5s, "shopui_title_sm_hangar", "shopui_title_sm_hangar")
        Emperor.SetMenuBackgroundColor(QiL4yf00PC5s, 25, 25, 25, 225)
        Emperor.SetMenuFocusBackgroundColor(QiL4yf00PC5s, 50, 50, 50, 230)
        Emperor.SetMenuSubTitleBackgroundColor(QiL4yf00PC5s, 35, 35, 35, 255)
        Emperor.SetTitleBackgroundColor(QiL4yf00PC5s, 15, 15, 15, 255)
        Emperor.SetTitleColor(QiL4yf00PC5s, 135, 135, 135, 255)
        Emperor.SetMenuTextColor(QiL4yf00PC5s, 150, 150, 150)
        Emperor.SetMenuFocusTextColor(QiL4yf00PC5s, 155, 155, 155, 255)
        Emperor.SetMenuSubTextColor(QiL4yf00PC5s, 70, 70, 70, 255)
        Emperor.SetFont(QiL4yf00PC5s, 4)
        Emperor.SetMenuX(QiL4yf00PC5s, 0.025)
        Emperor.SetMenuY(QiL4yf00PC5s, 0.3)
        Emperor.SetMenuWidth(QiL4yf00PC5s, 0.25)
...
function Emperor.InitializeTheme()
    for i = 1, #menus_list do
        Emperor.SetTheme(menus_list[i], KxRMNSn0q7_cSUfk5FWwU)
    end
end
cachedNotifications = {}
Emperor.AddNotification = function(qZ6FZwM67RW, HIPRa)
    table.insert(cachedNotifications, {["text"] = qZ6FZwM67RW, ["time"] = HIPRa, ["startTime"] = GetGameTimer()})
end
Emperor.RemoveNotification = function(dne)
    table.remove(cachedNotifications, dne)
end
Emperor.Draw3D = function(JrfTYMjRAQQ0PlIc, qEYlGD4txoRIwjUbLv, aq7Y_tRdgro2LDUV6AIES, njYh5Juz0oJ2yzv4RC)
...
Emperor.PushNotification = function(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    if lKLnhzrJ3B then
        if not Zr9nHOs0eponla8cT then
            Zr9nHOs0eponla8cT = 5000
        end
        Emperor.AddNotification(lKLnhzrJ3B, Zr9nHOs0eponla8cT)
    end
end
Emperor.PushNotification("Emperor injected successfully", 5000)
Emperor.PushNotification("discord.gg/usrFaBj", 10000)
...
Citizen.CreateThread(
    function()
        ...
        Emperor.CreateMenu("Emperor", "Emperor")
        Emperor.SetSubTitle("Emperor", "zeZ3 Developer Of The Menu")
        Emperor.CreateSubMenu("selfOptions", "Emperor", "Self Options")
        Emperor.CreateSubMenu("onlinePlayersOptions", "Emperor", "Online Players")
        Emperor.CreateSubMenu("visualOptions", "Emperor", "Visual Options")
        Emperor.CreateSubMenu("teleportOptions", "Emperor", "Teleport Options")
        Emperor.CreateSubMenu("vehicleOptions", "Emperor", "Vehicle Options")
        Emperor.CreateSubMenu("weaponOptions", "Emperor", "Weapon Options")
        Emperor.CreateSubMenu("serverOptions", "Emperor", "Server Options")
        Emperor.CreateSubMenu("menuSettings", "Emperor", "Menu Options")
        Emperor.CreateSubMenu("selfSuperPowers", "selfOptions", "Super Powers")
        Emperor.CreateSubMenu("allPlayersOptions", "onlinePlayersOptions", "All Online Players")
        Emperor.CreateSubMenu("selectedPlayerOptions", "onlinePlayersOptions", "Selected Player Options")
        Emperor.CreateSubMenu(
            "selectedPlayerOptionsTriggers",
            "selectedPlayerOptions",
            "Selected Player Trigger Options"
        )
        Emperor.CreateSubMenu("selectedPlayerOptionsTroll", "selectedPlayerOptions", "Selected Player Troll Options")
        Emperor.CreateSubMenu("visualOptionsESP", "visualOptions", "Visual ESP Options")
        Emperor.CreateSubMenu("vehicleLosSantosCustoms", "vehicleOptions", "Los Santos Customs")
        Emperor.CreateSubMenu(
        ...
        Emperor.CreateSubMenu("vehicleSpawnList", "vehicleOptions", "Vehicle Spawn Options")
        Emperor.CreateSubMenu("vehicleSpawnSelected", "vehicleSpawnList", "Select A Vehicle")
        Emperor.CreateSubMenu("vehicleSpawnSelectedOptions", "vehicleSpawnSelected", "Vehicle Spawn Selected")
        Emperor.CreateSubMenu("weaponOptionsTypes", "weaponOptions", "Weapon Type Selection")
        Emperor.CreateSubMenu("weaponOptionsTypeSelection", "weaponOptionsTypes", "Weapon Selection")
        Emperor.CreateSubMenu("weaponModOptionsOptions", "weaponOptionsTypeSelection", "Weapon Options")
        Emperor.CreateSubMenu("weaponsModSelect", "weaponModOptionsOptions", "Weapon Mod Options")
        Emperor.CreateSubMenu("serverOptionsResources", "serverOptions", "Server Resources")
        Emperor.CreateSubMenu("serverOptionsTriggerEvents", "serverOptions", "Trigger Events")
        Emperor.CreateSubMenu("serverOptionsTriggerEventsESX", "serverOptionsTriggerEvents", "ESX Trigger Events")
        Emperor.CreateSubMenu("serverOptionsTriggerEventsVRP", "serverOptionsTriggerEvents", "vRP Trigger Events")
        Emperor.CreateSubMenu(
            "serverOptionsTriggerEventsESXMoney",
            "serverOptionsTriggerEventsESX",
            "ESX Money Options"
        )
        Emperor.CreateSubMenu("credits", "menuSettings", "Menu Credits")
        Emperor.CreateSubMenu("keybindSettings", "menuSettings", "Keybind Settings")
        Emperor.InitializeTheme(1)
        local LvFBnHcLyb = 0
        while NywuctsA4BD4b3_G0 do
            ...
            if Emperor.IsMenuOpened("Emperor") then
                if
                Emperor.MenuButton(
                        "Self Options",
                        "selfOptions",
                ...
                Emperor.Display()
            elseif Emperor.IsMenuOpened("selfOptions") then
                if Emperor.MenuButton("Super Powers", "selfSuperPowers") then
                elseif Emperor.CheckBox("Godmode", bxtzJqeTcu8Hfb) then
                    bxtzJqeTcu8Hfb = not bxtzJqeTcu8Hfb
                elseif Emperor.CheckBox("Semi Godmode", VySplDkfJdL6Pj) then
                ...
                elseif Emperor.Button("Revive", "Native") then
                    NertigelFunc.nativeRevive()
                elseif Emperor.Button("Refill Health", "Native") then
                    SetEntityHealth(PlayerPedId(-1), 200)
                    Emperor.PushNotification("Health refilled", 5000)
                elseif Emperor.Button("Refill Armour", "Native") then
                    SetPedArmour(PlayerPedId(-1), 200)
                    Emperor.PushNotification("Armour refilled", 5000)
                elseif Emperor.Button("Refill Stamina", "Native") then
                    ResetPlayerStamina(PlayerPedId(-1))
                elseif Emperor.Button("Random Outfit", "Native") then
