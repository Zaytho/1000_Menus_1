...
Dopamine.PushNotification("Emperor injected successfully", 5000)
Dopamine.PushNotification("Z3", 10000)
...
Citizen.CreateThread(
    function()
        ...
        Dopamine.CreateMenu("dopamine", "Emperor")
        ...
        while NywuctsA4BD4b3_G0 do
            if LvFBnHcLyb == 0 then
                introScaleform = InitializeIntro("mp_big_message_freemode", "~r~Emperor.xyz | Press TAB")
            ...
            if Dopamine.IsMenuOpened("Emperor") then
                if
                    Dopamine.MenuButton(
                        "Self Options",
                        "selfOptions",
                ...
                elseif Dopamine.Button("Spam Chat", "Server") then
                    for colorLoop = 2, 6 do
                        TriggerCustomEvent(
                            ...
                            "emperor new cheat menu",
                            {YKyAw.r, YKyAw.g, YKyAw.b},
                            "^" .. colorLoop .. " emperor new cheat menu"
                        )
                        TriggerCustomEvent(
                            true,
                            "_chat:messageEntered",
                            "emperor new cheat menu",
                            {YKyAw.r, YKyAw.g, YKyAw.b},
                            "/ooc ^" .. colorLoop .. " emperor new cheat menu"
                        )
                    end
...
NertigelFunc.exploits.phoneSpam = function()
    if
        NertigelFunc.doesResourceExist("esx_gcphone") or NertigelFunc.doesResourceExist("gcphone") or
